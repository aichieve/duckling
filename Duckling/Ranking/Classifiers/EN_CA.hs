...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.572957404872997, unseen = -6.152732694704104,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 468},
                   koData =
                     ClassData{prior = -0.8297814889648725,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.46072042694218635,
                               unseen = -7.146772179452637,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.452837287154442),
                                    ("Father's Dayyear (latent)", -6.452837287154442),
                                    ...
                                    ("daymonth", -4.437934266612178),
                                    ("monthday", -6.0473721790462776),
                                    ("monthyear", -4.661077817926388),
                                    ...
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.452837287154442),
                                    ...
                                    ("Family Dayyear (latent)", -5.536546555280287),
                                    ("Octoberyear (latent)", -4.948759890378168),
                                    ...
                                    ("from|since|after <time>December", -6.452837287154442),
                                    ("<time-of-day> am|pmon <day>", -4.437934266612178),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.452837287154442),
                                    ("yyyy-mm-ddhh:mm:ss", -6.0473721790462776),
                                    ("dayday", -3.744787086052232),
                                    ("<time> <part-of-day>at <time-of-day>", -6.452837287154442),
                                    ("mm/ddat <time-of-day>", -6.452837287154442),
                                    ("tonightat <time-of-day>", -6.452837287154442),
                                    ...
                                    ("dayyear", -1.8181082989248065),
                                    ("Karva Chauthin|during <named-month>|year",
                                     -6.452837287154442),
                                    ("Thursdayfrom|since|after <time>", -6.0473721790462776),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.452837287154442),
                                    ...
                                    ("Discovery Dayyear (latent)", -6.0473721790462776),
                                    ...
                                    ("part of daysat <time-of-day>", -6.0473721790462776),
                                    ...
                                    ("intersectin|during the <part-of-day>", -6.452837287154442),
                                    ...
                                    ("minuteday", -2.715167668871074),
                                    ("absorption of , after named dayintersect",
                                     -5.759690106594497),
                                    ("intersectyear (latent)", -6.452837287154442),
                                    ...
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -6.0473721790462776),
                                    ("Labour Dayyear (latent)", -6.452837287154442),
                                    ("weekyear", -5.354224998486333),
                                    ...
                                    ("<datetime> - <datetime> (interval)July", -6.0473721790462776),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.759690106594497),
                                    ("Februaryintersect", -6.452837287154442),
                                    ("Mother's Dayyear (latent)", -6.452837287154442),
                                    ("Simchat Torahyear (latent)", -6.452837287154442),
                                    ("Victoria Dayyear (latent)", -6.0473721790462776),
                                    ("minuteyear", -6.452837287154442)],
                               n = 487},
                   koData =
                     ClassData{prior = -0.9964953697561257, unseen = -6.763884908562435,
                               likelihoods =
                                 HashMap.fromList
                                   [("Thursdayhhhmm", -4.56550492959566),
                                    ("hourday", -3.6716870535735633),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -6.0695823263719335),
                                    ("<day-of-month> (ordinal)August", -6.0695823263719335),
                                    ("dayhour", -3.207381445442466),
                                    ("<time> timezoneyear (latent)", -5.376435145811989),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.153291594497779),
                                    ("Tuesdayfrom|since|after <time>", -5.376435145811989),
                                    ("daymonth", -3.395433676945405),
                                    ("monthday", -5.153291594497779),
                                    ...
                                    ("about|exactly <time-of-day>year (latent)",
                                     -6.0695823263719335),
                                    ("hh:mmon <day>", -4.816819357876566),
                                    ("hhhmmintersect", -5.66411721826377),
                                    ("absorption of , after named dayJuly", -5.153291594497779),
                                    ...
                                    ("hhhmmyear (latent)", -4.816819357876566),
                                    ...
                                    ("mm/ddat <time-of-day>", -5.66411721826377),
                                    ("on <day>September", -5.376435145811989),
                                    ("time-of-day (latent)September", -5.66411721826377),
                                    ("hourhour", -5.66411721826377),
                                    ("time-of-day (latent)on <day>", -4.56550492959566),
                                    ("time-of-day (latent)<cycle> after|before <time>",
                                     -5.66411721826377),
                                    ("dayyear", -3.1251433472054937),
                                    ("Thursdaymm/dd", -6.0695823263719335),
                                    ...
                                    ("tomorrow<time-of-day> am|pm", -5.376435145811989),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.376435145811989),
