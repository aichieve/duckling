...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.5709086271147672, unseen = -6.173786103901937,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 478},
                   koData =
                     ClassData{prior = -0.8324364214372924, unseen = -5.91350300563827,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4630778608927755, unseen = -7.149916836132109,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.4559844179974615),
                                    ("Father's Dayyear (latent)", -6.4559844179974615),
                                    ("Karva Chauthyear (latent)", -6.4559844179974615),
                                    ("<day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.4559844179974615),
                                    ("Maha Shivaratriyear (latent)", -6.4559844179974615),
                                    ("Ramadanyear (latent)", -5.203221449502093),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -5.069690056877571),
                                    ("Bhai Doojyear (latent)", -6.4559844179974615),
                                    ("hourday", -4.441081397455196),
                                    ("dayhour", -3.5115454388310208),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.069690056877571),
                                    ("Martin Luther King's Dayyear (latent)", -6.050519309889297),
                                    ("Shemini Atzeretyear (latent)", -6.4559844179974615),
                                    ("daymonth", -4.441081397455196),
                                    ("monthday", -6.050519309889297),
                                    ("monthyear", -4.664224948769406),
                                    ("Yom Ha'atzmautyear (latent)", -6.4559844179974615),
                                    ("Vijayadashamiyear (latent)", -6.4559844179974615),
                                    ("Administrative Professionals' Dayyear (latent)",
                                     -6.050519309889297),
                                    ("Thanksgiving Dayyear (latent)", -5.3573721293293515),
                                    ("Thai Pongalyear (latent)", -5.762837237437516),
                                    ("Thiru Onamyear (latent)", -5.762837237437516),
                                    ("hhhmmabsorption of , after named day", -6.4559844179974615),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.4559844179974615),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.539693686123306),
                                    ("<day-of-month> (ordinal)Wednesday", -6.4559844179974615),
                                    ("Krishna Janmashtamiyear (latent)", -6.050519309889297),
                                    ("Guru Gobind Singh Jayantiyear (latent)", -6.4559844179974615),
                                    ("houryear", -5.539693686123306),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.4559844179974615),
                                    ("Christmas<time-of-day> am|pm", -6.4559844179974615),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.4559844179974615),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.762837237437516),
                                    ("intersectin|during <named-month>|year", -6.4559844179974615),
                                    ("<time-of-day> am|pmintersect", -5.203221449502093),
                                    ("Earth Houryear (latent)", -6.4559844179974615),
                                    ("Ganesh Chaturthiyear (latent)", -6.4559844179974615),
                                    ("Family Dayyear (latent)", -5.539693686123306),
                                    ("Octoberyear (latent)", -4.951907021221187),
                                    ("intersect<time-of-day> am|pm", -6.4559844179974615),
                                    ("Mattu Pongalyear (latent)", -6.4559844179974615),
                                    ("Shavuotyear (latent)", -6.4559844179974615),
                                    ("Parsi New Yearyear (latent)", -5.539693686123306),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.4559844179974615),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.4559844179974615),
                                    ("todayin|within|after <duration>", -6.4559844179974615),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -6.050519309889297),
                                    ("Marchyear (latent)", -6.4559844179974615),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hhhmm",
                                     -6.050519309889297),
                                    ("Sukkotyear (latent)", -6.050519309889297),
                                    ("hhhmmintersect", -6.050519309889297),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -6.050519309889297),
                                    ("Clean Mondayyear (latent)", -6.050519309889297),
                                    ("monthhour", -6.050519309889297),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.762837237437516),
                                    ("todayat <time-of-day>", -6.4559844179974615),
                                    ("Thursday<time> timezone", -4.058089145199091),
                                    ("time-of-day (latent)tonight", -6.050519309889297),
                                    ("from|since|after <time>December", -6.4559844179974615),
                                    ("<time-of-day> am|pmon <day>", -4.441081397455196),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.4559844179974615),
                                    ("yyyy-mm-ddhh:mm:ss", -6.050519309889297),
                                    ("dayday", -3.747934216895251),
                                    ("<time> <part-of-day>at <time-of-day>", -6.4559844179974615),
                                    ("mm/ddat <time-of-day>", -6.4559844179974615),
                                    ("tonightat <time-of-day>", -6.4559844179974615),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.762837237437516),
                                    ("Dayananda Saraswati Jayantiyear (latent)",
                                     -6.4559844179974615),
                                    ("today<time-of-day> am|pm", -6.4559844179974615),
                                    ("Februarythe <day-of-month> (ordinal)", -6.050519309889297),
                                    ("at <time-of-day><time> <part-of-day>", -6.4559844179974615),
                                    ("<day-of-month> (ordinal)intersect", -6.050519309889297),
                                    ("mm/dd<time-of-day> am|pm", -6.4559844179974615),
                                    ("hourhour", -4.376542876317625),
                                    ("Mahavir Jayantiyear (latent)", -6.050519309889297),
                                    ("Navaratriin|during <named-month>|year", -6.4559844179974615),
                                    ("National Patriots' Dayyear (latent)", -5.762837237437516),
                                    ("Wednesdaythis|last|next <cycle>", -6.4559844179974615),
                                    ("Lentyear (latent)", -6.4559844179974615),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.58418224109587),
                                    ("Boghiyear (latent)", -6.4559844179974615),
                                    ("dayyear", -1.8115935188560885),
                                    ("Karva Chauthin|during <named-month>|year",
                                     -6.4559844179974615),
                                    ("Thursdayfrom|since|after <time>", -6.050519309889297),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.4559844179974615),
                                    ("Thursdayat <time-of-day>", -5.762837237437516),
                                    ("Islamic New Yearyear (latent)", -6.050519309889297),
                                    ("Laylat al-Qadryear (latent)", -5.539693686123306),
                                    ("Discovery Dayyear (latent)", -6.050519309889297),
                                    ("Shrove Tuesdayyear (latent)", -6.4559844179974615),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.762837237437516),
                                    ("<time-of-day> am|pmtomorrow", -5.762837237437516),
                                    ("Yom Kippuryear (latent)", -6.4559844179974615),
                                    ("<day-of-month> (ordinal)Tuesday", -6.050519309889297),
                                    ("<part-of-day> of <time>year (latent)", -6.4559844179974615),
                                    ("minutehour", -5.203221449502093),
                                    ("Kaanum Pongalyear (latent)", -6.050519309889297),
                                    ("Maha Saptamiyear (latent)", -6.4559844179974615),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -6.050519309889297),
                                    ("time-of-day (latent)tomorrow", -5.539693686123306),
                                    ("part of daysat <time-of-day>", -6.050519309889297),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.441081397455196),
                                    ("for <duration> from <time>December", -6.4559844179974615),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.4559844179974615),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.203221449502093),
                                    ("intersect by \",\", \"of\", \"from\" for yearhhhmm",
                                     -5.203221449502093),
                                    ("time-of-day (latent)this <part-of-day>", -6.4559844179974615),
                                    ("Pentecostyear (latent)", -6.4559844179974615),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.203221449502093),
                                    ("<day-of-month> (ordinal)February", -6.4559844179974615),
                                    ("Eid al-Fitryear (latent)", -5.069690056877571),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.4559844179974615),
                                    ("Mondayin|during the <part-of-day>", -6.4559844179974615),
                                    ("Chhathin|during <named-month>|year", -6.4559844179974615),
                                    ("Diwaliin|during <named-month>|year", -6.4559844179974615),
                                    ("Vaisakhiin|during <named-month>|year", -6.4559844179974615),
                                    ("Guru Ravidass Jayantiyear (latent)", -5.203221449502093),
                                    ("Raksha Bandhanyear (latent)", -6.4559844179974615),
                                    ("daysecond", -6.050519309889297),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -6.050519309889297),
                                    ("Ratha-Yatrayear (latent)", -6.4559844179974615),
                                    ("Ashurayear (latent)", -6.4559844179974615),
                                    ("Tuesdayin|during <named-month>|year", -6.4559844179974615),
                                    ("Chinese New Yearyear (latent)", -6.4559844179974615),
                                    ("tomorrowintersect", -6.4559844179974615),
                                    ("Lag BaOmeryear (latent)", -6.4559844179974615),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.4559844179974615),
                                    ("Eid al-Adhayear (latent)", -4.315918254501191),
                                    ("intersectin|during the <part-of-day>", -6.4559844179974615),
                                    ("Palm Sundayyear (latent)", -6.4559844179974615),
                                    ("Christmasat <time-of-day>", -6.4559844179974615),
                                    ("Passoveryear (latent)", -6.4559844179974615),
                                    ("Lazarus Saturdayyear (latent)", -6.4559844179974615),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.4559844179974615),
                                    ("hhhmmon <day>", -5.539693686123306),
                                    ("Yom HaShoahyear (latent)", -6.050519309889297),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -6.050519309889297),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.4559844179974615),
                                    ("Septemberyear (latent)", -6.050519309889297),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.951907021221187),
                                    ("Halloweenyear (latent)", -6.4559844179974615),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.4559844179974615),
                                    ("at <time-of-day>intersect", -5.539693686123306),
                                    ("Rosh Hashanahyear (latent)", -5.762837237437516),
                                    ("Dhanterasyear (latent)", -6.4559844179974615),
                                    ("Tu BiShvatyear (latent)", -6.4559844179974615),
                                    ("<day-of-month> (ordinal)December", -5.762837237437516),
                                    ("Holiyear (latent)", -5.762837237437516),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.4559844179974615),
                                    ("Holika Dahanyear (latent)", -5.762837237437516),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.050519309889297),
                                    ("dayminute", -3.1060803307228566),
                                    ("Mawlidyear (latent)", -6.4559844179974615),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -6.050519309889297),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.4559844179974615),
                                    ("Jumu'atul-Widayear (latent)", -5.539693686123306),
                                    ("minuteday", -2.718314799714093),
                                    ("absorption of , after named dayintersect",
                                     -5.762837237437516),
                                    ("intersectyear (latent)", -6.4559844179974615),
                                    ("Orthodox Easter Sundayyear (latent)", -6.4559844179974615),
                                    ("time-of-day (latent)in|within|after <duration>",
                                     -6.4559844179974615),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -6.4559844179974615),
                                    ("intersecthhhmm", -6.050519309889297),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.4559844179974615),
                                    ("Boss's Dayyear (latent)", -6.050519309889297),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.4559844179974615),
                                    ("Global Youth Service Dayyear (latent)", -6.4559844179974615),
                                    ("Dhanterasin|during <named-month>|year", -6.4559844179974615),
                                    ("Tisha B'Avyear (latent)", -6.4559844179974615),
                                    ("Isra and Mi'rajyear (latent)", -5.539693686123306),
                                    ("at <time-of-day>on <day>", -4.846546505563361),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.050519309889297),
                                    ("time-of-day (latent)<time> <part-of-day>",
                                     -5.762837237437516),
                                    ("Christmasyear (latent)", -6.050519309889297),
                                    ("Naraka Chaturdashiyear (latent)", -6.050519309889297),
                                    ("Thai Pongalin|during <named-month>|year",
                                     -6.4559844179974615),
                                    ("dayweek", -6.4559844179974615),
                                    ("Easter Sundayyear (latent)", -5.762837237437516),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -6.050519309889297),
                                    ("Labour Dayyear (latent)", -6.4559844179974615),
                                    ("weekyear", -5.3573721293293515),
                                    ("King's Dayyear (latent)", -4.951907021221187),
                                    ("hh:mmin|during the <part-of-day>", -5.539693686123306),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -6.050519309889297),
                                    ("Hanukkahyear (latent)", -5.762837237437516),
                                    ("February<time> <part-of-day>", -6.4559844179974615),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -6.4559844179974615),
                                    ("Great Lentyear (latent)", -6.4559844179974615),
                                    ("tomorrowat <time-of-day>", -5.762837237437516),
                                    ("hhmm (latent)in|during the <part-of-day>",
                                     -6.4559844179974615),
                                    ("Ugadiyear (latent)", -5.069690056877571),
                                    ("Vaisakhiyear (latent)", -5.762837237437516),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -5.762837237437516),
                                    ("last <cycle> of <time>year (latent)", -5.762837237437516),
                                    ("at <time-of-day>tomorrow", -6.050519309889297),
                                    ("tomorrow<time-of-day> am|pm", -6.4559844179974615),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.762837237437516),
                                    ("Diwaliyear (latent)", -6.4559844179974615),
                                    ("between <time> and <time>on <day>", -6.050519309889297),
                                    ("Black Fridayyear (latent)", -6.050519309889297),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.4559844179974615),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.4559844179974615),
                                    ("Chhathyear (latent)", -6.050519309889297),
                                    ("Vasant Panchamiyear (latent)", -6.4559844179974615),
                                    ("Rabindra Jayantiyear (latent)", -5.203221449502093),
                                    ("St Patrick's Dayyear (latent)", -6.4559844179974615),
                                    ("Thursday<time> (timezone)", -6.4559844179974615),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.4559844179974615),
                                    ("Pargat Diwasyear (latent)", -5.203221449502093),
                                    ("<datetime> - <datetime> (interval)July", -6.050519309889297),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.762837237437516),
                                    ("Februaryintersect", -6.4559844179974615),
                                    ("Mother's Dayyear (latent)", -6.4559844179974615),
                                    ("Simchat Torahyear (latent)", -6.4559844179974615),
                                    ("Victoria Dayyear (latent)", -6.050519309889297),
                                    ("minuteyear", -6.4559844179974615)],
                               n = 489},
                   koData =
                     ClassData{prior = -0.9924798702317016, unseen = -6.77078942390898,
                               likelihoods =
                                 HashMap.fromList
                                   [("Thursdayhhhmm", -4.572417399516284),
                                    ("hourday", -3.678599523494187),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -6.0764947962925575),
                                    ("<day-of-month> (ordinal)August", -6.0764947962925575),
                                    ("dayhour", -3.214293915363089),
                                    ("<time> timezoneyear (latent)", -5.383347615732612),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.160204064418402),
                                    ("Tuesdayfrom|since|after <time>", -5.383347615732612),
                                    ("daymonth", -3.4023461468660288),
                                    ("monthday", -5.160204064418402),
                                    ("monthyear", -4.467056883858457),
                                    ("<time-of-day> am|pmyear (latent)", -5.383347615732612),
                                    ("Thai Pongalyear (latent)", -5.383347615732612),
                                    ("intersecthh:mm", -6.0764947962925575),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.671029688184393),
                                    ("<day-of-month> (ordinal)Wednesday", -6.0764947962925575),
                                    ("houryear", -4.690200435172667),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -6.0764947962925575),
                                    ("<day-of-month> (ordinal)October", -6.0764947962925575),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.383347615732612),
                                    ("hournograin", -4.8237318277971895),
                                    ("<time-of-day> am|pmintersect", -4.8237318277971895),
                                    ("Octoberyear (latent)", -6.0764947962925575),
                                    ("time-of-day (latent)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.671029688184393),
                                    ("until <time>on <day>", -5.383347615732612),
                                    ("time-of-day (latent)intersect", -5.383347615732612),
                                    ("todayin <number> (implicit minutes)", -6.0764947962925575),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.383347615732612),
                                    ("Marchyear (latent)", -5.671029688184393),
                                    ("about|exactly <time-of-day>year (latent)",
                                     -6.0764947962925575),
                                    ("hh:mmon <day>", -4.8237318277971895),
                                    ("hhhmmintersect", -5.671029688184393),
                                    ("absorption of , after named dayJuly", -5.160204064418402),
                                    ("from|since|after <time>July", -5.671029688184393),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.160204064418402),
                                    ("Clean Mondayyear (latent)", -6.0764947962925575),
                                    ("monthhour", -6.0764947962925575),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.671029688184393),
                                    ("hourmonth", -4.204692619390966),
                                    ("todayat <time-of-day>", -6.0764947962925575),
                                    ("hhhmmyear (latent)", -4.8237318277971895),
                                    ("from|since|after <time>December", -6.0764947962925575),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -6.0764947962925575),
                                    ("<time-of-day> am|pmon <day>", -4.8237318277971895),
                                    ("Mondayyear (latent)", -5.383347615732612),
                                    ("dayday", -4.690200435172667),
                                    ("mm/ddat <time-of-day>", -5.671029688184393),
                                    ("on <day>September", -5.383347615732612),
                                    ("time-of-day (latent)September", -5.671029688184393),
                                    ("hourhour", -5.671029688184393),
                                    ("time-of-day (latent)on <day>", -4.572417399516284),
                                    ("time-of-day (latent)<cycle> after|before <time>",
                                     -5.671029688184393),
                                    ("dayyear", -3.1320558171261172),
                                    ("Thursdaymm/dd", -6.0764947962925575),
                                    ("New Year's Dayyear (latent)", -5.160204064418402),
                                    ("time-of-day (latent)Sunday", -5.671029688184393),
                                    ("Thursdayfrom|since|after <time>", -4.371746704054132),
                                    ("Thursdayat <time-of-day>", -4.467056883858457),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -6.0764947962925575),
                                    ("Aprilyear (latent)", -5.671029688184393),
                                    ("the <day-of-month> (ordinal)July", -6.0764947962925575),
                                    ("the <day-of-month> (number)July", -6.0764947962925575),
                                    ("monthminute", -6.0764947962925575),
                                    ("<time-of-day> am|pmtomorrow", -6.0764947962925575),
                                    ("Thursdayhh:mm", -5.160204064418402),
                                    ("<day-of-month> (ordinal)Tuesday", -5.671029688184393),
                                    ("minutemonth", -3.9364286327962867),
                                    ("time-of-day (latent)Friday", -5.671029688184393),
                                    ("minutehour", -6.0764947962925575),
                                    ("this|last|next <cycle>from|since|after <time>",
                                     -5.671029688184393),
                                    ("tomorrowfrom|since|after <time>", -5.671029688184393),
                                    ("Augustyear (latent)", -5.671029688184393),
                                    ("week-endin|during <named-month>|year", -6.0764947962925575),
                                    ("this|last|next <cycle>until <time>", -5.671029688184393),
                                    ("time-of-day (latent)Tuesday", -5.671029688184393),
                                    ("tomorrowuntil <time>", -5.671029688184393),
                                    ("mm/dd<time-of-day> - <time-of-day> (interval)",
                                     -5.671029688184393),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -6.0764947962925575),
                                    ("Sundayyear (latent)", -5.160204064418402),
                                    ("Christmasat <time-of-day>", -6.0764947962925575),
                                    ("from|since|after <time>year (latent)", -4.9778825076244475),
                                    ("hhhmmon <day>", -5.160204064418402),
                                    ("yesterday<time-of-day> am|pm", -6.0764947962925575),
                                    ("<day-of-month> (ordinal)July", -5.383347615732612),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hh:mm",
                                     -6.0764947962925575),
                                    ("mm/ddyear (latent)", -6.0764947962925575),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -6.0764947962925575),
                                    ("in|during <named-month>|yearyear (latent)",
                                     -6.0764947962925575),
                                    ("at <time-of-day>intersect", -5.160204064418402),
                                    ("hh:mmyear (latent)", -4.690200435172667),
                                    ("Holiyear (latent)", -6.0764947962925575),
                                    ("until <time><time-of-day> am|pm", -6.0764947962925575),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.671029688184393),
                                    ("dayminute", -3.214293915363089),
                                    ("yyyy-mm-ddhh:mm", -5.671029688184393),
                                    ("intersectfrom|since|after <time>", -5.671029688184393),
                                    ("intersectSeptember", -4.204692619390966),
                                    ("minuteday", -2.919494375142444),
                                    ("absorption of , after named dayintersect",
                                     -6.0764947962925575),
                                    ("intersectyear (latent)", -6.0764947962925575),
                                    ("Februaryin|during the <part-of-day>", -6.0764947962925575),
                                    ("<duration> after|before|from|past <time>December",
                                     -6.0764947962925575),
                                    ("time-of-day (latent)July", -5.383347615732612),
                                    ("Saturdayyear (latent)", -6.0764947962925575),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.0764947962925575),
                                    ("at <time-of-day>on <day>", -5.160204064418402),
                                    ("absorption of , after named daySeptember",
                                     -4.8237318277971895),
                                    ("Naraka Chaturdashiyear (latent)", -6.0764947962925575),
                                    ("from|since|after <time>on <day>", -5.160204064418402),
                                    ("dayweek", -6.0764947962925575),
                                    ("Easter Sundayyear (latent)", -5.671029688184393),
                                    ("Thursday<time-of-day> am|pm", -4.8237318277971895),
                                    ("weekyear", -5.671029688184393),
                                    ("time-of-day (latent)Thursday", -5.671029688184393),
                                    ("<named-month> <day-of-month> (non ordinal)until <time>",
                                     -6.0764947962925575),
                                    ("<day-of-month> (ordinal)April", -6.0764947962925575),
                                    ("yyyy-mm-dd<time-of-day> - <time-of-day> (interval)",
                                     -5.671029688184393),
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.383347615732612),
                                    ("Sundayfrom|since|after <time>", -6.0764947962925575),
                                    ("absorption of , after named dayFebruary", -5.160204064418402),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.671029688184393),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -6.0764947962925575),
                                    ("tomorrowat <time-of-day>", -6.0764947962925575),
                                    ("daynograin", -5.671029688184393),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.671029688184393),
                                    ("last <cycle> of <time>year (latent)", -5.671029688184393),
                                    ("tomorrow<time-of-day> am|pm", -5.383347615732612),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.383347615732612),
                                    ("Diwaliyear (latent)", -5.671029688184393),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -6.0764947962925575),
                                    ("Fridayyear (latent)", -5.671029688184393),
                                    ("time-of-day (latent)April", -6.0764947962925575),
                                    ("minuteyear", -3.879270218956338)],
                               n = 288}}),
       ("one eleven",
        Classifier{okData =
       ...
       ("year (grain)",
        Classifier{okData =
                   ...
                   koData =
                     ClassData{prior = -2.740840023925201, unseen = -1.3862943611198906,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 2}}),
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.1498862810408007, unseen = -5.480638923341991,
                               likelihoods =
                                 HashMap.fromList
                               ...
                               n = 235},
                   koData =
                     ClassData{prior = -1.9718856354585739,
       ...
       ("this|last|next <cycle>",
        Classifier{okData =
                     ClassData{prior = -0.19948936041632004, unseen = -5.10594547390058,
                               likelihoods =
                                 HashMap.fromList
                               ...
                               n = 77},
                   koData =
                     ClassData{prior = -1.7100814382137877,
                               unseen = -3.8066624897703196,
                               likelihoods =
                                 HashMap.fromList
       ...
       ("time-of-day (latent)",
        Classifier{okData =
                     ClassData{prior = -0.6654956492294354, unseen = -4.727387818712341,
                               likelihoods =
                                 HashMap.fromList
                               ...
                               n = 110},
                   koData =
                     ClassData{prior = -0.7215851158804788, unseen = -4.672828834461907,
                               likelihoods =
                                 HashMap.fromList
       ...
       ("<integer> <unit-of-duration>",
        Classifier{okData =
                     ClassData{prior = -0.4500694143449184,
                               unseen = -5.3612921657094255,
                               likelihoods =
                                 HashMap.fromList
                                   [("week", -2.583997552432231),
                                    ("integer (0..19)year (grain)", -3.054001181677967),
                                    ("integer (numeric)day (grain)", -2.583997552432231),
                                    ("integer (0..19)second (grain) ", -3.970291913552122),
                                    ("integer (0..19)hour (grain)", -3.159361697335793),
                                    ("second", -3.5648268054439574),
                                    ("integer (numeric)second (grain) ", -4.257973986003902),
                                    ("integer (numeric)year (grain)", -3.4106761256166993),
                                    ("day", -2.3608540011180215), ("year", -2.583997552432231),
                                    ("integer (numeric)week (grain)", -3.2771447329921766),
                                    ("integer (0..19)month (grain)", -3.5648268054439574),
                                    ("integer (20..90)minute (grain)", -4.663439094112067),
                                    ("hour", -2.7916369172104756), ("month", -3.2771447329921766),
                                    ("integer (numeric)minute (grain)", -2.6485360735698023),
                                    ("integer (0..19)minute (grain)", -3.2771447329921766),
                                    ("integer (numeric)month (grain)", -4.257973986003902),
                                    ("minute", -2.2210920587428626),
                                    ("integer (numeric)hour (grain)", -3.747148362237912),
                                    ("integer (0..19)day (grain)", -3.747148362237912),
                                    ("integer (0..19)week (grain)", -3.159361697335793)],
                               n = 95},
                   koData =
                     ClassData{prior = -1.014962259381185, unseen = -4.875197323201151,
                               likelihoods =
                                 HashMap.fromList
                                   [("hour", -0.8602012652231115),
