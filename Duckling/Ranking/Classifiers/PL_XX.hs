...
classifiers
  = HashMap.fromList
      [("five",
       ...
       ("<time> <part-of-day>",
        Classifier{okData =
                     ClassData{prior = -0.7748252115742126, unseen = -4.919980925828125,
                               likelihoods =
                                 HashMap.fromList
                               ...
                               n = 47},
                   koData =
                     ClassData{prior = -0.6176396280518002, unseen = -5.030437921392435,
                               likelihoods =
                                 HashMap.fromList
                                   [("<ordinal> (as hour)after <time-of-day>", -4.330733340286331),
                                    ("dayhour", -1.9328380674879604),
                                    ("yearhour", -2.0281482472922856),
                                    ("year (latent)on <date>", -4.330733340286331),
                                    ("<day-of-month> (ordinal)on <date>", -4.330733340286331),
                                    ("nograinhour", -3.925268232178167),
                                    ("<time-of-day> - <time-of-day> (interval)morning",
                                     -4.330733340286331),
                                    ("<day-of-month> (ordinal)evening|night", -2.625985248047906),
                                    ("by the end of <time>morning", -4.330733340286331),
                                    ("year (latent)evening|night", -3.077970371790963),
                                    ("hourhour", -2.384823191231018),
                                    ("after <time-of-day>after <time-of-day>", -3.925268232178167),
                                    ("<day-of-month> (ordinal)morning", -3.925268232178167),
                                    ("<day-of-month> (ordinal)after <time-of-day>",
                                     -3.2321210516182215),
                                    ("until <time-of-day>morning", -4.330733340286331),
                                    ("about <time-of-day>after <time-of-day>", -4.330733340286331),
                                    ("by <time>morning", -4.330733340286331),
                                    ("<integer> (latent time-of-day)after <time-of-day>",
                                     -3.925268232178167),
                                    ("<integer> (latent time-of-day)morning", -3.2321210516182215),
                                    ("intersectmorning", -4.330733340286331),
                                    ("year (latent)morning", -2.625985248047906),
                                    ("Mondaymorning", -4.330733340286331),
                                    ("year (latent)after <time-of-day>", -3.925268232178167),
                                    ("at <time-of-day>after <time-of-day>", -4.330733340286331)],
                               n = 55}}),
       ("today",
        Classifier{okData =
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.24795872043393374,
                               unseen = -6.259581464064923,
                               likelihoods =
                                 HashMap.fromList
                                   [("Tuesdayon <date>", -4.648229675448539),
                                    ("Sundaylast <cycle>", -5.159055299214529),
                                    ("Fridaynext <cycle>", -5.564520407322694),
                                    ...
                                    ("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -5.159055299214529),
                                    ("hourday", -3.7727609380946383),
                                    ("dayhour", -2.702319526393225),
                                    ("daymonth", -3.7727609380946383),
                                    ("<time-of-day> popo\322udniu/wieczorem/w nocyabsorption of , after named day",
                                     -4.648229675448539),
                                    ("TuesdaySeptember", -5.564520407322694),
                                    ("monthyear", -3.079613757534693),
                                    ("Wednesdayintersect", -5.159055299214529),
                                    ...
                                    ("from <datetime> - <datetime> (interval)on a named-day",
                                     -5.564520407322694),
                                    ("Wednesdaynext <cycle>", -5.159055299214529),
                                    ("Tuesdaythis <cycle>", -5.564520407322694),
                                    ("Saturday<time> <part-of-day>", -5.564520407322694),
                                    ("Marchyear", -5.159055299214529),
                                    ("Saturdayat <time-of-day>", -5.159055299214529),
                                    ("on a named-dayat <time-of-day>", -5.159055299214529),
                                    ("at <time-of-day>on a named-day", -5.564520407322694),
                                    ("<time> <part-of-day>on a named-day", -5.159055299214529),
                                    ("Wednesdayon <date>", -4.465908118654584),
                                    ("on a named-day<time> <part-of-day>", -5.564520407322694),
                                    ("last <day-of-week> of <time>year", -5.564520407322694),
                                    ("today<time> <part-of-day>", -5.564520407322694),
                                    ("todayat <time-of-day>", -5.564520407322694),
                                    ("on <date>at <time-of-day>", -5.159055299214529),
                                    ("dayday", -2.925463077707435),
                                    ("on <date><time> <part-of-day>", -5.564520407322694),
                                    ("intersect by \",\"hh:mm", -4.648229675448539),
                                    ("mm/ddat <time-of-day>", -4.871373226762748),
                                    ("WednesdayOctober", -5.159055299214529),
                                    ("last <cycle> <time>year", -4.648229675448539),
                                    ...
                                    ("Wednesday<day-of-month>(ordinal) <named-month>",
                                     -5.564520407322694),
                                    ("Thursday<time> <part-of-day>", -5.159055299214529),
                                    ...
                                    ("absorption of , after named day<day-of-month>(ordinal) <named-month>",
                                     -4.060443010546419),
                                    ("Tuesdaynext <cycle>", -5.564520407322694),
                                    ...
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -4.648229675448539),
                                    ("tomorrowuntil <time-of-day>", -5.159055299214529),
                                    ("absorption of , after named day<day-of-month> (non ordinal) <named-month>",
                                     -4.060443010546419),
                                    ("<time-of-day> popo\322udniu/wieczorem/w nocyintersect by \",\"",
                                     -4.648229675448539),
                                    ("TuesdayOctober", -5.564520407322694),
                                    ("last <day-of-week> <time>year", -5.159055299214529),
                                    ("Monday<day-of-month>(ordinal) <named-month>",
                                     -5.159055299214529),
                                    ("Mondaythis <cycle>", -5.564520407322694),
                                    ("<time-of-day> ranoon <date>", -5.159055299214529),
                                    ("on <date><time-of-day> rano", -5.564520407322694),
                                    ...
                                    ("dayminute", -3.7727609380946383),
                                    ("<time-of-day> ranoon a named-day", -5.159055299214529),
                                    ("from <hour-of-day> - <hour-of-day> (interval)on <date>",
                                     -5.564520407322694),
                                    ("from <datetime> - <datetime> (interval)on <date>",
                                     -5.564520407322694),
                                    ("intersectyear", -5.159055299214529),
                                    ("on a named-day<time-of-day> rano", -5.564520407322694),
                                    ("<ordinal> <cycle> of <time>year", -5.564520407322694),
                                    ("minuteday", -2.365847289772012),
                                    ("absorption of , after named dayintersect",
                                     -5.564520407322694),
                                    ("Saturday<time-of-day> rano", -5.564520407322694),
                                    ("Octoberyear", -3.859772315084268),
                                    ("yearhh:mm", -5.564520407322694),
                                    ("at <time-of-day>intersect by \",\"", -5.159055299214529),
                                    ("absorption of , after named dayintersect by \",\"",
                                     -5.159055299214529),
                                    ("tomorrowexactly <time-of-day>", -4.871373226762748),
                                    ("at <time-of-day>absorption of , after named day",
                                     -5.159055299214529),
                                    ("Septemberyear", -4.648229675448539),
                                    ("at <time-of-day>on <date>", -5.564520407322694),
                                    ("on <date>year", -4.178226046202803),
                                    ("dayweek", -3.6186102582673803),
                                    ("Tuesdayin <duration>", -5.564520407322694),
                                    ("<time> <part-of-day>on <date>", -5.159055299214529),
                                    ("weekyear", -4.311757438827326),
                                    ("<ordinal> <cycle> <time>year", -5.159055299214529),
                                    ("tomorrowat <time-of-day>", -5.564520407322694),
                                    ("tomorrow<time> <part-of-day>", -5.564520407322694),
                                    ("at <time-of-day>Friday", -5.159055299214529),
                                    ("<time-of-day> popo\322udniu/wieczorem/w nocyintersect",
                                     -4.648229675448539),
                                    ("<named-month> <day-of-month> (ordinal)year",
                                     -5.564520407322694),
                                    ("tomorrow<time-of-day> rano", -5.564520407322694),
                                    ("<datetime> - <datetime> (interval)on a named-day",
                                     -5.159055299214529),
                                    ("last <cycle> of <time>year", -5.159055299214529),
                               ...
                               n = 199},
                   koData =
                     ClassData{prior = -1.515911854423277, unseen = -5.4680601411351315,
                               likelihoods =
                                 HashMap.fromList
                                   [("Tuesdayon <date>", -4.770684624465665),
                                    ("Julyrelative minutes to|till|before <integer> (hour-of-day)",
                                     -4.770684624465665),
                                    ("dayhour", -3.672072335797555),
                                    ("daymonth", -2.468099531471619),
                                    ("monthyear", -3.8543938925915096),
                                    ("Wednesdayintersect", -4.3652195163575005),
                                    ("<time> <part-of-day>until <time-of-day>",
                                     -4.3652195163575005),
                                    ("hournograin", -3.8543938925915096),
                                    ("Marchyear", -4.07753744390572),
                                    ("Wednesdayon <date>", -4.770684624465665),
                                    ("absorption of , after named dayJuly", -4.770684624465665),
                                    ("<time> <part-of-day><time> <part-of-day>", -4.07753744390572),
                                    ("mm/ddat <time-of-day>", -4.770684624465665),
                                    ("hourhour", -3.8543938925915096),
                                    ("dayyear", -3.5179216559702966),
                                    ("<named-month> <day-of-month> (non ordinal)until <time-of-day>",
                                     -4.770684624465665),
                                    ("monthminute", -4.770684624465665),
                                    ("minutemonth", -4.07753744390572),
                                    ("Aprilyear", -4.770684624465665),
                                    ("<time-of-day> popo\322udniu/wieczorem/w nocyintersect by \",\"",
                                     -4.3652195163575005),
                                    ("after <time-of-day>at <time-of-day>", -4.770684624465665),
                                    ("SundayMarch", -4.770684624465665),
                                    ("<time> <part-of-day><time-of-day> rano", -4.770684624465665),
                                    ("<time-of-day> rano<time> <part-of-day>", -4.3652195163575005),
                                    ("at <time-of-day>intersect", -4.770684624465665),
                                    ("intersectyear", -3.5179216559702966),
                                    ("intersectSeptember", -4.07753744390572),
                                    ("minuteday", -3.0659365322272394),
                                    ("hh:mmon <date>", -4.3652195163575005),
                                    ("at <time-of-day>intersect by \",\"", -4.770684624465665),
                                    ("MondayMarch", -4.770684624465665),
                                    ("tomorrowexactly <time-of-day>", -4.770684624465665),
                                    ("absorption of , after named daySeptember",
                                     -4.770684624465665),
                                    ("hh:mmon a named-day", -4.3652195163575005),
                                    ("Sundayon <date>", -4.3652195163575005),
                                    ("absorption of , after named dayFebruary", -3.672072335797555),
                                    ("tomorrowat <time-of-day>", -4.770684624465665),
                                    ("<time-of-day> popo\322udniu/wieczorem/w nocyintersect",
                                     -4.3652195163575005),
                                    ("Tuesdayintersect", -4.3652195163575005),
                                    ("Sundayintersect", -4.3652195163575005)],
                               n = 56}}),
       ...
       ("this <time>",
        Classifier{okData =
                     ClassData{prior = -0.8362480242006186, unseen = -3.784189633918261,
                               likelihoods =
                                 HashMap.fromList
                                   [("Thursday", -3.068052935133617),
                                    ("on <date>", -3.068052935133617),
                                    ("Wednesday", -3.068052935133617),
                                    ("season", -2.662587827025453),
                                    ("Saturday", -3.068052935133617),
                                    ("evening|night", -3.068052935133617),
                                    ("Friday", -3.068052935133617), ("day", -1.563975538357343),
                                    ("Sunday", -3.068052935133617), ("hour", -1.9694406464655074),
                                    ("Tuesday", -3.068052935133617),
                                    ("week-end", -2.374905754573672)],
                               n = 13},
                   koData =
                     ClassData{prior = -0.5679840376059393, unseen = -3.951243718581427,
                               likelihoods =
                                 HashMap.fromList
                                   [("on <date>", -3.2386784521643803),
                                    ("season", -2.833213344056216),
                                    ("evening|night", -3.2386784521643803),
                                    ("Monday", -3.2386784521643803), ("April", -2.833213344056216),
                                    ("day", -2.1400661634962708), ("February", -1.7346010553881064),
                                    ("hour", -2.833213344056216), ("month", -1.5339303599259553),
                                    ("<named-month> <day-of-month> (non ordinal)",
                                     -2.833213344056216)],
                               n = 17}}),
