       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.42819335918572043,
                               unseen = -5.955837369464831,
                               likelihoods =
                                 HashMap.fromList
                                   [("intersect<hour-of-day> <integer> (as relative minutes)",
                                     -5.260096153727839),
                                    ("intersectday-of-week", -4.161483865059729),
                                    ("year<time> \47560\51648\47561 <cycle>", -4.854631045619675),
                                    ("next <cycle>day-of-week", -4.343805421853684),
                                    ("dayhour", -2.0214177015634585),
                                    ("monthday", -2.4268828096716226),
                                    ("yearhour", -3.5553480614894135),
                                    ("<time> <part-of-day>time-of-day", -4.343805421853684),
                                    ("intersectam|pm <time-of-day>", -3.0628715763916197),
                                    ("next <cycle><time-of-day> am|pm", -5.260096153727839),
                                    ("next <cycle>am|pm <time-of-day>", -4.854631045619675),
                                    ("yearintersect", -2.9575110607337933),
                                    ...
                                    ("monthday with korean number - \51068\51068..\44396\51068",
                                     -5.260096153727839),
                                    ("dayday-of-week", -4.343805421853684),
                                    ("this <cycle>day-of-week", -4.854631045619675),
                                    ("day-of-week<time> timezone", -4.854631045619675),
                                    ("monthhour", -3.5553480614894135),
                                    ("mm/ddam|pm <time-of-day>", -4.566948973167894),
                                    ("todayam|pm <time-of-day>", -4.566948973167894),
                                    ("the day before yesterday - \50634\44536\51228am|pm <time-of-day>",
                                     -4.343805421853684),
                                    ("dayday", -3.6506582412937383),
                                    ("hourhour", -3.8738017926079484),
                                    ("year<time> <ordinal> <cycle>", -5.260096153727839),
                                    ("month<datetime> - <datetime> (interval)", -4.854631045619675),
                                    ("dayam|pm <time-of-day>", -5.260096153727839),
                                    ("day-of-weekam|pm <time-of-day>", -4.566948973167894),
                                    ("monthminute", -4.854631045619675),
                                    ("hourminute", -4.566948973167894),
                                    ("intersectday", -4.161483865059729),
                                    ("am|pm <time-of-day>after <time-of-day>", -5.260096153727839),
                                    ("last <cycle>day-of-week", -4.566948973167894),
                                    ("month<time> <part-of-day>", -4.854631045619675),
                                    ("yearmonth", -3.120029990231568),
                                    ("dayminute", -3.3882939768262474),
                                    ("today<date>\50640", -5.260096153727839),
                                    ("mm/dd<date>\50640", -5.260096153727839),
                                    ("<time> <part-of-day><date>\50640", -4.854631045619675),
                                    ("monthintersect", -3.6506582412937383),
                                    ("year<time> \47560\51648\47561 <day-of-week>",
                                     -5.260096153727839),
                                    ("intersectintersect", -3.468336684499784),
                                    ("weekday", -3.6506582412937383),
                                    ("intersectday with korean number - \51068\51068..\44396\51068",
                                     -4.854631045619675),
                                    ("yearday", -3.468336684499784),
                                    ("day-of-weekhh:mm", -4.854631045619675),
                                    ("yearweek", -4.854631045619675),
                                    ("<time> <part-of-day><hour-of-day> <integer> (as relative minutes)",
                                     -4.854631045619675),
                                    ("tomorrow<time-of-day> am|pm", -5.260096153727839),
                                    ("tomorrowam|pm <time-of-day>", -4.854631045619675),
                                    ("dayintersect", -4.854631045619675),
                                    ("day-of-weektime-of-day", -5.260096153727839)],
                               n = 174},
                   koData =
                     ClassData{prior = -1.0546491652469936, unseen = -5.54907608489522,
                               likelihoods =
                                 HashMap.fromList
                                   [("year<time> \47560\51648\47561 <cycle>", -4.852030263919617),
                                    ("day-of-weekintersect", -4.852030263919617),
                                    ("dayhour", -2.2129729343043585),
                                    ("monthday", -3.147282171681192),
                                    ("yearhour", -3.147282171681192),
                                    ("<time> <part-of-day>time-of-day", -3.7534179752515073),
                                    ("houryear", -4.1588830833596715),
                                    ("day-of-weekafter <time-of-day>", -4.852030263919617),
                                    ("after <time-of-day>by <time> - \44620\51648",
                                     -4.852030263919617),
                                    ("intersectam|pm <time-of-day>", -4.446565155811453),
                                    ("hournograin", -4.852030263919617),
                                    ("intersect<time> <part-of-day>", -3.9357395320454622),
                                    ("yearintersect", -2.9802280870180256),
                                    ("day-of-week<time-of-day> - <time-of-day> (interval)",
                                     -4.446565155811453),
                                    ("time-of-day<duration> ago", -4.852030263919617),
                                    ("this <cycle>day-of-week", -4.446565155811453),
                                    ("intersecttime-of-day", -4.446565155811453),
                                    ("monthhour", -2.9802280870180256),
                                    ("intersectlast <time>", -4.852030263919617),
                                    ("dayday", -3.9357395320454622),
                                    ("hourhour", -3.0602707946915624),
                                    ("month<datetime> - <datetime> (interval)",
                                     -3.9357395320454622),
                                    ("dayam|pm <time-of-day>", -4.446565155811453),
                                    ("day-of-weekam|pm <time-of-day>", -4.852030263919617),
                                    ("time-of-dayafter <time-of-day>", -4.852030263919617),
                                    ("hourminute", -4.1588830833596715),
                                    ("<time-of-day> - <time-of-day> (interval)last <time>",
                                     -4.446565155811453),
                                    ("intersectday", -4.446565155811453),
                                    ("<datetime> - <datetime> (interval)day", -3.9357395320454622),
                                    ("month<time> <part-of-day>", -4.446565155811453),
                                    ("yearmonth", -4.446565155811453),
                                    ("dayminute", -4.446565155811453),
                                    ("<hour-of-day> <integer> (as relative minutes)seconds",
                                     -4.852030263919617),
                                    ("<time> <part-of-day><date>\50640", -4.852030263919617),
                                    ("monthintersect", -3.347952867143343),
                                    ("year<time> <part-of-day>", -4.446565155811453),
                                    ("intersectintersect", -3.5992672954242493),
                                    ("weekday", -4.446565155811453),
                                    ("intersectday with korean number - \51068\51068..\44396\51068",
                                     -4.446565155811453),
                                    ("day<time> <part-of-day>", -4.852030263919617),
                                    ("yearday", -3.7534179752515073),
                                    ("day-of-weekhh:mm", -4.446565155811453),
                                    ("<time-of-day> - <time-of-day> (interval)time-of-day",
                                     -4.446565155811453),
                                    ("intersectafter <time-of-day>", -3.347952867143343),
                                    ("minutesecond", -4.852030263919617),
                                    ("<time> <part-of-day><hour-of-day> <integer> (as relative minutes)",
                                     -4.446565155811453),
                                    ("dayintersect", -4.852030263919617),
                                    ("mm/ddafter <time-of-day>", -4.852030263919617),
                                    ("todayafter <time-of-day>", -4.852030263919617)],
                               n = 93}}),
       ("season",
        Classifier{okData =
                     ClassData{prior = 0.0, unseen = -1.3862943611198906,
