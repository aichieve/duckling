  ...
  = HashMap.fromList
      [("<cycle> (que vem)",
       ...
       ("intersect by `da` or `de`",
        Classifier{okData =
                     ClassData{prior = -1.9752377641498333,
                               unseen = -4.7535901911063645,
                               likelihoods =
                                 HashMap.fromList
                                   [("daymonth", -2.953172659135195),
                                    ...
                                    ("Quart-feira<cycle> (que vem)", -4.051784947803305),
                                    ("dayyear", -2.1799827709017134),
                                    ("quarteryear", -4.051784947803305),
                                    ("<ordinal> trimestreyear", -4.051784947803305),
                                    ("day of month (1st)Mar\231o", -3.3586377672433594),
                                    ("two time tokens separated by \",\"2year",
                                     -3.6463198396951406),
                                    ("intersectyear", -4.051784947803305),
                                    ("<day-of-month> de <named-month>year", -2.665490586683414),
                                    ("dia <day-of-month> (non ordinal)Fevereiro",
                                     -3.6463198396951406),
                                    ("two time tokens separated by \",\"year", -3.6463198396951406),
                                    ("Domingo<cycle> passado", -4.051784947803305),
                                    ("dayweek", -3.3586377672433594),
                                    ("Quart-feiraproximo <cycle> ", -4.051784947803305)],
                               n = 24},
                   koData =
                     ClassData{prior = -0.14934528855231985,
                               unseen = -5.902633333401366,
                               likelihoods =
                                 HashMap.fromList
                                   [("time-of-day (latent)<datetime> - <datetime> (interval)",
                                     -5.206750173022546),
                                    ("hourday", -3.0666840095262753),
                                    ("year (latent)Abril", -4.801285064914382),
                                    ("year (latent)Julho", -3.3349479961209547),
                                    ("time-of-day (latent)Fevereiro", -3.953987204527178),
                                    ("monthday", -4.513602992462601),
                                    ("monthyear", -3.597312260588446),
                                    ("yearhour", -3.8204558119026557),
                                    ("entre <datetime> e <datetime> (interval)Julho",
                                     -4.513602992462601),
                                    ("houryear", -3.260840023967233),
                                    ("year (latent)Maio", -4.290459441148391),
                                    ("time-of-day (latent)two time tokens separated by \",\"2",
                                     -4.801285064914382),
                                    ("Setembroyear", -4.108137884354437),
                                    ("time-of-day (latent)Setembro", -4.108137884354437),
                                    ("time-of-day (latent)intersect", -3.260840023967233),
                                    ("year (latent)<time-of-day> <part-of-day>",
                                     -5.206750173022546),
                                    ("\224s <time-of-day>Julho", -4.513602992462601),
                                    ("year (latent)intersect", -4.513602992462601),
                                    ("Setembrointersect", -5.206750173022546),
                                    ("intersect by `da` or `de`two time tokens separated by \",\"",
                                     -5.206750173022546),
                                    ("year (latent)amanh\227 pela <part-of-day>",
                                     -5.206750173022546),
                                    ("hourmonth", -1.7727629685374),
                                    ("time-of-day (latent)intersect by `da` or `de`",
                                     -3.414990703794491),
                                    ("Setembrotwo time tokens separated by \",\"2",
                                     -5.206750173022546),
                                    ("year (latent)Fevereiro", -3.953987204527178),
                                    ("time-of-day (latent)Dezembro", -5.206750173022546),
                                    ("dayyear", -5.206750173022546),
                                    ("time-of-day (latent)Julho", -3.502002080784121),
                                    ("time-of-day (latent)Abril", -4.801285064914382),
                                    ("passado <cycle>year", -5.206750173022546),
                                    ("year (latent)<dim time> da manha", -5.206750173022546),
                                    ("time-of-day (latent)Mar\231o", -4.108137884354437),
                                    ("year (latent)Janeiro", -5.206750173022546),
                                    ("year (latent)Dezembro", -5.206750173022546),
                                    ("yearmonth", -2.211017899468555),
                                    ("two time tokens separated by \",\"2year", -4.801285064914382),
                                    ("Setembrotwo time tokens separated by \",\"",
                                     -5.206750173022546),
                                    ("intersect by `da` or `de`intersect", -5.206750173022546),
                                    ("intersectyear", -5.206750173022546),
                                    ("intersect by `da` or `de`two time tokens separated by \",\"2",
                                     -5.206750173022546),
                                    ("time-of-day (latent)Maio", -4.290459441148391),
                                    ("<day-of-month> de <named-month>year", -5.206750173022546),
                                    ("antes das <time-of-day>Julho", -3.953987204527178),
                                    ("Maioyear", -4.801285064914382),
                                    ("year (latent)Setembro", -4.108137884354437),
                                    ("\224s <time-of-day>Janeiro", -5.206750173022546),
                                    ("two time tokens separated by \",\"year", -4.801285064914382),
                                    ("time-of-day (latent)two time tokens separated by \",\"",
                                     -4.801285064914382),
                                    ("intersect by `da` or `de`year", -3.7026727762462723),
                                    ("year (latent)<datetime> - <datetime> (interval)",
                                     -5.206750173022546),
                                    ("time-of-day (latent)Janeiro", -5.206750173022546),
                                    ("Julhoyear", -5.206750173022546),
                                    ("de <datetime> - <datetime> (interval)Julho",
                                     -5.206750173022546),
                                    ("year (latent)Mar\231o", -4.108137884354437)],
                               n = 149}}),
       ...
       ("integer (0..19)",
        Classifier{okData =
                     ClassData{prior = -0.1416505170630268, unseen = -3.871201010907891,
       ...
       ("time-of-day (latent)",
        Classifier{okData =
                     ClassData{prior = -1.4500101755059984,
                               unseen = -3.1354942159291497,
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -1.0116009116784799),
                                    ("integer (0..19)", -0.5260930958967791)],
                               n = 19},
                   koData =
                     ClassData{prior = -0.2673147696273473, unseen = -4.189654742026425,
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -0.3677247801253174),
                                    ("integer (0..19)", -1.2840155119994723),
       ...
       ("\224s <time-of-day>",
        Classifier{okData =
                     ClassData{prior = -0.579818495252942, unseen = -4.219507705176107,
                               likelihoods =
                                 HashMap.fromList
                                   [("<hour-of-day> and half", -3.1060803307228566),
                                    ("<time-of-day> horas", -3.5115454388310208),
                                    ("<hour-of-day> and 3/4", -3.1060803307228566),
                                    ("time-of-day (latent)", -1.4321038971511848),
                                    ("<hour-of-day> and <relative minutes>", -2.412933150162911),
                                    ("<time-of-day> am|pm", -3.5115454388310208),
                                    ("hour", -1.3143208614948014),
                                    ("<hour-of-day> and quinze", -3.1060803307228566),
                                    ("minute", -1.7197859696029658)],
                               n = 28},
                   koData =
                     ClassData{prior = -0.8209805520698302, unseen = -4.02535169073515,
                               likelihoods =
                                 HashMap.fromList
                                   [("midnight", -3.3141860046725258),
                                    ("<time> timezone", -3.3141860046725258),
                                    ("<hour-of-day> and half", -2.908720896564361),
                                    ("<time-of-day> horas", -3.3141860046725258),
                                    ("time-of-day (latent)", -1.4423838277709342),
                                    ("<hour-of-day> and <relative minutes>", -2.3978952727983707),
                                    ("hour", -1.2347444629926898),
                                    ("<hour-of-day> and quinze", -3.3141860046725258),
       ...
       ("this <time>",
        Classifier{okData =
                     ClassData{prior = -0.3677247801253174, unseen = -3.258096538021482,
                               likelihoods =
                                 HashMap.fromList
                                   [("season", -2.120263536200091),
                                    ("dia <day-of-month> (non ordinal)", -1.8325814637483102),
                                    ("day", -1.4271163556401458), ("hour", -1.6094379124341003),
                                    ("evening", -2.120263536200091),
                                    ("week-end", -2.120263536200091)],
                               n = 9},
                   koData =
                     ClassData{prior = -1.1786549963416462, unseen = -2.772588722239781,
                               likelihoods =
                                 HashMap.fromList
                                   [("season", -2.0149030205422647),
                                    ("Segunda-feira", -1.3217558399823195),
