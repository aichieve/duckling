...
classifiers
  = HashMap.fromList
      [("Military Spouse Day",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.5566720118914094,
                               unseen = -6.1903154058531475,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 486},
                   koData =
                     ClassData{prior = -0.8512364239661321,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4507216996962853, unseen = -7.1785454837637,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.484635235635252),
                                    ("Father's Dayyear (latent)", -6.484635235635252),
                                    ("Karva Chauthyear (latent)", -6.484635235635252),
                                    ("<day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.484635235635252),
                                    ("Maha Shivaratriyear (latent)", -6.484635235635252),
                                    ("Ramadanyear (latent)", -5.231872267139884),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -5.098340874515361),
                                    ("Military Spouse Dayyear (latent)", -6.484635235635252),
                                    ("Bhai Doojyear (latent)", -6.484635235635252),
                                    ("hourday", -4.4697322150929875),
                                    ("dayhour", -3.5401962564688114),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.098340874515361),
                                    ("Martin Luther King's Dayyear (latent)", -6.079170127527087),
                                    ("Shemini Atzeretyear (latent)", -6.484635235635252),
                                    ("daymonth", -4.4697322150929875),
                                    ("monthday", -6.079170127527087),
                                    ("monthyear", -4.692875766407197),
                                    ("Yom Ha'atzmautyear (latent)", -6.484635235635252),
                                    ("Vijayadashamiyear (latent)", -6.484635235635252),
                                    ("Administrative Professionals' Dayyear (latent)",
                                     -5.098340874515361),
                                    ("Thanksgiving Dayyear (latent)", -5.386022946967143),
                                    ("Thai Pongalyear (latent)", -5.791488055075306),
                                    ("Thiru Onamyear (latent)", -5.791488055075306),
                                    ("hhhmmabsorption of , after named day", -6.484635235635252),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.484635235635252),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.568344503761097),
                                    ("<day-of-month> (ordinal)Wednesday", -6.484635235635252),
                                    ("Krishna Janmashtamiyear (latent)", -6.079170127527087),
                                    ("Guru Gobind Singh Jayantiyear (latent)", -6.484635235635252),
                                    ("houryear", -5.568344503761097),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.484635235635252),
                                    ("Christmas<time-of-day> am|pm", -6.484635235635252),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.484635235635252),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.791488055075306),
                                    ("intersectin|during <named-month>|year", -6.484635235635252),
                                    ("<time-of-day> am|pmintersect", -5.231872267139884),
                                    ("Earth Houryear (latent)", -6.484635235635252),
                                    ("Ganesh Chaturthiyear (latent)", -6.484635235635252),
                                    ("Octoberyear (latent)", -4.980557838858978),
                                    ("intersect<time-of-day> am|pm", -6.484635235635252),
                                    ("Mattu Pongalyear (latent)", -6.484635235635252),
                                    ("Daylight Saving Start Dayyear (latent)", -5.568344503761097),
                                    ("Shavuotyear (latent)", -6.484635235635252),
                                    ("Parsi New Yearyear (latent)", -5.568344503761097),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.484635235635252),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.484635235635252),
                                    ("todayin|within|after <duration>", -6.484635235635252),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -6.079170127527087),
                                    ("Marchyear (latent)", -6.484635235635252),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hhhmm",
                                     -6.079170127527087),
                                    ("Sukkotyear (latent)", -6.079170127527087),
                                    ("hhhmmintersect", -6.079170127527087),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -6.079170127527087),
                                    ("Daylight Saving End Dayyear (latent)", -5.568344503761097),
                                    ("Clean Mondayyear (latent)", -6.079170127527087),
                                    ("monthhour", -6.079170127527087),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.791488055075306),
                                    ("todayat <time-of-day>", -6.484635235635252),
                                    ("Thursday<time> timezone", -4.086739962836881),
                                    ("time-of-day (latent)tonight", -6.079170127527087),
                                    ("from|since|after <time>December", -6.484635235635252),
                                    ("Emergency Medical Services for Children Dayyear (latent)",
                                     -6.484635235635252),
                                    ("<time-of-day> am|pmon <day>", -4.4697322150929875),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.484635235635252),
                                    ("yyyy-mm-ddhh:mm:ss", -6.079170127527087),
                                    ("Tax Daythis|last|next <cycle>", -6.484635235635252),
                                    ("dayday", -3.776585034533042),
                                    ("<time> <part-of-day>at <time-of-day>", -6.484635235635252),
                                    ("mm/ddat <time-of-day>", -6.484635235635252),
                                    ("tonightat <time-of-day>", -6.484635235635252),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.791488055075306),
                                    ("Dayananda Saraswati Jayantiyear (latent)",
                                     -6.484635235635252),
                                    ("today<time-of-day> am|pm", -6.484635235635252),
                                    ("Februarythe <day-of-month> (ordinal)", -6.079170127527087),
                                    ("at <time-of-day><time> <part-of-day>", -6.484635235635252),
                                    ("<day-of-month> (ordinal)intersect", -6.079170127527087),
                                    ("mm/dd<time-of-day> am|pm", -6.484635235635252),
                                    ("hourhour", -4.405193693955416),
                                    ("Mahavir Jayantiyear (latent)", -6.079170127527087),
                                    ("Navaratriin|during <named-month>|year", -6.484635235635252),
                                    ("Wednesdaythis|last|next <cycle>", -6.484635235635252),
                                    ("Lentyear (latent)", -6.484635235635252),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.612833058733661),
                                    ("Boghiyear (latent)", -6.484635235635252),
                                    ("dayyear", -1.7706106447350785),
                                    ("Karva Chauthin|during <named-month>|year",
                                     -6.484635235635252),
                                    ("Thursdayfrom|since|after <time>", -6.079170127527087),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.484635235635252),
                                    ("Thursdayat <time-of-day>", -5.791488055075306),
                                    ("Islamic New Yearyear (latent)", -6.079170127527087),
                                    ("Laylat al-Qadryear (latent)", -5.568344503761097),
                                    ("Shrove Tuesdayyear (latent)", -6.484635235635252),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.791488055075306),
                                    ("<time-of-day> am|pmtomorrow", -5.791488055075306),
                                    ("Yom Kippuryear (latent)", -6.484635235635252),
                                    ("<day-of-month> (ordinal)Tuesday", -6.079170127527087),
                                    ("<part-of-day> of <time>year (latent)", -6.484635235635252),
                                    ("minutehour", -5.231872267139884),
                                    ("Kaanum Pongalyear (latent)", -6.079170127527087),
                                    ("Maha Saptamiyear (latent)", -6.484635235635252),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -6.079170127527087),
                                    ("time-of-day (latent)tomorrow", -5.568344503761097),
                                    ("part of daysat <time-of-day>", -6.079170127527087),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.4697322150929875),
                                    ("for <duration> from <time>December", -6.484635235635252),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.484635235635252),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.231872267139884),
                                    ("intersect by \",\", \"of\", \"from\" for yearhhhmm",
                                     -5.231872267139884),
                                    ("time-of-day (latent)this <part-of-day>", -6.484635235635252),
                                    ("Pentecostyear (latent)", -6.484635235635252),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.231872267139884),
                                    ("<day-of-month> (ordinal)February", -6.484635235635252),
                                    ("Eid al-Fitryear (latent)", -5.098340874515361),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.484635235635252),
                                    ("Mondayin|during the <part-of-day>", -6.484635235635252),
                                    ("Chhathin|during <named-month>|year", -6.484635235635252),
                                    ("Diwaliin|during <named-month>|year", -6.484635235635252),
                                    ("Vaisakhiin|during <named-month>|year", -6.484635235635252),
                                    ("Guru Ravidass Jayantiyear (latent)", -5.231872267139884),
                                    ("Raksha Bandhanyear (latent)", -6.484635235635252),
                                    ("daysecond", -6.079170127527087),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -6.079170127527087),
                                    ("Emancipation Dayyear (latent)", -5.791488055075306),
                                    ("Ratha-Yatrayear (latent)", -6.484635235635252),
                                    ("Ashurayear (latent)", -6.484635235635252),
                                    ("Tuesdayin|during <named-month>|year", -6.484635235635252),
                                    ("Chinese New Yearyear (latent)", -6.484635235635252),
                                    ("tomorrowintersect", -6.484635235635252),
                                    ("Lag BaOmeryear (latent)", -6.484635235635252),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.484635235635252),
                                    ("Eid al-Adhayear (latent)", -4.344569072138981),
                                    ("intersectin|during the <part-of-day>", -6.484635235635252),
                                    ("Palm Sundayyear (latent)", -6.484635235635252),
                                    ("Christmasat <time-of-day>", -6.484635235635252),
                                    ("Passoveryear (latent)", -6.484635235635252),
                                    ("Lazarus Saturdayyear (latent)", -6.484635235635252),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.484635235635252),
                                    ("Cyber Mondayyear (latent)", -6.079170127527087),
                                    ("hhhmmon <day>", -5.568344503761097),
                                    ("Yom HaShoahyear (latent)", -6.079170127527087),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -6.079170127527087),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.484635235635252),
                                    ("Septemberyear (latent)", -6.079170127527087),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.980557838858978),
                                    ("Halloweenyear (latent)", -6.484635235635252),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.484635235635252),
                                    ("at <time-of-day>intersect", -5.568344503761097),
                                    ("Rosh Hashanahyear (latent)", -5.791488055075306),
                                    ("Dhanterasyear (latent)", -6.484635235635252),
                                    ("Tu BiShvatyear (latent)", -6.484635235635252),
                                    ("<day-of-month> (ordinal)December", -5.791488055075306),
                                    ("Holiyear (latent)", -5.791488055075306),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.484635235635252),
                                    ("Holika Dahanyear (latent)", -5.791488055075306),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.079170127527087),
                                    ("dayminute", -3.1347311483606473),
                                    ("Mawlidyear (latent)", -6.484635235635252),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -6.079170127527087),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.484635235635252),
                                    ("Jumu'atul-Widayear (latent)", -5.568344503761097),
                                    ("minuteday", -2.7469656173518837),
                                    ("absorption of , after named dayintersect",
                                     -5.791488055075306),
                                    ("intersectyear (latent)", -6.484635235635252),
                                    ("Orthodox Easter Sundayyear (latent)", -6.484635235635252),
                                    ("time-of-day (latent)in|within|after <duration>",
                                     -6.484635235635252),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -6.484635235635252),
                                    ("intersecthhhmm", -6.079170127527087),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.484635235635252),
                                    ("Boss's Dayyear (latent)", -6.079170127527087),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.484635235635252),
                                    ("Global Youth Service Dayyear (latent)", -6.484635235635252),
                                    ("Dhanterasin|during <named-month>|year", -6.484635235635252),
                                    ("Tisha B'Avyear (latent)", -6.484635235635252),
                                    ("Isra and Mi'rajyear (latent)", -5.568344503761097),
                                    ("at <time-of-day>on <day>", -4.875197323201151),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.079170127527087),
                                    ("time-of-day (latent)<time> <part-of-day>",
                                     -5.791488055075306),
                                    ("Christmasyear (latent)", -6.079170127527087),
                                    ("Naraka Chaturdashiyear (latent)", -6.079170127527087),
                                    ("Thai Pongalin|during <named-month>|year", -6.484635235635252),
                                    ("Emergency Medical Services Weekyear (latent)",
                                     -6.484635235635252),
                                    ("dayweek", -6.484635235635252),
                                    ("Easter Sundayyear (latent)", -5.791488055075306),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -6.079170127527087),
                                    ("weekyear", -5.386022946967143),
                                    ("King's Dayyear (latent)", -4.980557838858978),
                                    ("hh:mmin|during the <part-of-day>", -5.568344503761097),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -6.079170127527087),
                                    ("Hanukkahyear (latent)", -5.791488055075306),
                                    ("February<time> <part-of-day>", -6.484635235635252),
                                    ("National Grandparents Dayyear (latent)", -6.484635235635252),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -6.484635235635252),
                                    ("Great Lentyear (latent)", -6.484635235635252),
                                    ("tomorrowat <time-of-day>", -5.791488055075306),
                                    ("hhmm (latent)in|during the <part-of-day>",
                                     -6.484635235635252),
                                    ("Labor Dayyear (latent)", -6.484635235635252),
                                    ("Ugadiyear (latent)", -5.098340874515361),
                                    ("Vaisakhiyear (latent)", -5.791488055075306),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -5.791488055075306),
                                    ("last <cycle> of <time>year (latent)", -5.791488055075306),
                                    ("at <time-of-day>tomorrow", -6.079170127527087),
                                    ("tomorrow<time-of-day> am|pm", -6.484635235635252),
                                    ("President's Dayyear (latent)", -6.484635235635252),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.484635235635252),
                                    ("Diwaliyear (latent)", -6.484635235635252),
                                    ("between <time> and <time>on <day>", -6.079170127527087),
                                    ("Black Fridayyear (latent)", -6.079170127527087),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.484635235635252),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.484635235635252),
                                    ("Chhathyear (latent)", -6.079170127527087),
                                    ("Vasant Panchamiyear (latent)", -6.484635235635252),
                                    ("Tax Dayyear (latent)", -5.568344503761097),
                                    ("Rabindra Jayantiyear (latent)", -5.231872267139884),
                                    ("St Patrick's Dayyear (latent)", -6.484635235635252),
                                    ("Thursday<time> (timezone)", -6.484635235635252),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.484635235635252),
                                    ("Pargat Diwasyear (latent)", -5.231872267139884),
                                    ("<datetime> - <datetime> (interval)July", -6.079170127527087),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.791488055075306),
                                    ("Februaryintersect", -6.484635235635252),
                                    ("Mother's Dayyear (latent)", -6.484635235635252),
                                    ("Simchat Torahyear (latent)", -6.484635235635252),
                                    ("minuteyear", -6.484635235635252)],
                               n = 504},
                   koData =
                     ClassData{prior = -1.0138157520080326, unseen = -6.776506992372183,
                               likelihoods =
                                 HashMap.fromList
                                   [("Thursdayhhhmm", -4.578141513600172),
                                    ("hourday", -3.6843236375780757),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -6.082218910376446),
                                    ("<day-of-month> (ordinal)August", -6.082218910376446),
                                    ("dayhour", -3.220018029446978),
                                    ("<time> timezoneyear (latent)", -5.389071729816501),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.165928178502291),
                                    ("Tuesdayfrom|since|after <time>", -5.389071729816501),
                                    ("daymonth", -3.4080702609499176),
                                    ("monthday", -5.165928178502291),
                                    ("monthyear", -4.829455941881078),
                                    ("<time-of-day> am|pmyear (latent)", -5.389071729816501),
                                    ("Thai Pongalyear (latent)", -5.389071729816501),
                                    ("intersecthh:mm", -6.082218910376446),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.676753802268282),
                                    ("<day-of-month> (ordinal)Wednesday", -6.082218910376446),
                                    ("houryear", -4.695924549256556),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -6.082218910376446),
                                    ("<day-of-month> (ordinal)October", -6.082218910376446),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.389071729816501),
                                    ("hournograin", -4.829455941881078),
                                    ("<time-of-day> am|pmintersect", -4.829455941881078),
                                    ("Octoberyear (latent)", -6.082218910376446),
                                    ("time-of-day (latent)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.676753802268282),
                                    ("until <time>on <day>", -5.389071729816501),
                                    ("time-of-day (latent)intersect", -5.389071729816501),
                                    ("todayin <number> (implicit minutes)", -6.082218910376446),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.389071729816501),
                                    ("about|exactly <time-of-day>year (latent)",
                                     -6.082218910376446),
                                    ("hh:mmon <day>", -4.829455941881078),
                                    ("hhhmmintersect", -5.676753802268282),
                                    ("absorption of , after named dayJuly", -5.165928178502291),
                                    ...
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.676753802268282),
                                    ("hourmonth", -4.210416733474855),
                                    ("todayat <time-of-day>", -6.082218910376446),
                                    ("hhhmmyear (latent)", -4.829455941881078),
                                    ("from|since|after <time>December", -6.082218910376446),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -6.082218910376446),
                                    ("<time-of-day> am|pmon <day>", -4.829455941881078),
                                    ("Mondayyear (latent)", -4.983606621708336),
                                    ("dayday", -4.695924549256556),
                                    ("mm/ddat <time-of-day>", -5.676753802268282),
                                    ("on <day>September", -5.389071729816501),
                                    ("time-of-day (latent)September", -5.676753802268282),
                                    ("hourhour", -5.676753802268282),
                                    ("time-of-day (latent)on <day>", -4.578141513600172),
                                    ("time-of-day (latent)<cycle> after|before <time>",
                                     -5.676753802268282),
                                    ("dayyear", -3.086486636822455),
                                    ("Thursdaymm/dd", -6.082218910376446),
                                    ("New Year's Dayyear (latent)", -5.165928178502291),
                                    ("time-of-day (latent)Sunday", -5.676753802268282),
                                    ("Thursdayfrom|since|after <time>", -4.377470818138021),
                                    ("Thursdayat <time-of-day>", -4.472780997942346),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -6.082218910376446),
                                    ("Aprilyear (latent)", -6.082218910376446),
                                    ("the <day-of-month> (ordinal)July", -6.082218910376446),
                                    ("the <day-of-month> (number)July", -6.082218910376446),
                                    ("monthminute", -6.082218910376446),
                                    ("<time-of-day> am|pmtomorrow", -6.082218910376446),
                                    ("Thursdayhh:mm", -5.165928178502291),
                                    ("<day-of-month> (ordinal)Tuesday", -5.676753802268282),
                                    ("minutemonth", -3.9421527468801756),
                                    ("time-of-day (latent)Friday", -5.676753802268282),
                                    ("minutehour", -6.082218910376446),
                                    ("this|last|next <cycle>from|since|after <time>",
                                     -5.676753802268282),
                                    ("tomorrowfrom|since|after <time>", -5.676753802268282),
                                    ("Augustyear (latent)", -5.676753802268282),
                                    ("week-endin|during <named-month>|year", -6.082218910376446),
                                    ("this|last|next <cycle>until <time>", -5.676753802268282),
                                    ("time-of-day (latent)Tuesday", -5.676753802268282),
                                    ("tomorrowuntil <time>", -5.676753802268282),
                                    ("mm/dd<time-of-day> - <time-of-day> (interval)",
                                     -5.676753802268282),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -6.082218910376446),
                                    ("Sundayyear (latent)", -5.165928178502291),
                                    ("Christmasat <time-of-day>", -6.082218910376446),
                                    ("from|since|after <time>year (latent)", -4.983606621708336),
                                    ("hhhmmon <day>", -5.165928178502291),
                                    ("yesterday<time-of-day> am|pm", -6.082218910376446),
                                    ("<day-of-month> (ordinal)July", -5.389071729816501),
                                    ...
                                    ("in|during <named-month>|yearyear (latent)",
                                     -6.082218910376446),
                                    ("at <time-of-day>intersect", -5.165928178502291),
                                    ("hh:mmyear (latent)", -4.695924549256556),
                                    ("Holiyear (latent)", -6.082218910376446),
                                    ("until <time><time-of-day> am|pm", -6.082218910376446),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.676753802268282),
                                    ("dayminute", -3.220018029446978),
                                    ("yyyy-mm-ddhh:mm", -5.676753802268282),
                                    ("intersectfrom|since|after <time>", -5.676753802268282),
                                    ("intersectSeptember", -4.210416733474855),
                                    ("minuteday", -2.925218489226333),
                                    ("absorption of , after named dayintersect",
                                     -6.082218910376446),
                                    ("intersectyear (latent)", -6.082218910376446),
                                    ("Februaryin|during the <part-of-day>", -6.082218910376446),
                                    ("<duration> after|before|from|past <time>December",
                                     -6.082218910376446),
                                    ("time-of-day (latent)July", -5.389071729816501),
                                    ("Saturdayyear (latent)", -6.082218910376446),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.082218910376446),
                                    ("at <time-of-day>on <day>", -5.165928178502291),
                                    ("absorption of , after named daySeptember",
                                     -4.829455941881078),
                                    ("Naraka Chaturdashiyear (latent)", -6.082218910376446),
                                    ("from|since|after <time>on <day>", -5.165928178502291),
                                    ("dayweek", -6.082218910376446),
                                    ("Easter Sundayyear (latent)", -5.676753802268282),
                                    ("Thursday<time-of-day> am|pm", -4.829455941881078),
                                    ("weekyear", -5.676753802268282),
                                    ("time-of-day (latent)Thursday", -5.676753802268282),
                                    ("<named-month> <day-of-month> (non ordinal)until <time>",
                                     -6.082218910376446),
                                    ("<day-of-month> (ordinal)April", -6.082218910376446),
                                    ("yyyy-mm-dd<time-of-day> - <time-of-day> (interval)",
                                     -5.676753802268282),
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.389071729816501),
                                    ("Sundayfrom|since|after <time>", -6.082218910376446),
                                    ("absorption of , after named dayFebruary", -5.165928178502291),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.676753802268282),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -6.082218910376446),
                                    ("tomorrowat <time-of-day>", -6.082218910376446),
                                    ("daynograin", -5.676753802268282),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.676753802268282),
                                    ("last <cycle> of <time>year (latent)", -5.676753802268282),
                                    ("tomorrow<time-of-day> am|pm", -5.389071729816501),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.389071729816501),
                                    ("Diwaliyear (latent)", -5.676753802268282),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -6.082218910376446),
                                    ("Fridayyear (latent)", -5.676753802268282),
                                    ("time-of-day (latent)April", -6.082218910376446),
                                    ("minuteyear", -3.884994333040227)],
                               n = 287}}),
       ("one eleven",
        Classifier{okData =
       ...
       ("this|last|next <cycle>",
        Classifier{okData =
                     ClassData{prior = -0.1949003390008148,
                               ...
                               n = 79},
                   koData =
                     ClassData{prior = -1.7311348474116202,
                               unseen = -3.8066624897703196,
                               likelihoods =
                                 HashMap.fromList
       ...
       ("<integer> <unit-of-duration>",
        Classifier{okData =
                     ClassData{prior = -0.4462871026284195,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("week", -2.5933872927820705),
                                    ("integer (0..19)year (grain)", -3.0633909220278057),
                                    ("integer (numeric)day (grain)", -2.5933872927820705),
                                    ("integer (0..19)second (grain) ", -3.979681653901961),
                                    ("integer (0..19)hour (grain)", -3.168751437685632),
                                    ("second", -3.5742165457937967),
                                    ("integer (numeric)second (grain) ", -4.267363726353742),
                                    ("integer (numeric)year (grain)", -3.2865344733420154),
                                    ("day", -2.3702437414678603), ("year", -2.5327626709656355),
                                    ("integer (numeric)week (grain)", -3.2865344733420154),
                                    ("integer (0..19)month (grain)", -3.5742165457937967),
                                    ("integer (20..90)minute (grain)", -4.672828834461907),
                                    ("hour", -2.801026657560315), ("month", -3.2865344733420154),
                                    ("integer (numeric)minute (grain)", -2.6579258139196416),
                                    ("integer (0..19)minute (grain)", -3.2865344733420154),
                                    ("integer (numeric)month (grain)", -4.267363726353742),
                                    ("minute", -2.230481799092702),
                                    ("integer (numeric)hour (grain)", -3.756538102587751),
                                    ("integer (0..19)day (grain)", -3.756538102587751),
                                    ("integer (0..19)week (grain)", -3.168751437685632)],
                               n = 96},
                   koData =
                     ClassData{prior = -1.0216512475319814, unseen = -4.875197323201151,
                               likelihoods =
                                 HashMap.fromList
                                   [("hour", -0.8602012652231115),
