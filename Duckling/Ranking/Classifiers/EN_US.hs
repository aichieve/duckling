...
classifiers
  = HashMap.fromList
      [("Military Spouse Day",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.5549968420791281, unseen = -6.210600077024653,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 496},
                   koData =
                     ClassData{prior = -0.8534898306351247, unseen = -5.91350300563827,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4530625165569174, unseen = -7.181591944611865,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.487684018484611),
                                    ("Father's Dayyear (latent)", -6.487684018484611),
                                    ...
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -5.10138965736472),
                                    ("Military Spouse Dayyear (latent)", -6.487684018484611),
                                    ...
                                    ("Octoberyear (latent)", -4.983606621708336),
                                    ("intersect<time-of-day> am|pm", -6.487684018484611),
                                    ("Mattu Pongalyear (latent)", -6.487684018484611),
                                    ("Daylight Saving Start Dayyear (latent)", -5.571393286610456),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -6.082218910376446),
                                    ("Daylight Saving End Dayyear (latent)", -5.571393286610456),
                                    ...
                                    ("Tax Daythis|last|next <cycle>", -6.487684018484611),
                                    ("dayday", -3.7796338173824005),
                                    ("<time> <part-of-day>at <time-of-day>", -6.487684018484611),
                                    ("mm/ddat <time-of-day>", -6.487684018484611),
                                    ("tonightat <time-of-day>", -6.487684018484611),
                                    ...
                                    ("<day-of-month> (ordinal)intersect", -6.082218910376446),
                                    ("mm/dd<time-of-day> am|pm", -6.487684018484611),
                                    ("hourhour", -4.408242476804775),
                                    ...
                                    ("part of daysat <time-of-day>", -6.082218910376446),
                                    ...
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -6.082218910376446),
                                    ("Emancipation Dayyear (latent)", -5.794536837924666),
                                    ...
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.487684018484611),
                                    ("Cyber Mondayyear (latent)", -6.082218910376446),
                                    ...
                                    ("absorption of , after named dayintersect",
                                     -5.794536837924666),
                                    ("intersectyear (latent)", -6.487684018484611),
                                    ...
                                    ("National Grandparents Dayyear (latent)", -6.487684018484611),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -6.487684018484611),
                                    ...
                                    ("hhmm (latent)in|during the <part-of-day>",
                                     -6.487684018484611),
                                    ("Labor Dayyear (latent)", -6.487684018484611),
                                    ...
                                    ("President's Dayyear (latent)", -6.487684018484611),
                                    ...
                                    ("Tax Dayyear (latent)", -5.571393286610456),
                                    ...
                                    ("Mother's Dayyear (latent)", -6.487684018484611),
                                    ("Simchat Torahyear (latent)", -6.487684018484611),
                                    ("minuteyear", -6.487684018484611)],
                               n = 506},
                   koData =
                     ClassData{prior = -1.0097182628638632, unseen = -6.78332520060396,
                               likelihoods =
                                 HashMap.fromList
                                   [("Thursdayhhhmm", -4.584967478670572),
                                    ("hourday", -3.6911496026484754),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -6.089044875446846),
                                    ("<day-of-month> (ordinal)August", -6.089044875446846),
                                    ("dayhour", -3.2268439945173775),
                                    ("<time> timezoneyear (latent)", -5.395897694886901),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.172754143572691),
                                    ("Tuesdayfrom|since|after <time>", -5.395897694886901),
                                    ("daymonth", -3.4148962260203173),
                                    ("monthday", -5.172754143572691),
                                    ("monthyear", -4.4796069630127455),
                                    ("<time-of-day> am|pmyear (latent)", -5.395897694886901),
                                    ("Thai Pongalyear (latent)", -5.395897694886901),
                                    ("intersecthh:mm", -6.089044875446846),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.683579767338681),
                                    ("<day-of-month> (ordinal)Wednesday", -6.089044875446846),
                                    ("houryear", -4.702750514326955),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -6.089044875446846),
                                    ("<day-of-month> (ordinal)October", -6.089044875446846),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.395897694886901),
                                    ("hournograin", -4.836281906951478),
                                    ("<time-of-day> am|pmintersect", -4.836281906951478),
                                    ("Octoberyear (latent)", -6.089044875446846),
                                    ("time-of-day (latent)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.683579767338681),
                                    ("until <time>on <day>", -5.395897694886901),
                                    ("time-of-day (latent)intersect", -5.395897694886901),
                                    ("todayin <number> (implicit minutes)", -6.089044875446846),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.395897694886901),
                                    ("Marchyear (latent)", -5.683579767338681),
                                    ("about|exactly <time-of-day>year (latent)",
                                     -6.089044875446846),
                                    ("hh:mmon <day>", -4.836281906951478),
                                    ("hhhmmintersect", -5.683579767338681),
                                    ("absorption of , after named dayJuly", -5.172754143572691),
                                    ("from|since|after <time>July", -5.683579767338681),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.172754143572691),
                                    ...
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.683579767338681),
                                    ("hourmonth", -4.217242698545254),
                                    ("todayat <time-of-day>", -6.089044875446846),
                                    ("hhhmmyear (latent)", -4.836281906951478),
                                    ("from|since|after <time>December", -6.089044875446846),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -6.089044875446846),
                                    ("<time-of-day> am|pmon <day>", -4.836281906951478),
                                    ("Mondayyear (latent)", -4.990432586778736),
                                    ("dayday", -4.702750514326955),
                                    ("mm/ddat <time-of-day>", -5.683579767338681),
                                    ("on <day>September", -5.395897694886901),
                                    ("time-of-day (latent)September", -5.683579767338681),
                                    ("hourhour", -5.683579767338681),
                                    ("time-of-day (latent)on <day>", -4.584967478670572),
                                    ("time-of-day (latent)<cycle> after|before <time>",
                                     -5.683579767338681),
                                    ("dayyear", -3.093312601892855),
                                    ("Thursdaymm/dd", -6.089044875446846),
                                    ("New Year's Dayyear (latent)", -5.172754143572691),
                                    ("time-of-day (latent)Sunday", -5.683579767338681),
                                    ("Thursdayfrom|since|after <time>", -4.384296783208421),
                                    ("Thursdayat <time-of-day>", -4.4796069630127455),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -6.089044875446846),
                                    ("Aprilyear (latent)", -5.683579767338681),
                                    ("the <day-of-month> (ordinal)July", -6.089044875446846),
                                    ("the <day-of-month> (number)July", -6.089044875446846),
                                    ("monthminute", -6.089044875446846),
                                    ("<time-of-day> am|pmtomorrow", -6.089044875446846),
                                    ("Thursdayhh:mm", -5.172754143572691),
                                    ("<day-of-month> (ordinal)Tuesday", -5.683579767338681),
                                    ("minutemonth", -3.9489787119505753),
                                    ("time-of-day (latent)Friday", -5.683579767338681),
                                    ("minutehour", -6.089044875446846),
                                    ("this|last|next <cycle>from|since|after <time>",
                                     -5.683579767338681),
                                    ("tomorrowfrom|since|after <time>", -5.683579767338681),
                                    ("Augustyear (latent)", -5.683579767338681),
                                    ("week-endin|during <named-month>|year", -6.089044875446846),
                                    ("this|last|next <cycle>until <time>", -5.683579767338681),
                                    ("time-of-day (latent)Tuesday", -5.683579767338681),
                                    ("tomorrowuntil <time>", -5.683579767338681),
                                    ("mm/dd<time-of-day> - <time-of-day> (interval)",
                                     -5.683579767338681),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -6.089044875446846),
                                    ("Sundayyear (latent)", -5.172754143572691),
                                    ("Christmasat <time-of-day>", -6.089044875446846),
                                    ("from|since|after <time>year (latent)", -4.990432586778736),
                                    ("hhhmmon <day>", -5.172754143572691),
                                    ("yesterday<time-of-day> am|pm", -6.089044875446846),
                                    ("<day-of-month> (ordinal)July", -5.395897694886901),
                                    ...
                                    ("in|during <named-month>|yearyear (latent)",
                                     -6.089044875446846),
                                    ("at <time-of-day>intersect", -5.172754143572691),
                                    ("hh:mmyear (latent)", -4.702750514326955),
                                    ("Holiyear (latent)", -6.089044875446846),
                                    ("until <time><time-of-day> am|pm", -6.089044875446846),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.683579767338681),
                                    ("dayminute", -3.2268439945173775),
                                    ("yyyy-mm-ddhh:mm", -5.683579767338681),
                                    ("intersectfrom|since|after <time>", -5.683579767338681),
                                    ("intersectSeptember", -4.217242698545254),
                                    ("minuteday", -2.9320444542967325),
                                    ("absorption of , after named dayintersect",
                                     -6.089044875446846),
                                    ("intersectyear (latent)", -6.089044875446846),
                                    ("Februaryin|during the <part-of-day>", -6.089044875446846),
                                    ("<duration> after|before|from|past <time>December",
                                     -6.089044875446846),
                                    ("time-of-day (latent)July", -5.395897694886901),
                                    ("Saturdayyear (latent)", -6.089044875446846),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.089044875446846),
                                    ("at <time-of-day>on <day>", -5.172754143572691),
                                    ("absorption of , after named daySeptember",
                                     -4.836281906951478),
                                    ("Naraka Chaturdashiyear (latent)", -6.089044875446846),
                                    ("from|since|after <time>on <day>", -5.172754143572691),
                                    ("dayweek", -6.089044875446846),
                                    ("Easter Sundayyear (latent)", -5.683579767338681),
                                    ("Thursday<time-of-day> am|pm", -4.836281906951478),
                                    ("weekyear", -5.683579767338681),
                                    ("time-of-day (latent)Thursday", -5.683579767338681),
                                    ("<named-month> <day-of-month> (non ordinal)until <time>",
                                     -6.089044875446846),
                                    ("<day-of-month> (ordinal)April", -6.089044875446846),
                                    ("yyyy-mm-dd<time-of-day> - <time-of-day> (interval)",
                                     -5.683579767338681),
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.395897694886901),
                                    ("Sundayfrom|since|after <time>", -6.089044875446846),
                                    ("absorption of , after named dayFebruary", -5.172754143572691),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.683579767338681),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -6.089044875446846),
                                    ("tomorrowat <time-of-day>", -6.089044875446846),
                                    ("daynograin", -5.683579767338681),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.683579767338681),
                                    ("last <cycle> of <time>year (latent)", -5.683579767338681),
                                    ("tomorrow<time-of-day> am|pm", -5.395897694886901),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.395897694886901),
                                    ("Diwaliyear (latent)", -5.683579767338681),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -6.089044875446846),
                                    ("Fridayyear (latent)", -5.683579767338681),
                                    ("time-of-day (latent)April", -6.089044875446846),
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.14045183546909645, unseen = -5.54907608489522,
                               likelihoods =
                                 HashMap.fromList
                               ...
                               n = 252},
                   koData =
                     ClassData{prior = -2.032294763254134, unseen = -3.7612001156935624,
                               likelihoods =
                                 HashMap.fromList
