      ...
      [("<time> timezone",
       ...
       ("integer (numeric)",
        Classifier{okData =
                   ...
                   koData =
                     ClassData{prior = -1.2192402764567243, unseen = -3.332204510175204,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.6286086594223742, unseen = -5.53338948872752,
                               likelihoods =
                                 HashMap.fromList
                                   [("Tuesdayon <date>", -4.836281906951478),
                                    ("in <named-month>year", -4.836281906951478),
                                    ("<hour-of-day> till thirdafter part of days",
                                     -4.430816798843313),
                                    ("dayhour", -3.919991175077323),
                                    ("daymonth", -4.836281906951478),
                                    ("in <named-month>on <date>", -4.836281906951478),
                                    ("monthyear", -3.332204510175204),
                                    ("Mondayon <date>", -4.836281906951478),
                                    ("Christmasyear", -4.836281906951478),
                                    ("Monday<day-of-month> (ordinal or number) <named-month>",
                                     -4.836281906951478),
                                    ("month (integer)year (integer)", -4.430816798843313),
                                    ("\1593\1610\1583 \1575\1604\1605\1610\1604\1575\1583year",
                                     -4.836281906951478),
                                    ("<day-of-week> the last of <time><cycle> this|last|next",
                                     -4.836281906951478),
                                    ("at <time-of-day>before part of days", -4.143134726391533),
                                    ("hh:mmbefore part of days", -4.836281906951478),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year",
                                     -4.836281906951478),
                                    ("intersect<time> <part-of-day>", -4.430816798843313),
                                    ("month (ordinal)year (integer)", -4.836281906951478),
                                    ("\1593\1610\1583 \1575\1604\1601\1589\1581year",
                                     -4.836281906951478),
                                    ("dd/mm<time> <part-of-day>", -4.836281906951478),
                                    ...
                                    ("absorption of , after named day<day-of-month> (ordinal or number) <named-month>",
                                     -4.836281906951478),
                                    ("hourhour", -3.7376696182833684),
                                    ("month (integer)year", -4.836281906951478),
                                    ("\1593\1610\1583 \1575\1604\1601\1591\1585year",
                                     -4.836281906951478),
                                    ("Thursday<day-of-month> (ordinal or number) <named-month>",
                                     -4.836281906951478),
                                    ("dayyear", -3.044522437723423),
                                    ("Thursday<time> <part-of-day>", -4.836281906951478),
                                    ("<cycle> last of <time>year (integer)", -4.430816798843313),
                                    ("last <cycle> of <time>year (integer)", -4.836281906951478),
                                    ("<hour-of-day> quarterafter part of days", -4.836281906951478),
                                    ...
                                    ("\1585\1571\1587 \1575\1604\1587\1606\1577 \1575\1604\1607\1580\1585\1610\1577year",
                                     -4.836281906951478),
                                    ("Monday<cycle> this|last|next", -4.836281906951478),
                                    ("<day-of-month> (ordinal or number) of <named-month>year",
                                     -4.836281906951478),
                                    ("<cycle> <ordinal> day? of <time>year", -4.836281906951478),
                                    ("\1593\1610\1583 \1575\1604\1571\1590\1581\1609year",
                                     -4.836281906951478),
                                    ("on a <named-day>dd/mm", -4.836281906951478),
                                    ("on a <named-day>on <date>", -4.836281906951478),
                                    ("on a <named-day><day-of-month> (ordinal or number) <named-month>",
                                     -4.836281906951478),
                                    ("Tuesday<cycle> this|last|next", -4.836281906951478),
                                    ("dayminute", -3.58351893845611),
                                    ("dd/mmintersect", -4.836281906951478),
                                    ("in <named-month><cycle> this|last|next", -4.836281906951478),
                                    ("<hour-of-day> and integer minutesafter part of days",
                                     -4.430816798843313),
                                    ("Saturdaydd/mm", -4.836281906951478),
                                    ("the <cycle> the <ordinal> of <time>year", -4.836281906951478),
                                    ("at <time-of-day>after part of days", -3.7376696182833684),
                                    ("<ordinal> <cycle> of <time>year", -4.836281906951478),
                                    ("Sunday<cycle> this|last|next", -4.836281906951478),
                                    ("Tuesday<day-of-month> (ordinal or number) of <named-month>",
                                     -4.430816798843313),
                                    ("Septemberon <date>", -4.836281906951478),
                                    ("from <datetime> - <datetime> (interval)after part of days",
                                     -4.836281906951478),
                                    ("intersectintersect", -4.430816798843313),
                                    ("dayweek", -4.143134726391533),
                                    ("weekyear", -3.919991175077323),
                                    ("<datetime> - <datetime> (interval)after part of days",
                                     -4.836281906951478),
                                    ...
                                    ("<time-of-day> - <time-of-day> (interval)after part of days",
                                     -4.836281906951478),
                                    ("at <time-of-day>this <part-of-day>", -4.836281906951478),
                                    ("<hour-of-day> till thirdbefore part of days",
                                     -4.430816798843313)],
                               n = 72},
                   koData =
                     ClassData{prior = -0.7621400520468967, unseen = -5.459585514144159,
                               likelihoods =
                                 HashMap.fromList
                                   [("Tuesdayon <date>", -4.762173934797756),
                                    ("dayhour", -3.258096538021482),
                                    ("daymonth", -3.057425842559331),
                                    ("monthday", -4.762173934797756),
                                    ("monthyear", -2.890371757896165),
                                    ("Wednesdayintersect", -4.356708826689592),
                                    ("hh:mmafter part of days", -4.762173934797756),
                                    ("houryear", -4.356708826689592),
                                    ("this|last <cycle><time> for <duration>", -4.762173934797756),
                                    ("intersectat <time-of-day>", -3.845883202923601),
                                    ("intersect<time> <part-of-day>", -4.356708826689592),
                                    ("Wednesday<time> for <duration>", -4.762173934797756),
                                    ("Octoberon <date>", -4.762173934797756),
                                    ("until <time-of-day>after part of days", -4.762173934797756),
                                    ("this|last <cycle>on <date>", -4.356708826689592),
                                    ("Tuesdayafter <time-of-day>", -4.762173934797756),
                                    ("Wednesdayon <date>", -3.845883202923601),
                                    ("dd/mm<time> <part-of-day>", -4.762173934797756),
                                    ("yearyear", -4.356708826689592),
                                    ("<hour-of-day> till quarterthis <part-of-day>",
                                     -4.762173934797756),
                                    ("dayday", -4.069026754237811),
                                    ("dd/mmat <time-of-day>", -4.356708826689592),
                                    ("hourhour", -4.356708826689592),
                                    ("dayyear", -3.3758795736778655),
                                    ("Thursdayat <time-of-day>", -4.356708826689592),
                                    ("Februaryyear", -4.762173934797756),
                                    ("minutemonth", -4.762173934797756),
                                    ("minutehour", -4.356708826689592),
                                    ("<day-of-month> (ordinal or number) of <named-month>year",
                                     -4.356708826689592),
                                    ("weekmonth", -4.356708826689592),
                                    ("March<cycle> this|last|next", -4.762173934797756),
                                    ("nth <time> of <time>year", -4.762173934797756),
                                    ("Wednesday<day-of-month> (ordinal or number) of <named-month>",
                                     -4.762173934797756),
                                    ("secondyear", -4.762173934797756),
                                    ("Wednesdayintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -4.762173934797756),
                                    ("on <date>year (integer)", -4.762173934797756),
                                    ("<time> for <duration>year", -3.845883202923601),
                                    ("<duration> after|before|from <time>on <date>",
                                     -4.762173934797756),
                                    ("dayminute", -3.258096538021482),
                                    ("Julyuntil <time-of-day>", -4.762173934797756),
                                    ("intersecton <date>", -4.762173934797756),
                                    ("intersectyear", -4.356708826689592),
                                    ("at <time-of-day>after part of days", -4.762173934797756),
                                    ("Octoberyear", -4.762173934797756),
                                    ("in|within|after <duration>year", -4.356708826689592),
                                    ("Tuesday<day-of-month> (ordinal or number) of <named-month>",
                                     -4.762173934797756),
                                    ("on a <named-day>intersect", -4.356708826689592),
                                    ("Saturdayintersect", -4.356708826689592),
                                    ("at <time-of-day>year", -4.762173934797756),
                                    ("on <date>year", -4.356708826689592),
                                    ("on <date>on <date>", -4.762173934797756),
                                    ("weekday", -4.762173934797756),
                                    ("Tuesdaynth <time> of <time>", -4.762173934797756),
                                    ("weekyear", -4.762173934797756),
                                    ("Tuesdayintersect", -4.762173934797756),
                                    ("after <time-of-day>year", -4.762173934797756),
                                    ("in <number> (implicit minutes)February", -4.762173934797756),
                                    ("last <cycle> of <time>year", -4.762173934797756),
        ...
        Classifier{okData =
                   ...
                   koData =
                     ClassData{prior = 0.0, unseen = -3.044522437723423,
                               likelihoods =
                                 HashMap.fromList
                                   [("intersectsingle <unit-of-duration>", -2.3025850929940455),
                                    ("monthyear", -1.3862943611198906),
                                    ("dayyear", -2.3025850929940455),
                                    ("last <cycle> of <time>single <unit-of-duration>",
                                     -2.3025850929940455),
                                    ("weekyear", -2.3025850929940455),
                                    ("Octobersingle <unit-of-duration>", -2.3025850929940455),
                                    ("Septembersingle <unit-of-duration>", -2.3025850929940455),
                                    ("on <date>single <unit-of-duration>", -1.8971199848858813)],
                               n = 6}}),
       ...
       ("year",
        Classifier{okData =
                     ClassData{prior = -1.0986122886681098,
                               ...
                               likelihoods =
                                 HashMap.fromList [("integer (numeric)", -9.53101798043249e-2)],
                               n = 9},
                   koData =
                     ClassData{prior = -0.40546510810816444,
                               unseen = -3.044522437723423,
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -0.4307829160924542),
                                    ("powers of tens", -1.0498221244986778)],
                               n = 18}}),
