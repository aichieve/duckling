      ...
      [("<time> timezone",
       ...
       ("integer (numeric)",
        Classifier{okData =
                   ...
                   koData =
                     ClassData{prior = -1.2584609896100056, unseen = -3.295836866004329,
       ...
       ("at <time-of-day>",
        Classifier{okData =
                     ClassData{prior = -0.11778303565638351,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("<hour-of-day> third", -4.119037174812472),
                                    ("<hour-of-day> and integer minutes", -2.509599262378372),
                                    ("<hour-of-day> quarter", -4.119037174812472),
                                    ("<hour-of-day> till quarter", -3.713572066704308),
                                    ("time-of-day ordinal (latent)", -1.9218125974762528),
                                    ("<hour-of-day> half", -4.119037174812472),
                                    ("hh:mm", -3.202746442938317), ("hour", -1.201266442728193),
                                    ("minute", -1.7676619176489945),
                                    ("<hour-of-day> till third", -3.713572066704308),
                                    ("time-of-day integer (latent)", -1.8164520818184264)],
                               n = 56},
                   koData =
                     ClassData{prior = -2.1972245773362196, unseen = -3.258096538021482,
                               likelihoods =
                                 HashMap.fromList
                                   [("time-of-day ordinal (latent)", -1.8325814637483102),
                                    ("hour", -1.1394342831883648),
                                    ("time-of-day integer (latent)", -1.6094379124341003)],
                               n = 7}}),
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("year", -0.6931471805599453),
                                    ("single <unit-of-duration>", -0.6931471805599453)],
                               n = 2}}),
       ("Wednesday",
        Classifier{okData =
                     ClassData{prior = 0.0, unseen = -1.9459101490553135,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.5965203448708736, unseen = -5.568344503761097,
                               likelihoods =
                                 HashMap.fromList
                                   [("Tuesdayon <date>", -4.871373226762748),
                                    ("in <named-month>year", -4.871373226762748),
                                    ("<hour-of-day> till thirdafter part of days",
                                     -4.465908118654584),
                                    ("dayhour", -3.955082494888593),
                                    ("daymonth", -4.871373226762748),
                                    ("in <named-month>on <date>", -4.871373226762748),
                                    ("monthyear", -3.166625134524323),
                                    ("Mondayon <date>", -4.871373226762748),
                                    ("Christmasyear", -4.871373226762748),
                                    ("Monday<day-of-month> (ordinal or number) <named-month>",
                                     -4.871373226762748),
                                    ("month (integer)year (integer)", -4.465908118654584),
                                    ("\1593\1610\1583 \1575\1604\1605\1610\1604\1575\1583year",
                                     -4.871373226762748),
                                    ("<day-of-week> the last of <time><cycle> this|last|next",
                                     -4.871373226762748),
                                    ("at <time-of-day>before part of days", -4.178226046202803),
                                    ("hh:mmbefore part of days", -4.871373226762748),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year",
                                     -4.871373226762748),
                                    ("intersect<time> <part-of-day>", -4.465908118654584),
                                    ("month (ordinal)year (integer)", -4.871373226762748),
                                    ("\1593\1610\1583 \1575\1604\1601\1589\1581year",
                                     -4.871373226762748),
                                    ("dd/mm<time> <part-of-day>", -4.871373226762748),
                                    ("Thursday<time> timezone", -4.465908118654584),
                                    ("<hour-of-day> till quarterthis <part-of-day>",
                                     -4.465908118654584),
                                    ("dayday", -3.079613757534693),
                                    ("absorption of , after named day<day-of-month> (ordinal or number) <named-month>",
                                     -4.871373226762748),
                                    ("hourhour", -3.7727609380946383),
                                    ("month (integer)year", -4.871373226762748),
                                    ("\1593\1610\1583 \1575\1604\1601\1591\1585year",
                                     -4.871373226762748),
                                    ("Thursday<day-of-month> (ordinal or number) <named-month>",
                                     -4.871373226762748),
                                    ("dayyear", -2.9995710498611565),
                                    ("Thursday<time> <part-of-day>", -4.871373226762748),
                                    ("<cycle> last of <time>year (integer)", -4.465908118654584),
                                    ("last <cycle> of <time>year (integer)", -4.871373226762748),
                                    ("<hour-of-day> quarterafter part of days", -4.871373226762748),
                                    ("minutehour", -2.5687881337687024),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -4.871373226762748),
                                    ("\1585\1571\1587 \1575\1604\1587\1606\1577 \1575\1604\1607\1580\1585\1610\1577year",
                                     -4.871373226762748),
                                    ("Monday<cycle> this|last|next", -4.871373226762748),
                                    ("<day-of-month> (ordinal or number) of <named-month>year",
                                     -4.871373226762748),
                                    ("<cycle> <ordinal> day? of <time>year", -4.871373226762748),
                                    ("\1593\1610\1583 \1575\1604\1571\1590\1581\1609year",
                                     -4.871373226762748),
                                    ("on a <named-day>dd/mm", -4.871373226762748),
                                    ("<time> for <duration>year", -4.178226046202803),
                                    ("on a <named-day>on <date>", -4.871373226762748),
                                    ("on a <named-day><day-of-month> (ordinal or number) <named-month>",
                                     -4.871373226762748),
                                    ("Tuesday<cycle> this|last|next", -4.871373226762748),
                                    ("dayminute", -3.6186102582673803),
                                    ("dd/mmintersect", -4.871373226762748),
                                    ("in <named-month><cycle> this|last|next", -4.871373226762748),
                                    ("<hour-of-day> and integer minutesafter part of days",
                                     -4.465908118654584),
                                    ("Saturdaydd/mm", -4.871373226762748),
                                    ("\1585\1605\1590\1575\1606year", -4.871373226762748),
                                    ("the <cycle> the <ordinal> of <time>year", -4.871373226762748),
                                    ("at <time-of-day>after part of days", -3.7727609380946383),
                                    ("<ordinal> <cycle> of <time>year", -4.871373226762748),
                                    ("Sunday<cycle> this|last|next", -4.871373226762748),
                                    ("Tuesday<day-of-month> (ordinal or number) of <named-month>",
                                     -4.465908118654584),
                                    ("Septemberon <date>", -4.871373226762748),
                                    ("from <datetime> - <datetime> (interval)after part of days",
                                     -4.871373226762748),
                                    ("intersectintersect", -4.465908118654584),
                                    ("dayweek", -4.178226046202803),
                                    ("weekyear", -3.7727609380946383),
                                    ("<datetime> - <datetime> (interval)after part of days",
                                     -4.871373226762748),
                                    ...
                                    ("<time-of-day> - <time-of-day> (interval)after part of days",
                                     -4.871373226762748),
                                    ("at <time-of-day>this <part-of-day>", -4.871373226762748),
                                    ("<hour-of-day> till thirdbefore part of days",
                                     -4.465908118654584)],
                               n = 76},
                   koData =
                     ClassData{prior = -0.8001193001121132, unseen = -5.455321115357702,
                               likelihoods =
                                 HashMap.fromList
                                   [("Tuesdayon <date>", -4.757891273005756),
                                    ("dayhour", -3.253813876229481),
                                    ("daymonth", -3.05314318076733),
                                    ("monthday", -4.757891273005756),
                                    ("monthyear", -3.05314318076733),
                                    ("Wednesdayintersect", -4.352426164897591),
                                    ("hh:mmafter part of days", -4.757891273005756),
                                    ("houryear", -4.352426164897591),
                                    ("this|last <cycle><time> for <duration>", -4.757891273005756),
                                    ("intersectat <time-of-day>", -3.8416005411316),
                                    ("intersect<time> <part-of-day>", -4.352426164897591),
                                    ("Wednesday<time> for <duration>", -4.757891273005756),
                                    ("Octoberon <date>", -4.757891273005756),
                                    ("until <time-of-day>after part of days", -4.757891273005756),
                                    ("this|last <cycle>on <date>", -4.352426164897591),
                                    ("Tuesdayafter <time-of-day>", -4.757891273005756),
                                    ("Wednesdayon <date>", -3.8416005411316),
                                    ("dd/mm<time> <part-of-day>", -4.757891273005756),
                                    ("yearyear", -4.352426164897591),
                                    ("<hour-of-day> till quarterthis <part-of-day>",
                                     -4.757891273005756),
                                    ("dayday", -4.06474409244581),
                                    ("dd/mmat <time-of-day>", -4.352426164897591),
                                    ("hourhour", -4.352426164897591),
                                    ("dayyear", -3.253813876229481),
                                    ("Thursdayat <time-of-day>", -4.352426164897591),
                                    ("Februaryyear", -4.757891273005756),
                                    ("minutemonth", -4.757891273005756),
                                    ("minutehour", -4.352426164897591),
                                    ("for <duration> from <time>on <date>", -4.757891273005756),
                                    ("<day-of-month> (ordinal or number) of <named-month>year",
                                     -4.352426164897591),
                                    ("weekmonth", -4.352426164897591),
                                    ("March<cycle> this|last|next", -4.757891273005756),
                                    ("nth <time> of <time>year", -4.757891273005756),
                                    ("Wednesday<day-of-month> (ordinal or number) of <named-month>",
                                     -4.757891273005756),
                                    ("secondyear", -4.352426164897591),
                                    ("Wednesdayintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -4.757891273005756),
                                    ("on <date>year (integer)", -4.757891273005756),
                                    ("<time> for <duration>year", -4.06474409244581),
                                    ("<duration> after|before|from <time>on <date>",
                                     -4.757891273005756),
                                    ("dayminute", -3.253813876229481),
                                    ("Julyuntil <time-of-day>", -4.757891273005756),
                                    ("intersecton <date>", -4.757891273005756),
                                    ("intersectyear", -4.352426164897591),
                                    ("at <time-of-day>after part of days", -4.757891273005756),
                                    ("Octoberyear", -4.757891273005756),
                                    ("in|within|after <duration>year", -4.352426164897591),
                                    ("Tuesday<day-of-month> (ordinal or number) of <named-month>",
                                     -4.757891273005756),
                                    ("on a <named-day>intersect", -4.352426164897591),
                                    ("Saturdayintersect", -4.352426164897591),
                                    ("at <time-of-day>year", -4.757891273005756),
                                    ("on <date>year", -4.352426164897591),
                                    ("on <date>on <date>", -4.757891273005756),
                                    ("weekday", -4.757891273005756),
                                    ("Tuesdaynth <time> of <time>", -4.757891273005756),
                                    ("Tuesdayintersect", -4.757891273005756),
                                    ("after <time-of-day>year", -4.757891273005756),
                                    ("in <number> (implicit minutes)February", -4.757891273005756),
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("monthyear", -1.540445040947149),
                                    ...
                                    ("Octobersingle <unit-of-duration>", -1.9459101490553135),
                                    ("Septembersingle <unit-of-duration>", -1.9459101490553135)],
                               n = 3},
                   koData =
                     ClassData{prior = -0.6931471805599453, unseen = -2.70805020110221,
                               likelihoods =
                                 HashMap.fromList
                                   [("intersectsingle <unit-of-duration>", -1.9459101490553135),
                                    ("monthyear", -1.540445040947149),
                                    ("dayyear", -1.9459101490553135),
                                    ("on <date>single <unit-of-duration>", -1.540445040947149)],
                               n = 3}}),
       ...
       ("nth <time> of <time>",
        Classifier{okData =
                     ClassData{prior = -0.6931471805599453,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("daymonth", -1.6376087894007967),
                                    ("ordinals (first..tenth)Wednesdayintersect",
                                     -2.890371757896165),
                   ...
                   koData =
                     ClassData{prior = -0.6931471805599453,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("ordinals (first..tenth)TuesdaySeptember", -2.890371757896165),
                                    ("ordinals (first..tenth)time-of-day integer (latent)intersect",
                                     -2.890371757896165),
                                    ("daymonth", -1.791759469228055),
                                    ("ordinals (first..tenth)Wednesday<time> for <duration>",
                                     -2.890371757896165),
                                    ("ordinals (first..tenth)time-of-day integer (latent)February",
                                     -2.4849066497880004),
                                    ("hourmonth", -1.9740810260220096),
                                    ("ordinals (first..tenth)WednesdayOctober", -2.890371757896165),
       ...
       ("time-of-day ordinal (latent)",
        Classifier{okData =
                     ClassData{prior = -0.19105523676270922,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("ordinals (twelveth)", -1.9924301646902063),
                                    ("ordinals (first..tenth)", -0.3184537311185346),
                                    ("ordinals (eleventh)", -1.9924301646902063)],
                               n = 19},
                   koData =
                     ClassData{prior = -1.749199854809259, unseen = -2.0794415416798357,
                               likelihoods =
                                 HashMap.fromList
       ...
       ("year",
        Classifier{okData =
                     ClassData{prior = -0.8109302162163288, unseen = -2.70805020110221,
                               likelihoods =
                                 HashMap.fromList [("integer (numeric)", -7.410797215372185e-2)],
                               n = 12},
                   koData =
                     ClassData{prior = -0.587786664902119, unseen = -2.890371757896165,
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -0.5306282510621704),
                                    ("powers of tens", -0.8873031950009028)],
                               n = 15}}),
       ...
       ("<hour-of-day> and integer",
        Classifier{okData =
                     ClassData{prior = -0.916290731874155, unseen = -3.0910424533583156,
                               likelihoods =
                                 HashMap.fromList
                                   [("at <time-of-day>integer (13..19)", -1.9459101490553135),
                                    ("at <time-of-day>integer 21..99", -1.9459101490553135),
                                    ("hour", -1.0986122886681098),
                                    ("at <time-of-day>integer (numeric)", -1.9459101490553135)],
                               n = 6},
                   koData =
                     ClassData{prior = -0.5108256237659907, unseen = -3.332204510175204,
                               likelihoods =
                                 HashMap.fromList
                                   [("at <time-of-day>integer 5", -2.1972245773362196),
                                    ("at <time-of-day>integer (13..19)", -2.6026896854443837),
                                    ("at <time-of-day>integer 3", -2.6026896854443837),
                                    ("at <time-of-day>integer 4", -2.6026896854443837),
                                    ("at <time-of-day>integer (20..90)", -2.6026896854443837),
                                    ("at <time-of-day>integer 8", -2.1972245773362196),
                                    ("hour", -0.9932517730102834),
                                    ("at <time-of-day>integer (numeric)", -2.6026896854443837)],
                               n = 9}}),
       ("month (ordinal)",
        Classifier{okData =
                     ClassData{prior = 0.0, unseen = -1.3862943611198906,
       ...
       ("about|exactly <time-of-day>",
        Classifier{okData =
                     ClassData{prior = -0.6931471805599453,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("<day-of-week> next", -1.5040773967762742),
                                    ("day", -1.0986122886681098), ("Tuesday", -1.5040773967762742)],
                               n = 2},
                   koData =
                     ClassData{prior = -0.6931471805599453,
                               unseen = -2.3025850929940455,
                                 ...
                                 HashMap.fromList
                                   [("daymonth", -1.8971199848858813),
                                    ("week (grain)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -2.3025850929940455),
                                    ("day (grain)intersect", -2.3025850929940455),
                                    ("weekmonth", -1.6094379124341003),
                                    ("week (grain)intersect", -2.3025850929940455),
                                    ("week (grain)September", -2.3025850929940455),
                                    ("day (grain)month (integer)", -2.3025850929940455)],
                               n = 5},
                   koData =
                     ClassData{prior = -1.252762968495368, unseen = -2.70805020110221,
                               likelihoods =
                                 HashMap.fromList
                                   [("week (grain)<time> for <duration>", -1.9459101490553135),
                                    ("weekmonth", -1.9459101490553135),
                                    ("weekday", -1.9459101490553135),
                                    ("week (grain)Saturday", -1.9459101490553135)],
                               n = 2}}),
       ("ordinals (composite, e.g., eighty-seven)",
        Classifier{okData =
                     ClassData{prior = 0.0, unseen = -1.3862943611198906,
                     ...
                     ClassData{prior = 0.0, unseen = -1.6094379124341003,
                               likelihoods =
                                 HashMap.fromList
                                   [("single <unit-of-duration>in <named-month>",
                                     -0.6931471805599453),
                                    ("secondmonth", -0.6931471805599453)],
                               n = 1}}),
       ...
       ("time-of-day integer (latent)",
        Classifier{okData =
                     ClassData{prior = -0.5819215454497209,
                               ...
                               n = 19},
                   koData =
                     ClassData{prior = -0.8183103235139514, unseen = -2.995732273553991,
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -0.9985288301111273),
                                    ("integer 10", -0.8649974374866046),
                                    ("integer 3", -2.2512917986064953),
                                    ("integer 5", -2.2512917986064953)],
                               n = 15}}),
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("year (grain)", -1.9924301646902063),
                                    ("day", -1.9924301646902063), ("year", -1.9924301646902063),
       ...
       ("this <time>",
        Classifier{okData =
                     ClassData{prior = -0.6931471805599453, unseen = -1.791759469228055,
                               likelihoods =
                                 HashMap.fromList
                                   [("today", -0.916290731874155), ("day", -0.916290731874155)],
                               n = 1},
                   koData =
                     ClassData{prior = -0.6931471805599453, unseen = -1.791759469228055,
                               likelihoods =
