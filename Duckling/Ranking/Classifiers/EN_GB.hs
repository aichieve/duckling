...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.7367760429491519, unseen = -5.918893854273146,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 370},
                   koData =
                     ClassData{prior = -0.6513424866407391, unseen = -6.003887067106539,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.5453705327993739, unseen = -6.975413927455952,
                               likelihoods =
                                 HashMap.fromList
                                   [("Father's Dayyear (latent)", -6.2813317304651),
                                    ("<day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.2813317304651),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -4.2664287099228355),
                                    ("Bhai Doojyear (latent)", -6.2813317304651),
                                    ("hourday", -4.2664287099228355),
                                    ("dayhour", -3.363560998380821),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -4.2664287099228355),
                                    ("Martin Luther King's Dayyear (latent)", -5.875866622356936),
                                    ("Shemini Atzeretyear (latent)", -6.2813317304651),
                                    ("daymonth", -4.335421581409786),
                                    ("monthday", -5.875866622356936),
                                    ("monthyear", -4.489572261237045),
                                    ("Yom Ha'atzmautyear (latent)", -6.2813317304651),
                                    ("Vijayadashamiyear (latent)", -6.2813317304651),
                                    ("Thanksgiving Dayyear (latent)", -5.182719441796991),
                                    ("Thai Pongalyear (latent)", -5.588184549905154),
                                    ("Thiru Onamyear (latent)", -5.588184549905154),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.2813317304651),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.365040998590945),
                                    ("<day-of-month> (ordinal)Wednesday", -6.2813317304651),
                                    ("Krishna Janmashtamiyear (latent)", -5.875866622356936),
                                    ("Guru Gobind Singh Jayantiyear (latent)", -6.2813317304651),
                                    ("houryear", -5.365040998590945),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.2813317304651),
                                    ("Christmas<time-of-day> am|pm", -6.2813317304651),
                                    ("last <day-of-week> of <time>year (latent)", -6.2813317304651),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.588184549905154),
                                    ("intersectin|during <named-month>|year", -6.2813317304651),
                                    ("<time-of-day> am|pmintersect", -5.028568761969732),
                                    ("Octoberyear (latent)", -4.777254333688826),
                                    ("intersect<time-of-day> am|pm", -6.2813317304651),
                                    ("Mattu Pongalyear (latent)", -6.2813317304651),
                                    ("Parsi New Yearyear (latent)", -5.365040998590945),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.2813317304651),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.2813317304651),
                                    ("todayin|within|after <duration>", -6.2813317304651),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.875866622356936),
                                    ("Marchyear (latent)", -6.2813317304651),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.875866622356936),
                                    ("Clean Mondayyear (latent)", -5.875866622356936),
                                    ("monthhour", -5.875866622356936),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.588184549905154),
                                    ("todayat <time-of-day>", -6.2813317304651),
                                    ("Thursday<time> timezone", -4.335421581409786),
                                    ("time-of-day (latent)tonight", -5.875866622356936),
                                    ("from|since|after <time>December", -6.2813317304651),
                                    ("dd/mm<time-of-day> am|pm", -6.2813317304651),
                                    ("<time-of-day> am|pmon <day>", -4.2664287099228355),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm", -6.2813317304651),
                                    ("dayday", -3.8389846950958955),
                                    ("dd/mmat <time-of-day>", -6.2813317304651),
                                    ("<time> <part-of-day>at <time-of-day>", -6.2813317304651),
                                    ("tonightat <time-of-day>", -6.2813317304651),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.588184549905154),
                                    ("Dayananda Saraswati Jayantiyear (latent)", -6.2813317304651),
                                    ("today<time-of-day> am|pm", -6.2813317304651),
                                    ("Februarythe <day-of-month> (ordinal)", -5.875866622356936),
                                    ("at <time-of-day><time> <part-of-day>", -6.2813317304651),
                                    ("<day-of-month> (ordinal)intersect", -5.875866622356936),
                                    ("hourhour", -4.2018901887852635),
                                    ("Wednesdaythis|last|next <cycle>", -6.2813317304651),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.777254333688826),
                                    ("Boghiyear (latent)", -6.2813317304651),
                                    ("dayyear", -1.984046324246309),
                                    ("Thursdayfrom|since|after <time>", -5.875866622356936),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.2813317304651),
                                    ("Thursdayat <time-of-day>", -5.588184549905154),
                                    ("Islamic New Yearyear (latent)", -5.875866622356936),
                                    ("Laylat al-Qadryear (latent)", -5.365040998590945),
                                    ("Shrove Tuesdayyear (latent)", -6.2813317304651),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.588184549905154),
                                    ("<time-of-day> am|pmtomorrow", -5.588184549905154),
                                    ("Yom Kippuryear (latent)", -6.2813317304651),
                                    ("<day-of-month> (ordinal)Tuesday", -5.875866622356936),
                                    ("<part-of-day> of <time>year (latent)", -6.2813317304651),
                                    ("minutehour", -5.028568761969732),
                                    ("Kaanum Pongalyear (latent)", -5.875866622356936),
                                    ("Maha Saptamiyear (latent)", -6.2813317304651),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.875866622356936),
                                    ("time-of-day (latent)tomorrow", -5.365040998590945),
                                    ("part of daysat <time-of-day>", -5.875866622356936),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.5765836382266745),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.2813317304651),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.028568761969732),
                                    ("time-of-day (latent)this <part-of-day>", -6.2813317304651),
                                    ("Pentecostyear (latent)", -6.2813317304651),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.028568761969732),
                                    ("<day-of-month> (ordinal)February", -6.2813317304651),
                                    ("Eid al-Fitryear (latent)", -5.365040998590945),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.2813317304651),
                                    ("Chhathin|during <named-month>|year", -6.2813317304651),
                                    ("Diwaliin|during <named-month>|year", -6.2813317304651),
                                    ("Vaisakhiin|during <named-month>|year", -6.2813317304651),
                                    ("Guru Ravidass Jayantiyear (latent)", -5.028568761969732),
                                    ("Raksha Bandhanyear (latent)", -6.2813317304651),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.875866622356936),
                                    ("Ashurayear (latent)", -6.2813317304651),
                                    ("Tuesdayin|during <named-month>|year", -6.2813317304651),
                                    ("Chinese New Yearyear (latent)", -6.2813317304651),
                                    ("tomorrowintersect", -6.2813317304651),
                                    ("Lag BaOmeryear (latent)", -6.2813317304651),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.2813317304651),
                                    ("Eid al-Adhayear (latent)", -4.141265566968829),
                                    ("intersectin|during the <part-of-day>", -6.2813317304651),
                                    ("Palm Sundayyear (latent)", -6.2813317304651),
                                    ("Christmasat <time-of-day>", -6.2813317304651),
                                    ("Lazarus Saturdayyear (latent)", -6.2813317304651),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.2813317304651),
                                    ("Yom HaShoahyear (latent)", -5.875866622356936),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.875866622356936),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.2813317304651),
                                    ("Septemberyear (latent)", -5.875866622356936),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.777254333688826),
                                    ("Halloweenyear (latent)", -6.2813317304651),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.2813317304651),
                                    ("at <time-of-day>intersect", -5.875866622356936),
                                    ("Dhanterasyear (latent)", -6.2813317304651),
                                    ("Tu BiShvatyear (latent)", -6.2813317304651),
                                    ("<day-of-month> (ordinal)December", -5.588184549905154),
                                    ("Holiyear (latent)", -5.588184549905154),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.2813317304651),
                                    ("Holika Dahanyear (latent)", -5.588184549905154),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.2813317304651),
                                    ("dayminute", -3.363560998380821),
                                    ("Mawlidyear (latent)", -6.2813317304651),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -5.875866622356936),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.2813317304651),
                                    ("Jumu'atul-Widayear (latent)", -5.875866622356936),
                                    ("minuteday", -2.4526903339760047),
                                    ("absorption of , after named dayintersect", -6.2813317304651),
                                    ("intersectyear (latent)", -6.2813317304651),
                                    ("Orthodox Easter Sundayyear (latent)", -6.2813317304651),
                                    ("time-of-day (latent)in|within|after <duration>",
                                     -6.2813317304651),
                                    ("<ordinal> <cycle> of <time>year (latent)", -6.2813317304651),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.2813317304651),
                                    ("Mothering Sundayyear (latent)", -5.875866622356936),
                                    ("Boss's Dayyear (latent)", -5.875866622356936),
                                    ("Dhanterasin|during <named-month>|year", -6.2813317304651),
                                    ("Tisha B'Avyear (latent)", -6.2813317304651),
                                    ("Isra and Mi'rajyear (latent)", -5.365040998590945),
                                    ("at <time-of-day>on <day>", -5.182719441796991),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.2813317304651),
                                    ("time-of-day (latent)<time> <part-of-day>",
                                     -5.588184549905154),
                                    ("Christmasyear (latent)", -5.875866622356936),
                                    ("Naraka Chaturdashiyear (latent)", -5.875866622356936),
                                    ("Thai Pongalin|during <named-month>|year", -6.2813317304651),
                                    ("dayweek", -6.2813317304651),
                                    ("Easter Sundayyear (latent)", -5.588184549905154),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -4.671893818030999),
                                    ("weekyear", -5.182719441796991),
                                    ("King's Dayyear (latent)", -4.777254333688826),
                                    ("hh:mmin|during the <part-of-day>", -5.365040998590945),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.875866622356936),
                                    ("February<time> <part-of-day>", -6.2813317304651),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -6.2813317304651),
                                    ("tomorrowat <time-of-day>", -5.588184549905154),
                                    ("hhmm (latent)in|during the <part-of-day>", -6.2813317304651),
                                    ("Vaisakhiyear (latent)", -5.588184549905154),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -6.2813317304651),
                                    ("last <cycle> of <time>year (latent)", -5.588184549905154),
                                    ("at <time-of-day>tomorrow", -5.875866622356936),
                                    ("tomorrow<time-of-day> am|pm", -6.2813317304651),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.2813317304651),
                                    ("Diwaliyear (latent)", -6.2813317304651),
                                    ("between <time> and <time>on <day>", -4.671893818030999),
                                    ("Black Fridayyear (latent)", -5.875866622356936),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.2813317304651),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.2813317304651),
                                    ("Chhathyear (latent)", -5.875866622356936),
                                    ("Vasant Panchamiyear (latent)", -6.2813317304651),
                                    ("Rabindra Jayantiyear (latent)", -5.028568761969732),
                                    ("St Patrick's Dayyear (latent)", -6.2813317304651),
                                    ("Thursday<time> (timezone)", -6.2813317304651),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.2813317304651),
                                    ("<datetime> - <datetime> (interval)July", -5.875866622356936),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.875866622356936),
                                    ("Februaryintersect", -6.2813317304651),
                                    ("Simchat Torahyear (latent)", -6.2813317304651)],
                               n = 404},
                   koData =
                     ClassData{prior = -0.8666128017434567, unseen = -6.742880635791903,
                               likelihoods =
                                 HashMap.fromList
                                   [("time-of-day (latent)<time-of-day> - <time-of-day> (interval)",
                                     -5.643088405983945),
                                    ("hourday", -3.1581817561959444),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -6.048553514092109),
                                    ("<day-of-month> (ordinal)August", -6.048553514092109),
                                    ("dayhour", -3.340503312989899),
                                    ("<time> timezoneyear (latent)", -6.048553514092109),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.132262782217954),
                                    ("Tuesdayfrom|since|after <time>", -5.355406333532164),
                                    ("daymonth", -3.5636468643041086),
                                    ...
                                    ("about|exactly <time-of-day>year (latent)",
                                     -6.048553514092109),
                                    ("hh:mmon <day>", -3.6062064787229047),
                                    ("absorption of , after named dayJuly", -5.643088405983945),
                                    ...
                                    ("Bank Holidayyear (latent)", -5.355406333532164),
                                    ...
                                    ("Mondayyear (latent)", -5.355406333532164),
                                    ("yyyy-mm-ddhh:mm:ss", -5.643088405983945),
                                    ("dayday", -4.662259152972219),
                                    ("dd/mmat <time-of-day>", -5.643088405983945),
                                    ("on <day>September", -5.643088405983945),
                                    ("time-of-day (latent)September", -5.643088405983945),
                                    ("hourhour", -4.949941225423999),
                                    ("time-of-day (latent)on <day>", -3.6062064787229047),
                                    ("Thursdaydd/mm", -6.048553514092109),
                                    ("time-of-day (latent)<cycle> after|before <time>",
                                     -5.643088405983945),
                                    ("dayyear", -2.9130592981629593),
                                    ...
                                    ("dd/mmyear (latent)", -6.048553514092109),
                                    ...
                                    ("in|during <named-month>|yearyear (latent)",
                                     -6.048553514092109),
                                    ("at <time-of-day>intersect", -5.643088405983945),
                                    ("hh:mmyear (latent)", -3.969111972412273),
                                    ("Holiyear (latent)", -6.048553514092109),
                                    ("until <time><time-of-day> am|pm", -6.048553514092109),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.048553514092109),
                                    ("dayminute", -3.4458638286477252),
                                    ("yyyy-mm-ddhh:mm", -5.643088405983945),
                                    ("intersectfrom|since|after <time>", -5.643088405983945),
                                    ("intersectSeptember", -4.544476117315835),
                                    ("Jumu'atul-Widayear (latent)", -5.643088405983945),
                                    ("minuteday", -2.8098750619277286),
                                    ...
                                    ("at <time-of-day>on <day>", -5.643088405983945),
                                    ("time-of-day (latent)<time-of-day> am|pm", -6.048553514092109),
                                    ...
                                    ("time-of-day (latent)at <time-of-day>", -5.355406333532164),
                                    ...
                                    ("August Bank Holidayyear (latent)", -5.355406333532164),
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.21472498084861394,
                               ...
                               n = 167},
                   koData =
                     ClassData{prior = -1.6438393391514328,
                               unseen = -3.8066624897703196,
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -1.2192402764567243),
       ...
       ("next <time>",
        Classifier{okData =
                     ClassData{prior = -8.004270767353637e-2,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("Martin Luther King's Day", -2.169053700369523),
                                    ("Halloween", -2.8622008809294686),
                                    ("Wednesday", -2.8622008809294686),
                                    ("Boss's Day", -2.8622008809294686),
                                    ("Mothering Sunday", -2.8622008809294686),
                                    ("day", -1.0704414117014134),
                                    ("Thanksgiving Day", -2.8622008809294686),
                                    ("March", -2.8622008809294686), ("month", -2.8622008809294686),
                                    ("Tuesday", -2.169053700369523)],
                               n = 12},
                   koData =
                     ClassData{prior = -2.5649493574615367, unseen = -2.639057329615259,
                               likelihoods =
                                 HashMap.fromList
                                   [("Monday", -1.8718021769015913), ("day", -1.8718021769015913)],
                               n = 1}}),
