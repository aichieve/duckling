...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.588514202220496, unseen = -6.131226489483141,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 458},
                   koData =
                     ClassData{prior = -0.8100215382801108, unseen = -5.910796644040527,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4801718826749882,
                               unseen = -7.1308988302963465,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.436951329565632),
                                    ("Father's Dayyear (latent)", -6.436951329565632),
                                    ("Karva Chauthyear (latent)", -6.436951329565632),
                                    ("<day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.436951329565632),
                                    ("Maha Shivaratriyear (latent)", -6.436951329565632),
                                    ("Ramadanyear (latent)", -5.184188361070264),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -5.050656968445741),
                                    ("Bhai Doojyear (latent)", -6.436951329565632),
                                    ("hourday", -4.422048309023368),
                                    ("dayhour", -3.492512350399192),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.050656968445741),
                                    ("Martin Luther King's Dayyear (latent)", -6.0314862214574685),
                                    ("Shemini Atzeretyear (latent)", -6.436951329565632),
                                    ("daymonth", -4.422048309023368),
                                    ("monthday", -6.0314862214574685),
                                    ("monthyear", -4.645191860337578),
                                    ("Yom Ha'atzmautyear (latent)", -6.436951329565632),
                                    ("Vijayadashamiyear (latent)", -6.436951329565632),
                                    ("Thanksgiving Dayyear (latent)", -5.338339040897523),
                                    ("Thai Pongalyear (latent)", -5.743804149005687),
                                    ("Thiru Onamyear (latent)", -5.743804149005687),
                                    ("hhhmmabsorption of , after named day", -6.436951329565632),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.436951329565632),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.520660597691477),
                                    ("<day-of-month> (ordinal)Wednesday", -6.436951329565632),
                                    ("Krishna Janmashtamiyear (latent)", -6.0314862214574685),
                                    ("Guru Gobind Singh Jayantiyear (latent)", -6.436951329565632),
                                    ("houryear", -5.520660597691477),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.436951329565632),
                                    ("Christmas<time-of-day> am|pm", -6.436951329565632),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.436951329565632),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.743804149005687),
                                    ("intersectin|during <named-month>|year", -6.436951329565632),
                                    ("<time-of-day> am|pmintersect", -5.184188361070264),
                                    ("Earth Houryear (latent)", -6.436951329565632),
                                    ("Ganesh Chaturthiyear (latent)", -6.436951329565632),
                                    ("Octoberyear (latent)", -4.9328739327893585),
                                    ("intersect<time-of-day> am|pm", -6.436951329565632),
                                    ("Mattu Pongalyear (latent)", -6.436951329565632),
                                    ("Shavuotyear (latent)", -6.436951329565632),
                                    ("Parsi New Yearyear (latent)", -5.520660597691477),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.436951329565632),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.436951329565632),
                                    ("todayin|within|after <duration>", -6.436951329565632),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -6.0314862214574685),
                                    ("Marchyear (latent)", -6.436951329565632),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hhhmm",
                                     -6.0314862214574685),
                                    ("Sukkotyear (latent)", -6.0314862214574685),
                                    ("hhhmmintersect", -6.0314862214574685),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -6.0314862214574685),
                                    ("Clean Mondayyear (latent)", -6.0314862214574685),
                                    ("monthhour", -6.0314862214574685),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.743804149005687),
                                    ("todayat <time-of-day>", -6.436951329565632),
                                    ("Thursday<time> timezone", -4.0390560567672615),
                                    ("time-of-day (latent)tonight", -6.0314862214574685),
                                    ("from|since|after <time>December", -6.436951329565632),
                                    ("dd/mm<time-of-day> am|pm", -6.436951329565632),
                                    ("<time-of-day> am|pmon <day>", -4.422048309023368),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.436951329565632),
                                    ("yyyy-mm-ddhh:mm:ss", -6.0314862214574685),
                                    ("dayday", -3.728901128463422),
                                    ("dd/mmat <time-of-day>", -6.436951329565632),
                                    ("<time> <part-of-day>at <time-of-day>", -6.436951329565632),
                                    ("tonightat <time-of-day>", -6.436951329565632),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.743804149005687),
                                    ("Dayananda Saraswati Jayantiyear (latent)",
                                     -6.436951329565632),
                                    ("today<time-of-day> am|pm", -6.436951329565632),
                                    ("Februarythe <day-of-month> (ordinal)", -6.0314862214574685),
                                    ("at <time-of-day><time> <part-of-day>", -6.436951329565632),
                                    ("<day-of-month> (ordinal)intersect", -6.0314862214574685),
                                    ("hourhour", -4.357509787885797),
                                    ("Mahavir Jayantiyear (latent)", -6.0314862214574685),
                                    ("Navaratriin|during <named-month>|year", -6.436951329565632),
                                    ("Wednesdaythis|last|next <cycle>", -6.436951329565632),
                                    ("Lentyear (latent)", -6.436951329565632),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.565149152664041),
                                    ("Boghiyear (latent)", -6.436951329565632),
                                    ("dayyear", -1.8519838508950603),
                                    ("Karva Chauthin|during <named-month>|year",
                                     -6.436951329565632),
                                    ("Thursdayfrom|since|after <time>", -6.0314862214574685),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.436951329565632),
                                    ("Thursdayat <time-of-day>", -5.743804149005687),
                                    ("Islamic New Yearyear (latent)", -6.0314862214574685),
                                    ("Laylat al-Qadryear (latent)", -5.520660597691477),
                                    ("Shrove Tuesdayyear (latent)", -6.436951329565632),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.743804149005687),
                                    ("<time-of-day> am|pmtomorrow", -5.743804149005687),
                                    ("Yom Kippuryear (latent)", -6.436951329565632),
                                    ("<day-of-month> (ordinal)Tuesday", -6.0314862214574685),
                                    ("<part-of-day> of <time>year (latent)", -6.436951329565632),
                                    ("minutehour", -5.184188361070264),
                                    ("Kaanum Pongalyear (latent)", -6.0314862214574685),
                                    ("Maha Saptamiyear (latent)", -6.436951329565632),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -6.0314862214574685),
                                    ("time-of-day (latent)tomorrow", -5.520660597691477),
                                    ("part of daysat <time-of-day>", -6.0314862214574685),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.422048309023368),
                                    ("for <duration> from <time>December", -6.436951329565632),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.436951329565632),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.184188361070264),
                                    ("intersect by \",\", \"of\", \"from\" for yearhhhmm",
                                     -5.184188361070264),
                                    ("time-of-day (latent)this <part-of-day>", -6.436951329565632),
                                    ("Pentecostyear (latent)", -6.436951329565632),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.184188361070264),
                                    ("<day-of-month> (ordinal)February", -6.436951329565632),
                                    ("Eid al-Fitryear (latent)", -5.050656968445741),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.436951329565632),
                                    ("Mondayin|during the <part-of-day>", -6.436951329565632),
                                    ("Chhathin|during <named-month>|year", -6.436951329565632),
                                    ("Diwaliin|during <named-month>|year", -6.436951329565632),
                                    ("Vaisakhiin|during <named-month>|year", -6.436951329565632),
                                    ("Guru Ravidass Jayantiyear (latent)", -5.184188361070264),
                                    ("Raksha Bandhanyear (latent)", -6.436951329565632),
                                    ("daysecond", -6.0314862214574685),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -6.0314862214574685),
                                    ("Ratha-Yatrayear (latent)", -6.436951329565632),
                                    ("Ashurayear (latent)", -6.436951329565632),
                                    ("Tuesdayin|during <named-month>|year", -6.436951329565632),
                                    ("Chinese New Yearyear (latent)", -6.436951329565632),
                                    ("tomorrowintersect", -6.436951329565632),
                                    ("Lag BaOmeryear (latent)", -6.436951329565632),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.436951329565632),
                                    ("Eid al-Adhayear (latent)", -4.296885166069361),
                                    ("intersectin|during the <part-of-day>", -6.436951329565632),
                                    ("Palm Sundayyear (latent)", -6.436951329565632),
                                    ("Christmasat <time-of-day>", -6.436951329565632),
                                    ("Passoveryear (latent)", -6.436951329565632),
                                    ("Lazarus Saturdayyear (latent)", -6.436951329565632),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.436951329565632),
                                    ("hhhmmon <day>", -5.520660597691477),
                                    ("Yom HaShoahyear (latent)", -6.0314862214574685),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -6.0314862214574685),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.436951329565632),
                                    ("Septemberyear (latent)", -6.0314862214574685),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.9328739327893585),
                                    ("Halloweenyear (latent)", -6.436951329565632),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.436951329565632),
                                    ("at <time-of-day>intersect", -5.520660597691477),
                                    ("Rosh Hashanahyear (latent)", -5.743804149005687),
                                    ("Dhanterasyear (latent)", -6.436951329565632),
                                    ("Tu BiShvatyear (latent)", -6.436951329565632),
                                    ("<day-of-month> (ordinal)December", -5.743804149005687),
                                    ("Holiyear (latent)", -5.743804149005687),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.436951329565632),
                                    ("Holika Dahanyear (latent)", -5.743804149005687),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.0314862214574685),
                                    ("dayminute", -3.0870472422910273),
                                    ("Mawlidyear (latent)", -6.436951329565632),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -6.0314862214574685),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.436951329565632),
                                    ("Jumu'atul-Widayear (latent)", -5.520660597691477),
                                    ("minuteday", -2.6992817112822642),
                                    ("absorption of , after named dayintersect",
                                     -5.743804149005687),
                                    ("intersectyear (latent)", -6.436951329565632),
                                    ("Orthodox Easter Sundayyear (latent)", -6.436951329565632),
                                    ("time-of-day (latent)in|within|after <duration>",
                                     -6.436951329565632),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -6.436951329565632),
                                    ("intersecthhhmm", -6.0314862214574685),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.436951329565632),
                                    ("Mothering Sundayyear (latent)", -6.0314862214574685),
                                    ("Boss's Dayyear (latent)", -6.0314862214574685),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.436951329565632),
                                    ("Global Youth Service Dayyear (latent)", -6.436951329565632),
                                    ("Dhanterasin|during <named-month>|year", -6.436951329565632),
                                    ("Tisha B'Avyear (latent)", -6.436951329565632),
                                    ("Isra and Mi'rajyear (latent)", -5.520660597691477),
                                    ("at <time-of-day>on <day>", -4.827513417131532),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.0314862214574685),
                                    ("time-of-day (latent)<time> <part-of-day>",
                                     -5.743804149005687),
                                    ("Christmasyear (latent)", -6.0314862214574685),
                                    ("Naraka Chaturdashiyear (latent)", -6.0314862214574685),
                                    ("Thai Pongalin|during <named-month>|year", -6.436951329565632),
                                    ("dayweek", -6.436951329565632),
                                    ("Easter Sundayyear (latent)", -5.743804149005687),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -6.0314862214574685),
                                    ("weekyear", -5.338339040897523),
                                    ("King's Dayyear (latent)", -4.9328739327893585),
                                    ("hh:mmin|during the <part-of-day>", -5.520660597691477),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -6.0314862214574685),
                                    ("Hanukkahyear (latent)", -5.743804149005687),
                                    ("February<time> <part-of-day>", -6.436951329565632),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -6.436951329565632),
                                    ("Great Lentyear (latent)", -6.436951329565632),
                                    ("tomorrowat <time-of-day>", -5.743804149005687),
                                    ("hhmm (latent)in|during the <part-of-day>",
                                     -6.436951329565632),
                                    ("Ugadiyear (latent)", -5.050656968445741),
                                    ("Vaisakhiyear (latent)", -5.743804149005687),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -5.743804149005687),
                                    ("last <cycle> of <time>year (latent)", -5.743804149005687),
                                    ("at <time-of-day>tomorrow", -6.0314862214574685),
                                    ("tomorrow<time-of-day> am|pm", -6.436951329565632),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.436951329565632),
                                    ("Diwaliyear (latent)", -6.436951329565632),
                                    ("between <time> and <time>on <day>", -6.0314862214574685),
                                    ("Black Fridayyear (latent)", -6.0314862214574685),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.436951329565632),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.436951329565632),
                                    ("Chhathyear (latent)", -6.0314862214574685),
                                    ("Vasant Panchamiyear (latent)", -6.436951329565632),
                                    ("Rabindra Jayantiyear (latent)", -5.184188361070264),
                                    ("St Patrick's Dayyear (latent)", -6.436951329565632),
                                    ("Thursday<time> (timezone)", -6.436951329565632),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.436951329565632),
                                    ("Pargat Diwasyear (latent)", -5.184188361070264),
                                    ("August Bank Holidayyear (latent)", -5.743804149005687),
                                    ("<datetime> - <datetime> (interval)July", -6.0314862214574685),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.743804149005687),
                                    ("Februaryintersect", -6.436951329565632),
                                    ("Simchat Torahyear (latent)", -6.436951329565632),
                                    ("minuteyear", -6.436951329565632)],
                               n = 477},
                   koData =
                     ClassData{prior = -0.9641086062246479, unseen = -6.784457062637643,
                               likelihoods =
                                 HashMap.fromList
                                   [("Thursdayhhhmm", -4.586100623267741),
                                    ...
                                    ("Bank Holidayyear (latent)", -5.397030839484069),
                                    ...
                                    ("dayday", -4.703883658924124),
                                    ("dd/mmat <time-of-day>", -5.684712911935851),
                                    ("on <day>September", -5.397030839484069),
                                    ("time-of-day (latent)September", -5.684712911935851),
                                    ("hourhour", -4.991565731375905),
                                    ...
                                    ("this|last|next <cycle>from|since|after <time>",
                                     -5.684712911935851),
                                    ("tomorrowfrom|since|after <time>", -5.684712911935851),
                                    ("Augustyear (latent)", -5.684712911935851),
                                    ("week-endin|during <named-month>|year", -6.090178020044014),
                                    ("this|last|next <cycle>until <time>", -5.684712911935851),
                                    ("time-of-day (latent)Tuesday", -5.684712911935851),
                                    ("tomorrowuntil <time>", -5.684712911935851),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -6.090178020044014),
                                    ...
                                    ("dd/mmyear (latent)", -6.090178020044014),
                                    ...
                                    ("time-of-day (latent)<time-of-day> am|pm", -6.090178020044014),
                                    ...
                                    ("time-of-day (latent)at <time-of-day>", -5.397030839484069),
                                    ...
                                    ("tomorrow<time-of-day> am|pm", -5.397030839484069),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.397030839484069),
