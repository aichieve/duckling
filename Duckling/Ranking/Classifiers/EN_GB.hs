...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.5861233640553012, unseen = -6.152732694704104,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 468},
                   koData =
                     ClassData{prior = -0.8130132403291325, unseen = -5.926926025970411,
       ...
       ("from|since|after <time>",
        Classifier{okData =
                     ClassData{prior = -1.5515439340151977, unseen = -4.624972813284271,
                               likelihoods =
                                 HashMap.fromList
                               ...
                               n = 32},
                   koData =
                     ClassData{prior = -0.23815634370339492, unseen = -5.62040086571715,
                               likelihoods =
                                 HashMap.fromList
                                   [("<integer> to|till|before <hour-of-day>", -4.007333185232471),
                                    ("week", -4.923623917106626),
                                    ("<day-of-month> (ordinal or number) <named-month>",
                                     -4.923623917106626),
                                    ("today", -4.923623917106626),
                                    ("intersect", -2.977713768051313),
                                    ("<time> for <duration>", -4.230476736546681),
                                    ("second", -4.923623917106626), ("now", -3.3141860046725258),
                                    ("tomorrow", -4.518158808998462),
                                    ("this|last|next <cycle>", -4.923623917106626),
                                    ("day", -1.8101086078962516),
                                    ("the <day-of-month> (ordinal)", -4.518158808998462),
                                    ("the <day-of-month> (number)", -3.5373295559867355),
                                    ("time-of-day (latent)", -2.4812768817374216),
                                    ("<time-of-day> am|pm", -4.230476736546681),
                                    ("hh:mm", -4.518158808998462), ("nograin", -3.3141860046725258),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -4.518158808998462),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)",
                                     -4.923623917106626),
                                    ("<day-of-month> (ordinal)", -3.8250116284385163),
                                    ("Easter Sunday", -4.923623917106626),
                                    ("Christmas", -4.230476736546681), ("hour", -2.320934231662242),
                                    ("month", -4.923623917106626),
                                    ("<datetime> - <datetime> (interval)", -2.84418237542679),
                                    ("<time-of-day> - <time-of-day> (interval)",
                                     -2.977713768051313),
                                    ("<named-month> <day-of-month> (non ordinal)",
                                     -4.518158808998462),
                                    ("minute", -1.9791849379401856),
                                    ("right now", -4.923623917106626),
                                    ("<month> dd-dd (interval)", -4.230476736546681),
                                    ("part of days", -4.923623917106626),
                                    ("dd-dd <month> (interval)", -4.518158808998462)],
                               n = 119}}),
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4824519227723035, unseen = -7.134093721192866,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.440148774336123),
                                    ("Father's Dayyear (latent)", -6.440148774336123),
                                    ("Karva Chauthyear (latent)", -6.440148774336123),
                                    ("<day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.440148774336123),
                                    ("Maha Shivaratriyear (latent)", -6.440148774336123),
                                    ("Ramadanyear (latent)", -5.187385805840755),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -5.053854413216232),
                                    ("Bhai Doojyear (latent)", -6.440148774336123),
                                    ("hourday", -4.425245753793858),
                                    ("dayhour", -3.4957097951696827),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.053854413216232),
                                    ("Martin Luther King's Dayyear (latent)", -6.034683666227958),
                                    ("Shemini Atzeretyear (latent)", -6.440148774336123),
                                    ("daymonth", -4.425245753793858),
                                    ("monthday", -6.034683666227958),
                                    ("monthyear", -4.648389305108068),
                                    ("Yom Ha'atzmautyear (latent)", -6.440148774336123),
                                    ("Vijayadashamiyear (latent)", -6.440148774336123),
                                    ("Thanksgiving Dayyear (latent)", -5.341536485668013),
                                    ("Thai Pongalyear (latent)", -5.747001593776178),
                                    ("Thiru Onamyear (latent)", -5.747001593776178),
                                    ("hhhmmabsorption of , after named day", -6.440148774336123),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.440148774336123),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.523858042461968),
                                    ("<day-of-month> (ordinal)Wednesday", -6.440148774336123),
                                    ("Krishna Janmashtamiyear (latent)", -6.034683666227958),
                                    ("Guru Gobind Singh Jayantiyear (latent)", -6.440148774336123),
                                    ("houryear", -5.523858042461968),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.440148774336123),
                                    ("Christmas<time-of-day> am|pm", -6.440148774336123),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.440148774336123),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.747001593776178),
                                    ("intersectin|during <named-month>|year", -6.440148774336123),
                                    ("<time-of-day> am|pmintersect", -5.187385805840755),
                                    ("Earth Houryear (latent)", -6.440148774336123),
                                    ("Ganesh Chaturthiyear (latent)", -6.440148774336123),
                                    ("Octoberyear (latent)", -4.936071377559849),
                                    ("intersect<time-of-day> am|pm", -6.440148774336123),
                                    ("Mattu Pongalyear (latent)", -6.440148774336123),
                                    ("Shavuotyear (latent)", -6.440148774336123),
                                    ("Parsi New Yearyear (latent)", -5.523858042461968),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.440148774336123),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.440148774336123),
                                    ("todayin|within|after <duration>", -6.440148774336123),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -6.034683666227958),
                                    ("Marchyear (latent)", -6.440148774336123),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hhhmm",
                                     -6.034683666227958),
                                    ("Sukkotyear (latent)", -6.034683666227958),
                                    ("hhhmmintersect", -6.034683666227958),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -6.034683666227958),
                                    ("Clean Mondayyear (latent)", -6.034683666227958),
                                    ("monthhour", -6.034683666227958),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.747001593776178),
                                    ("todayat <time-of-day>", -6.440148774336123),
                                    ("Thursday<time> timezone", -4.042253501537752),
                                    ("time-of-day (latent)tonight", -6.034683666227958),
                                    ("from|since|after <time>December", -6.440148774336123),
                                    ("dd/mm<time-of-day> am|pm", -6.440148774336123),
                                    ("<time-of-day> am|pmon <day>", -4.425245753793858),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.440148774336123),
                                    ("yyyy-mm-ddhh:mm:ss", -6.034683666227958),
                                    ("dayday", -3.732098573233913),
                                    ("dd/mmat <time-of-day>", -6.440148774336123),
                                    ("<time> <part-of-day>at <time-of-day>", -6.440148774336123),
                                    ("tonightat <time-of-day>", -6.440148774336123),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.747001593776178),
                                    ("Dayananda Saraswati Jayantiyear (latent)",
                                     -6.440148774336123),
                                    ("today<time-of-day> am|pm", -6.440148774336123),
                                    ("Februarythe <day-of-month> (ordinal)", -6.034683666227958),
                                    ("at <time-of-day><time> <part-of-day>", -6.440148774336123),
                                    ("<day-of-month> (ordinal)intersect", -6.034683666227958),
                                    ("hourhour", -4.360707232656287),
                                    ("Mahavir Jayantiyear (latent)", -6.034683666227958),
                                    ("Navaratriin|during <named-month>|year", -6.440148774336123),
                                    ("Wednesdaythis|last|next <cycle>", -6.440148774336123),
                                    ("Lentyear (latent)", -6.440148774336123),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.568346597434531),
                                    ("Boghiyear (latent)", -6.440148774336123),
                                    ("dayyear", -1.8450289242015332),
                                    ("Karva Chauthin|during <named-month>|year",
                                     -6.440148774336123),
                                    ("Thursdayfrom|since|after <time>", -6.034683666227958),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.440148774336123),
                                    ("Thursdayat <time-of-day>", -5.747001593776178),
                                    ("Islamic New Yearyear (latent)", -6.034683666227958),
                                    ("Laylat al-Qadryear (latent)", -5.523858042461968),
                                    ("Shrove Tuesdayyear (latent)", -6.440148774336123),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.747001593776178),
                                    ("<time-of-day> am|pmtomorrow", -5.747001593776178),
                                    ("Yom Kippuryear (latent)", -6.440148774336123),
                                    ("<day-of-month> (ordinal)Tuesday", -6.034683666227958),
                                    ("<part-of-day> of <time>year (latent)", -6.440148774336123),
                                    ("minutehour", -5.187385805840755),
                                    ("Kaanum Pongalyear (latent)", -6.034683666227958),
                                    ("Maha Saptamiyear (latent)", -6.440148774336123),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -6.034683666227958),
                                    ("time-of-day (latent)tomorrow", -5.523858042461968),
                                    ("part of daysat <time-of-day>", -6.034683666227958),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.425245753793858),
                                    ("for <duration> from <time>December", -6.440148774336123),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.440148774336123),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.187385805840755),
                                    ("intersect by \",\", \"of\", \"from\" for yearhhhmm",
                                     -5.187385805840755),
                                    ("time-of-day (latent)this <part-of-day>", -6.440148774336123),
                                    ("Pentecostyear (latent)", -6.440148774336123),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.187385805840755),
                                    ("<day-of-month> (ordinal)February", -6.440148774336123),
                                    ("Eid al-Fitryear (latent)", -5.053854413216232),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.440148774336123),
                                    ("Mondayin|during the <part-of-day>", -6.440148774336123),
                                    ("Chhathin|during <named-month>|year", -6.440148774336123),
                                    ("Diwaliin|during <named-month>|year", -6.440148774336123),
                                    ("Vaisakhiin|during <named-month>|year", -6.440148774336123),
                                    ("Guru Ravidass Jayantiyear (latent)", -5.187385805840755),
                                    ("Raksha Bandhanyear (latent)", -6.440148774336123),
                                    ("daysecond", -6.034683666227958),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -6.034683666227958),
                                    ("Ratha-Yatrayear (latent)", -6.440148774336123),
                                    ("Ashurayear (latent)", -6.440148774336123),
                                    ("Tuesdayin|during <named-month>|year", -6.440148774336123),
                                    ("Chinese New Yearyear (latent)", -6.440148774336123),
                                    ("tomorrowintersect", -6.440148774336123),
                                    ("Lag BaOmeryear (latent)", -6.440148774336123),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.440148774336123),
                                    ("Eid al-Adhayear (latent)", -4.300082610839852),
                                    ("intersectin|during the <part-of-day>", -6.440148774336123),
                                    ("Palm Sundayyear (latent)", -6.440148774336123),
                                    ("Christmasat <time-of-day>", -6.440148774336123),
                                    ("Passoveryear (latent)", -6.440148774336123),
                                    ("Lazarus Saturdayyear (latent)", -6.440148774336123),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.440148774336123),
                                    ("hhhmmon <day>", -5.523858042461968),
                                    ("Yom HaShoahyear (latent)", -6.034683666227958),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -6.034683666227958),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.440148774336123),
                                    ("Septemberyear (latent)", -6.034683666227958),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.936071377559849),
                                    ("Halloweenyear (latent)", -6.440148774336123),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.440148774336123),
                                    ("at <time-of-day>intersect", -5.523858042461968),
                                    ("Rosh Hashanahyear (latent)", -5.747001593776178),
                                    ("Dhanterasyear (latent)", -6.440148774336123),
                                    ("Tu BiShvatyear (latent)", -6.440148774336123),
                                    ("<day-of-month> (ordinal)December", -5.747001593776178),
                                    ("Holiyear (latent)", -5.747001593776178),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.440148774336123),
                                    ("Holika Dahanyear (latent)", -5.747001593776178),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.034683666227958),
                                    ("dayminute", -3.090244687061518),
                                    ("Mawlidyear (latent)", -6.440148774336123),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -6.034683666227958),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.440148774336123),
                                    ("Jumu'atul-Widayear (latent)", -5.523858042461968),
                                    ("minuteday", -2.7024791560527546),
                                    ("absorption of , after named dayintersect",
                                     -5.747001593776178),
                                    ("intersectyear (latent)", -6.440148774336123),
                                    ("Orthodox Easter Sundayyear (latent)", -6.440148774336123),
                                    ("time-of-day (latent)in|within|after <duration>",
                                     -6.440148774336123),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -6.440148774336123),
                                    ("intersecthhhmm", -6.034683666227958),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.440148774336123),
                                    ("Mothering Sundayyear (latent)", -6.034683666227958),
                                    ("Boss's Dayyear (latent)", -6.034683666227958),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.440148774336123),
                                    ("Global Youth Service Dayyear (latent)", -6.440148774336123),
                                    ("Dhanterasin|during <named-month>|year", -6.440148774336123),
                                    ("Tisha B'Avyear (latent)", -6.440148774336123),
                                    ("Isra and Mi'rajyear (latent)", -5.523858042461968),
                                    ("at <time-of-day>on <day>", -4.8307108619020225),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.034683666227958),
                                    ("time-of-day (latent)<time> <part-of-day>",
                                     -5.747001593776178),
                                    ("Christmasyear (latent)", -6.034683666227958),
                                    ("Naraka Chaturdashiyear (latent)", -6.034683666227958),
                                    ("Thai Pongalin|during <named-month>|year", -6.440148774336123),
                                    ("dayweek", -6.440148774336123),
                                    ("Easter Sundayyear (latent)", -5.747001593776178),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -6.034683666227958),
                                    ("weekyear", -5.341536485668013),
                                    ("King's Dayyear (latent)", -4.936071377559849),
                                    ("hh:mmin|during the <part-of-day>", -5.523858042461968),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -6.034683666227958),
                                    ("Hanukkahyear (latent)", -5.747001593776178),
                                    ("February<time> <part-of-day>", -6.440148774336123),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -6.440148774336123),
                                    ("Great Lentyear (latent)", -6.440148774336123),
                                    ("tomorrowat <time-of-day>", -5.747001593776178),
                                    ("hhmm (latent)in|during the <part-of-day>",
                                     -6.440148774336123),
                                    ("Ugadiyear (latent)", -5.053854413216232),
                                    ("Vaisakhiyear (latent)", -5.747001593776178),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -5.747001593776178),
                                    ("last <cycle> of <time>year (latent)", -5.747001593776178),
                                    ("at <time-of-day>tomorrow", -6.034683666227958),
                                    ("tomorrow<time-of-day> am|pm", -6.440148774336123),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.747001593776178),
                                    ("Diwaliyear (latent)", -6.440148774336123),
                                    ("between <time> and <time>on <day>", -6.034683666227958),
                                    ("Black Fridayyear (latent)", -6.034683666227958),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.440148774336123),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.440148774336123),
                                    ("Chhathyear (latent)", -6.034683666227958),
                                    ("Vasant Panchamiyear (latent)", -6.440148774336123),
                                    ("Rabindra Jayantiyear (latent)", -5.187385805840755),
                                    ("St Patrick's Dayyear (latent)", -6.440148774336123),
                                    ("Thursday<time> (timezone)", -6.440148774336123),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.440148774336123),
                                    ("Pargat Diwasyear (latent)", -5.187385805840755),
                                    ("August Bank Holidayyear (latent)", -5.747001593776178),
                                    ("<datetime> - <datetime> (interval)July", -6.034683666227958),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.747001593776178),
                                    ("Februaryintersect", -6.440148774336123),
                                    ("Simchat Torahyear (latent)", -6.440148774336123),
                                    ("minuteyear", -6.440148774336123)],
                               n = 479},
                   koData =
                     ClassData{prior = -0.9604203813805192,
                               unseen = -6.7912214627261855,
                               likelihoods =
                                 HashMap.fromList
                                   [("Thursdayhhhmm", -4.5928726581776855),
                                    ("time-of-day (latent)<time-of-day> - <time-of-day> (interval)",
                                     -5.691484946845795),
                                    ("hourday", -3.6990547821555886),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -6.096950054953959),
                                    ("<day-of-month> (ordinal)August", -6.096950054953959),
                                    ("dayhour", -3.2347491740244907),
                                    ("<time> timezoneyear (latent)", -5.403802874394014),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.180659323079804),
                                    ("Tuesdayfrom|since|after <time>", -5.403802874394014),
                                    ("daymonth", -3.4228014055274305),
                                    ("monthday", -5.180659323079804),
                                    ("monthyear", -4.487512142519859),
                                    ("<time-of-day> am|pmyear (latent)", -5.403802874394014),
                                    ("Thai Pongalyear (latent)", -5.403802874394014),
                                    ("intersecthh:mm", -6.096950054953959),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.691484946845795),
                                    ("<day-of-month> (ordinal)Wednesday", -6.096950054953959),
                                    ("houryear", -4.7106556938340685),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -6.096950054953959),
                                    ("<day-of-month> (ordinal)October", -6.096950054953959),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.403802874394014),
                                    ("hournograin", -4.844187086458591),
                                    ("<time-of-day> am|pmintersect", -4.844187086458591),
                                    ("Octoberyear (latent)", -6.096950054953959),
                                    ("time-of-day (latent)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.691484946845795),
                                    ("until <time>on <day>", -5.403802874394014),
                                    ("time-of-day (latent)intersect", -5.403802874394014),
                                    ("todayin <number> (implicit minutes)", -6.096950054953959),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.403802874394014),
                                    ("Marchyear (latent)", -5.691484946845795),
                                    ("about|exactly <time-of-day>year (latent)",
                                     -6.096950054953959),
                                    ("hh:mmon <day>", -4.844187086458591),
                                    ("hhhmmintersect", -5.691484946845795),
                                    ("absorption of , after named dayJuly", -5.180659323079804),
                                    ("from|since|after <time>July", -5.691484946845795),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.180659323079804),
                                    ("Clean Mondayyear (latent)", -6.096950054953959),
                                    ("monthhour", -6.096950054953959),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.691484946845795),
                                    ("hourmonth", -4.2251478780523675),
                                    ("todayat <time-of-day>", -6.096950054953959),
                                    ("Bank Holidayyear (latent)", -5.403802874394014),
                                    ("hhhmmyear (latent)", -4.844187086458591),
                                    ("from|since|after <time>December", -6.096950054953959),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -6.096950054953959),
                                    ("<time-of-day> am|pmon <day>", -4.844187086458591),
                                    ("Mondayyear (latent)", -5.403802874394014),
                                    ("dayday", -4.7106556938340685),
                                    ("dd/mmat <time-of-day>", -5.691484946845795),
                                    ("on <day>September", -5.403802874394014),
                                    ("time-of-day (latent)September", -5.691484946845795),
                                    ("hourhour", -4.998337766285849),
                                    ("time-of-day (latent)on <day>", -4.5928726581776855),
                                    ("Thursdaydd/mm", -6.096950054953959),
                                    ("time-of-day (latent)<cycle> after|before <time>",
                                     -5.691484946845795),
                                    ("dayyear", -3.0765251688095967),
                                    ("New Year's Dayyear (latent)", -5.180659323079804),
                                    ("time-of-day (latent)Sunday", -5.691484946845795),
                                    ("Thursdayfrom|since|after <time>", -4.392201962715534),
                                    ("Thursdayat <time-of-day>", -4.487512142519859),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -6.096950054953959),
                                    ("Aprilyear (latent)", -5.691484946845795),
                                    ("the <day-of-month> (ordinal)July", -6.096950054953959),
                                    ("the <day-of-month> (number)July", -6.096950054953959),
                                    ("monthminute", -6.096950054953959),
                                    ("hourminute", -5.403802874394014),
                                    ("<time-of-day> am|pmtomorrow", -6.096950054953959),
                                    ("Thursdayhh:mm", -5.180659323079804),
                                    ("<day-of-month> (ordinal)Tuesday", -5.691484946845795),
                                    ("minutemonth", -3.9568838914576885),
                                    ("time-of-day (latent)Friday", -5.691484946845795),
                                    ("minutehour", -6.096950054953959),
                                    ("this|last|next <cycle>from|since|after <time>",
                                     -5.691484946845795),
                                    ("tomorrowfrom|since|after <time>", -5.691484946845795),
                                    ("Augustyear (latent)", -5.691484946845795),
                                    ("week-endin|during <named-month>|year", -6.096950054953959),
                                    ("this|last|next <cycle>until <time>", -5.691484946845795),
                                    ("time-of-day (latent)Tuesday", -5.691484946845795),
                                    ("tomorrowuntil <time>", -5.691484946845795),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -6.096950054953959),
                                    ("dd/mm<time-of-day> - <time-of-day> (interval)",
                                     -5.691484946845795),
                                    ("Sundayyear (latent)", -5.180659323079804),
                                    ("Christmasat <time-of-day>", -6.096950054953959),
                                    ("from|since|after <time>year (latent)", -4.998337766285849),
                                    ("dd/mmyear (latent)", -6.096950054953959),
                                    ("hhhmmon <day>", -5.180659323079804),
                                    ("yesterday<time-of-day> am|pm", -6.096950054953959),
                                    ("<day-of-month> (ordinal)July", -5.403802874394014),
                                    ...
                                    ("in|during <named-month>|yearyear (latent)",
                                     -6.096950054953959),
                                    ("at <time-of-day>intersect", -5.180659323079804),
                                    ("hh:mmyear (latent)", -4.7106556938340685),
                                    ("Holiyear (latent)", -6.096950054953959),
                                    ("until <time><time-of-day> am|pm", -6.096950054953959),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.691484946845795),
                                    ("dayminute", -3.2347491740244907),
                                    ("yyyy-mm-ddhh:mm", -5.691484946845795),
                                    ("intersectfrom|since|after <time>", -5.691484946845795),
                                    ("intersectSeptember", -4.2251478780523675),
                                    ("minuteday", -2.939949633803846),
                                    ("absorption of , after named dayintersect",
                                     -6.096950054953959),
                                    ("intersectyear (latent)", -6.096950054953959),
                                    ("Februaryin|during the <part-of-day>", -6.096950054953959),
                                    ("<duration> after|before|from|past <time>December",
                                     -6.096950054953959),
                                    ("time-of-day (latent)July", -5.403802874394014),
                                    ("Saturdayyear (latent)", -6.096950054953959),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.096950054953959),
                                    ("at <time-of-day>on <day>", -5.180659323079804),
                                    ("time-of-day (latent)<time-of-day> am|pm", -6.096950054953959),
                                    ("absorption of , after named daySeptember",
                                     -4.844187086458591),
                                    ("Naraka Chaturdashiyear (latent)", -6.096950054953959),
                                    ("from|since|after <time>on <day>", -5.180659323079804),
                                    ("dayweek", -6.096950054953959),
                                    ("Easter Sundayyear (latent)", -5.691484946845795),
                                    ("time-of-day (latent)at <time-of-day>", -5.403802874394014),
                                    ("Thursday<time-of-day> am|pm", -4.844187086458591),
                                    ("weekyear", -5.691484946845795),
                                    ("time-of-day (latent)Thursday", -5.691484946845795),
                                    ("<named-month> <day-of-month> (non ordinal)until <time>",
                                     -6.096950054953959),
                                    ("<day-of-month> (ordinal)April", -6.096950054953959),
                                    ("yyyy-mm-dd<time-of-day> - <time-of-day> (interval)",
                                     -5.691484946845795),
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.403802874394014),
                                    ("Sundayfrom|since|after <time>", -6.096950054953959),
                                    ("absorption of , after named dayFebruary", -5.180659323079804),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.691484946845795),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -6.096950054953959),
                                    ("tomorrowat <time-of-day>", -6.096950054953959),
                                    ("daynograin", -5.691484946845795),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.691484946845795),
                                    ("last <cycle> of <time>year (latent)", -5.691484946845795),
                                    ("tomorrow<time-of-day> am|pm", -5.403802874394014),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.403802874394014),
                                    ("Diwaliyear (latent)", -5.691484946845795),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -6.096950054953959),
                                    ("Fridayyear (latent)", -5.691484946845795),
                                    ("time-of-day (latent)April", -6.096950054953959),
                                    ("minuteyear", -3.8997254776177397)],
                               n = 297}}),
       ("one eleven",
        Classifier{okData =
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.15605362997334443,
                               ...
                               n = 225},
                   koData =
                     ClassData{prior = -1.9345678724513788,
       ...
       ("time-of-day (latent)",
        Classifier{okData =
                     ClassData{prior = -0.6701576623352465, unseen = -4.727387818712341,
                               likelihoods =
                                 HashMap.fromList
                               ...
                               n = 110},
                   koData =
                     ClassData{prior = -0.7166776779701395, unseen = -4.68213122712422,
                               likelihoods =
                                 HashMap.fromList
       ...
       ("<integer> <unit-of-duration>",
        Classifier{okData =
                     ClassData{prior = -0.45391749149411126,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("week", -2.5745188084776873),
                                    ("integer (0..19)year (grain)", -3.1498829533812494),
                                    ("integer (numeric)day (grain)", -2.5745188084776873),
                                    ("integer (0..19)second (grain) ", -3.960813169597578),
                                    ("integer (0..19)hour (grain)", -3.1498829533812494),
                                    ("second", -3.5553480614894135),
                                    ("integer (numeric)second (grain) ", -4.248495242049359),
                                    ("integer (numeric)year (grain)", -3.4011973816621555),
                                    ("day", -2.3513752571634776), ("year", -2.639057329615259),
                                    ("integer (numeric)week (grain)", -3.2676659890376327),
                                    ("integer (0..19)month (grain)", -3.5553480614894135),
                                    ("integer (20..90)minute (grain)", -4.653960350157523),
                                    ("hour", -2.7821581732559317), ("month", -3.2676659890376327),
                                    ("integer (numeric)minute (grain)", -2.639057329615259),
                                    ("integer (0..19)minute (grain)", -3.2676659890376327),
                                    ("integer (numeric)month (grain)", -4.248495242049359),
                                    ("minute", -2.211613314788319),
                                    ("integer (numeric)hour (grain)", -3.7376696182833684),
                                    ("integer (0..19)day (grain)", -3.7376696182833684),
                                    ("integer (0..19)week (grain)", -3.1498829533812494)],
                               n = 94},
                   koData =
                     ClassData{prior = -1.0082282271998406, unseen = -4.875197323201151,
                               likelihoods =
                                 HashMap.fromList
                                   [("hour", -0.8602012652231115),
