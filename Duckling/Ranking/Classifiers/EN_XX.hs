...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.6931471805599453, unseen = -5.955837369464831,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.5146099234572302, unseen = -7.01211529430638,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.318066806790422),
                                    ("<day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.318066806790422),
                                    ("Ramadanyear (latent)", -5.624919626230477),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -4.303163786248157),
                                    ("Bhai Doojyear (latent)", -6.318066806790422),
                                    ("hourday", -4.303163786248157),
                                    ("dayhour", -3.4002960747061426),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -4.303163786248157),
                                    ("Martin Luther King's Dayyear (latent)", -5.912601698682257),
                                    ("Shemini Atzeretyear (latent)", -6.318066806790422),
                                    ("daymonth", -4.178000643294151),
                                    ("monthday", -5.912601698682257),
                                    ("monthyear", -4.44626462988883),
                                    ("Yom Ha'atzmautyear (latent)", -6.318066806790422),
                                    ("Vijayadashamiyear (latent)", -6.318066806790422),
                                    ("Thanksgiving Dayyear (latent)", -5.219454518122312),
                                    ("Thai Pongalyear (latent)", -5.624919626230477),
                                    ("Thiru Onamyear (latent)", -5.624919626230477),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.318066806790422),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.401776074916267),
                                    ("<day-of-month> (ordinal)Wednesday", -6.318066806790422),
                                    ("Krishna Janmashtamiyear (latent)", -5.912601698682257),
                                    ("Guru Gobind Singh Jayantiyear (latent)", -6.318066806790422),
                                    ("houryear", -5.401776074916267),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.318066806790422),
                                    ("Christmas<time-of-day> am|pm", -6.318066806790422),
                                    ("<day-of-month> (ordinal)October", -6.318066806790422),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.318066806790422),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.624919626230477),
                                    ("intersectin|during <named-month>|year", -6.318066806790422),
                                    ("<time-of-day> am|pmintersect", -5.065303838295054),
                                    ("Octoberyear (latent)", -4.7086288943563215),
                                    ("intersect<time-of-day> am|pm", -6.318066806790422),
                                    ("Mattu Pongalyear (latent)", -6.318066806790422),
                                    ("Parsi New Yearyear (latent)", -5.401776074916267),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.318066806790422),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.318066806790422),
                                    ("todayin|within|after <duration>", -6.318066806790422),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.912601698682257),
                                    ("Marchyear (latent)", -6.318066806790422),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.912601698682257),
                                    ("Clean Mondayyear (latent)", -5.912601698682257),
                                    ("monthhour", -5.912601698682257),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.624919626230477),
                                    ("todayat <time-of-day>", -6.318066806790422),
                                    ("Thursday<time> timezone", -4.3721566577351085),
                                    ("time-of-day (latent)tonight", -5.912601698682257),
                                    ("from|since|after <time>December", -6.318066806790422),
                                    ("<time-of-day> am|pmon <day>", -4.303163786248157),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.318066806790422),
                                    ("dayday", -3.8757197714212173),
                                    ("<time> <part-of-day>at <time-of-day>", -6.318066806790422),
                                    ("mm/ddat <time-of-day>", -6.318066806790422),
                                    ("tonightat <time-of-day>", -6.318066806790422),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.624919626230477),
                                    ("Dayananda Saraswati Jayantiyear (latent)",
                                     -6.318066806790422),
                                    ("today<time-of-day> am|pm", -6.318066806790422),
                                    ("Februarythe <day-of-month> (ordinal)", -5.912601698682257),
                                    ("at <time-of-day><time> <part-of-day>", -6.318066806790422),
                                    ("<day-of-month> (ordinal)intersect", -5.624919626230477),
                                    ("mm/dd<time-of-day> am|pm", -6.318066806790422),
                                    ("hourhour", -4.238625265110586),
                                    ("Navaratriin|during <named-month>|year", -6.318066806790422),
                                    ("Wednesdaythis|last|next <cycle>", -6.318066806790422),
                                    ("Lentyear (latent)", -6.318066806790422),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.813989410014147),
                                    ("Boghiyear (latent)", -6.318066806790422),
                                    ("dayyear", -1.929809622365904),
                                    ("Thursdayfrom|since|after <time>", -5.912601698682257),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.318066806790422),
                                    ("Thursdayat <time-of-day>", -5.624919626230477),
                                    ("Islamic New Yearyear (latent)", -5.912601698682257),
                                    ("Laylat al-Qadryear (latent)", -5.401776074916267),
                                    ("Shrove Tuesdayyear (latent)", -6.318066806790422),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.624919626230477),
                                    ("<time-of-day> am|pmtomorrow", -5.624919626230477),
                                    ("Yom Kippuryear (latent)", -6.318066806790422),
                                    ("<day-of-month> (ordinal)Tuesday", -5.912601698682257),
                                    ("<part-of-day> of <time>year (latent)", -6.318066806790422),
                                    ("minutehour", -5.065303838295054),
                                    ("Kaanum Pongalyear (latent)", -5.912601698682257),
                                    ("Maha Saptamiyear (latent)", -6.318066806790422),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.912601698682257),
                                    ("time-of-day (latent)tomorrow", -5.401776074916267),
                                    ("part of daysat <time-of-day>", -5.912601698682257),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.613318714551997),
                                    ("for <duration> from <time>December", -6.318066806790422),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.318066806790422),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.065303838295054),
                                    ("time-of-day (latent)this <part-of-day>", -6.318066806790422),
                                    ("Pentecostyear (latent)", -6.318066806790422),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.065303838295054),
                                    ("<day-of-month> (ordinal)February", -6.318066806790422),
                                    ("Eid al-Fitryear (latent)", -5.401776074916267),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.318066806790422),
                                    ("Chhathin|during <named-month>|year", -6.318066806790422),
                                    ("Diwaliin|during <named-month>|year", -6.318066806790422),
                                    ("Vaisakhiin|during <named-month>|year", -6.318066806790422),
                                    ("Guru Ravidass Jayantiyear (latent)", -5.065303838295054),
                                    ("Raksha Bandhanyear (latent)", -6.318066806790422),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.912601698682257),
                                    ("Ashurayear (latent)", -6.318066806790422),
                                    ("Tuesdayin|during <named-month>|year", -6.318066806790422),
                                    ("Chinese New Yearyear (latent)", -6.318066806790422),
                                    ("tomorrowintersect", -6.318066806790422),
                                    ("Lag BaOmeryear (latent)", -6.318066806790422),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.318066806790422),
                                    ("Eid al-Adhayear (latent)", -4.178000643294151),
                                    ("intersectin|during the <part-of-day>", -6.318066806790422),
                                    ("Palm Sundayyear (latent)", -6.318066806790422),
                                    ("Christmasat <time-of-day>", -6.318066806790422),
                                    ("Passoveryear (latent)", -6.318066806790422),
                                    ("Lazarus Saturdayyear (latent)", -6.318066806790422),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -5.912601698682257),
                                    ("Yom HaShoahyear (latent)", -5.912601698682257),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.912601698682257),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.318066806790422),
                                    ("Septemberyear (latent)", -5.912601698682257),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.813989410014147),
                                    ("Halloweenyear (latent)", -6.318066806790422),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.318066806790422),
                                    ("at <time-of-day>intersect", -5.912601698682257),
                                    ("Rosh Hashanahyear (latent)", -5.624919626230477),
                                    ("Dhanterasyear (latent)", -6.318066806790422),
                                    ("Tu BiShvatyear (latent)", -6.318066806790422),
                                    ("<day-of-month> (ordinal)December", -5.624919626230477),
                                    ("Holiyear (latent)", -5.624919626230477),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.318066806790422),
                                    ("Holika Dahanyear (latent)", -5.624919626230477),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.318066806790422),
                                    ("dayminute", -3.4002960747061426),
                                    ("Mawlidyear (latent)", -6.318066806790422),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -5.912601698682257),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.318066806790422),
                                    ("Jumu'atul-Widayear (latent)", -5.912601698682257),
                                    ("minuteday", -2.489425410301327),
                                    ("absorption of , after named dayintersect",
                                     -6.318066806790422),
                                    ("intersectyear (latent)", -5.912601698682257),
                                    ("Orthodox Easter Sundayyear (latent)", -6.318066806790422),
                                    ...
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.318066806790422),
                                    ("Boss's Dayyear (latent)", -5.912601698682257),
                                    ("Global Youth Service Dayyear (latent)", -6.318066806790422),
                                    ("Dhanterasin|during <named-month>|year", -6.318066806790422),
                                    ("Tisha B'Avyear (latent)", -6.318066806790422),
                                    ("Isra and Mi'rajyear (latent)", -5.401776074916267),
                                    ("at <time-of-day>on <day>", -5.219454518122312),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.318066806790422),
                                    ("time-of-day (latent)<time> <part-of-day>",
                                     -5.624919626230477),
                                    ("Christmasyear (latent)", -5.912601698682257),
                                    ("Naraka Chaturdashiyear (latent)", -5.912601698682257),
                                    ("Thai Pongalin|during <named-month>|year", -6.318066806790422),
                                    ("dayweek", -6.318066806790422),
                                    ("Easter Sundayyear (latent)", -5.624919626230477),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -4.7086288943563215),
                                    ("weekyear", -5.219454518122312),
                                    ("King's Dayyear (latent)", -4.813989410014147),
                                    ("hh:mmin|during the <part-of-day>", -5.401776074916267),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.912601698682257),
                                    ("Hanukkahyear (latent)", -5.624919626230477),
                                    ("February<time> <part-of-day>", -6.318066806790422),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -6.318066806790422),
                                    ("Great Lentyear (latent)", -6.318066806790422),
                                    ("tomorrowat <time-of-day>", -5.624919626230477),
                                    ("hhmm (latent)in|during the <part-of-day>",
                                     -6.318066806790422),
                                    ("Vaisakhiyear (latent)", -5.624919626230477),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -6.318066806790422),
                                    ("last <cycle> of <time>year (latent)", -5.624919626230477),
                                    ("at <time-of-day>tomorrow", -5.912601698682257),
                                    ("tomorrow<time-of-day> am|pm", -6.318066806790422),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.318066806790422),
                                    ("Diwaliyear (latent)", -6.318066806790422),
                                    ("between <time> and <time>on <day>", -4.7086288943563215),
                                    ("Black Fridayyear (latent)", -5.912601698682257),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.318066806790422),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.318066806790422),
                                    ("Chhathyear (latent)", -5.912601698682257),
                                    ("Vasant Panchamiyear (latent)", -6.318066806790422),
                                    ("Rabindra Jayantiyear (latent)", -5.065303838295054),
                                    ("St Patrick's Dayyear (latent)", -6.318066806790422),
                                    ("Thursday<time> (timezone)", -6.318066806790422),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.318066806790422),
                                    ("<datetime> - <datetime> (interval)July", -5.912601698682257),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.912601698682257),
                                    ("Februaryintersect", -6.318066806790422),
                                    ("Simchat Torahyear (latent)", -6.318066806790422)],
                               n = 422},
                   koData =
                     ClassData{prior = -0.910640999332036, unseen = -6.726233402358747,
                               likelihoods =
                                 HashMap.fromList
                                   [("hourday", -3.1415147037107327),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -6.031886461606898),
                                    ("<day-of-month> (ordinal)August", -6.031886461606898),
                                    ("dayhour", -3.323836260504687),
                                    ("<time> timezoneyear (latent)", -6.031886461606898),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.115595729732743),
                                    ("Tuesdayfrom|since|after <time>", -5.338739281046952),
                                    ("daymonth", -3.546979811818897),
                                    ...
                                    ("Shavuotyear (latent)", -6.031886461606898),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.338739281046952),
                                    ("about|exactly <time-of-day>year (latent)",
                                     -6.031886461606898),
                                    ("Sukkotyear (latent)", -5.626421353498733),
                                    ("hh:mmon <day>", -3.589539426237693),
                                    ("absorption of , after named dayJuly", -5.626421353498733),
                                    ...
                                    ("in|during <named-month>|yearyear (latent)",
                                     -6.031886461606898),
                                    ("at <time-of-day>intersect", -5.626421353498733),
                                    ("hh:mmyear (latent)", -3.9524449199270615),
                                    ("Holiyear (latent)", -6.031886461606898),
                                    ("until <time><time-of-day> am|pm", -6.031886461606898),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.031886461606898),
                                    ("dayminute", -3.4291967761625135),
                                    ("yyyy-mm-ddhh:mm", -5.626421353498733),
                                    ("intersectfrom|since|after <time>", -5.626421353498733),
                                    ("intersectSeptember", -4.527809064830623),
                                    ("Jumu'atul-Widayear (latent)", -5.626421353498733),
                                    ...
                                    ("at <time-of-day>on <day>", -5.626421353498733),
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.1961148789262905, unseen = -5.220355825078324,
                               likelihoods =
                                 HashMap.fromList
                               ...
                               n = 180},
                   koData =
                     ClassData{prior = -1.7255100836868544, unseen = -3.784189633918261,
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -1.276293465905562),
                                    ("negative numbers", -0.5031035776720805),
       ...
       ("<integer> <unit-of-duration>",
        Classifier{okData =
                     ClassData{prior = -0.24567266437423793,
                               ...
                               n = 79},
                   koData =
                     ClassData{prior = -1.5240780634829436, unseen = -4.204692619390966,
                               likelihoods =
                                 HashMap.fromList
                                   [("week", -3.4965075614664802),
                                    ("integer (0..19)year (grain)", -2.803360380906535),
                                    ("integer (numeric)day (grain)", -3.4965075614664802),
                                    ("integer (numeric)year (grain)", -2.580216829592325),
                                    ("day", -3.4965075614664802), ("year", -2.1102132003465894),
                                    ("integer (numeric)week (grain)", -3.4965075614664802),
                                    ("hour", -1.791759469228055), ("month", -2.803360380906535),
                                    ("integer (numeric)month (grain)", -2.803360380906535),
                                    ("integer (numeric)hour (grain)", -1.791759469228055)],
                               n = 22}}),
        ...
        Classifier{okData =
                   ...
                   koData =
                     ClassData{prior = -0.45198512374305727,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("hour (grain)", -2.128231705849268),
                                    ("year (grain)", -2.3513752571634776),
                                    ("quarter", -1.6582280766035324), ("year", -2.3513752571634776),
                                    ("hour", -2.128231705849268),
                                    ("quarter (grain)", -1.6582280766035324)],
                               n = 14}}),
       ("Dhanteras",
        Classifier{okData =
                     ClassData{prior = 0.0, unseen = -1.3862943611198906,
       ...
       ("<duration> after|before|from|past <time>",
        Classifier{okData =
                     ClassData{prior = -1.0360919316867756, unseen = -3.891820298110627,
                               likelihoods =
                                 HashMap.fromList
                                   [("a <unit-of-duration>now", -3.1780538303479458),
                                    ("dayday", -3.1780538303479458),
                                    ("<integer> <unit-of-duration>today", -3.1780538303479458),
                                    ("minutehour", -2.0794415416798357),
                                    ("daysecond", -3.1780538303479458),
                                    ("a <unit-of-duration>right now", -3.1780538303479458),
                                    ("minutenograin", -3.1780538303479458),
                                    ("<integer> <unit-of-duration>Easter Sunday",
                                     -3.1780538303479458),
                                    ("secondnograin", -3.1780538303479458),
                                    ...
                                    ("<integer> <unit-of-duration>noon|midnight|EOD|end of day",
                                     -3.1780538303479458),
                                    ("daynograin", -3.1780538303479458),
                                    ("<integer> <unit-of-duration>now", -2.772588722239781)],
                               n = 11},
                   koData =
                     ClassData{prior = -0.4382549309311553, unseen = -4.204692619390966,
                               likelihoods =
                                 HashMap.fromList
                                   [("quarterhour", -1.8870696490323797),
                                    ("dayhour", -3.4965075614664802),
                                    ("<integer> <unit-of-duration>intersect", -3.4965075614664802),
                                    ("<integer> <unit-of-duration><day-of-month> (ordinal)",
                                     -3.4965075614664802),
                                    ("monthnograin", -3.4965075614664802),
                                    ("a <unit-of-duration>Christmas", -3.4965075614664802),
                                    ("a <unit-of-duration><time-of-day> am|pm", -2.580216829592325),
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("Martin Luther King's Day", -2.5649493574615367),
                                    ("Monday", -2.5649493574615367), ("day", -1.8718021769015913),
       ...
       ("next <time>",
        Classifier{okData =
                     ClassData{prior = -0.40546510810816444,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("Halloween", -2.5649493574615367),
                                    ("Wednesday", -2.5649493574615367),
                                    ("Boss's Day", -2.5649493574615367),
                   ...
                   koData =
                     ClassData{prior = -1.0986122886681098,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("Martin Luther King's Day", -1.5040773967762742),
                                    ("Monday", -2.1972245773362196), ("day", -1.2809338454620642)],
                               n = 4}}),
