...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.5887544849631462, unseen = -6.133398042996649,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 459},
                   koData =
                     ClassData{prior = -0.8097217568547604, unseen = -5.91350300563827,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.47026510133507987,
                               unseen = -7.126087273299125,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.432135910950766),
                                    ("Karva Chauthyear (latent)", -6.432135910950766),
                                    ("<day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.432135910950766),
                                    ("Maha Shivaratriyear (latent)", -6.432135910950766),
                                    ("Ramadanyear (latent)", -5.179372942455398),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -5.045841549830875),
                                    ("Bhai Doojyear (latent)", -6.432135910950766),
                                    ("hourday", -4.417232890408501),
                                    ("dayhour", -3.4876969317843254),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.045841549830875),
                                    ("Martin Luther King's Dayyear (latent)", -6.0266708028426015),
                                    ("Shemini Atzeretyear (latent)", -6.432135910950766),
                                    ("daymonth", -4.292069747454495),
                                    ("monthday", -6.0266708028426015),
                                    ("monthyear", -4.560333734049174),
                                    ("Yom Ha'atzmautyear (latent)", -6.432135910950766),
                                    ("Vijayadashamiyear (latent)", -6.432135910950766),
                                    ("Thanksgiving Dayyear (latent)", -5.333523622282656),
                                    ("Thai Pongalyear (latent)", -5.738988730390821),
                                    ("Thiru Onamyear (latent)", -5.738988730390821),
                                    ("hhhmmabsorption of , after named day", -6.432135910950766),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.432135910950766),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.515845179076611),
                                    ("<day-of-month> (ordinal)Wednesday", -6.432135910950766),
                                    ("Krishna Janmashtamiyear (latent)", -6.0266708028426015),
                                    ("Guru Gobind Singh Jayantiyear (latent)", -6.432135910950766),
                                    ("houryear", -5.515845179076611),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.432135910950766),
                                    ("Christmas<time-of-day> am|pm", -6.432135910950766),
                                    ("<day-of-month> (ordinal)October", -6.432135910950766),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.432135910950766),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.738988730390821),
                                    ("intersectin|during <named-month>|year", -6.432135910950766),
                                    ("<time-of-day> am|pmintersect", -5.179372942455398),
                                    ("Earth Houryear (latent)", -6.432135910950766),
                                    ("Ganesh Chaturthiyear (latent)", -6.432135910950766),
                                    ("Octoberyear (latent)", -4.822697998516666),
                                    ("intersect<time-of-day> am|pm", -6.432135910950766),
                                    ("Mattu Pongalyear (latent)", -6.432135910950766),
                                    ("Shavuotyear (latent)", -6.432135910950766),
                                    ("Parsi New Yearyear (latent)", -5.515845179076611),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.432135910950766),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.432135910950766),
                                    ("todayin|within|after <duration>", -6.432135910950766),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -6.0266708028426015),
                                    ("Marchyear (latent)", -6.432135910950766),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hhhmm",
                                     -6.0266708028426015),
                                    ("Sukkotyear (latent)", -6.0266708028426015),
                                    ("hhhmmintersect", -6.0266708028426015),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -6.0266708028426015),
                                    ("Clean Mondayyear (latent)", -6.0266708028426015),
                                    ("monthhour", -6.0266708028426015),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.738988730390821),
                                    ("todayat <time-of-day>", -6.432135910950766),
                                    ("Thursday<time> timezone", -4.034240638152395),
                                    ("time-of-day (latent)tonight", -6.0266708028426015),
                                    ("from|since|after <time>December", -6.432135910950766),
                                    ("<time-of-day> am|pmon <day>", -4.417232890408501),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.432135910950766),
                                    ("yyyy-mm-ddhh:mm:ss", -6.0266708028426015),
                                    ("dayday", -3.7240857098485556),
                                    ("<time> <part-of-day>at <time-of-day>", -6.432135910950766),
                                    ("mm/ddat <time-of-day>", -5.738988730390821),
                                    ("tonightat <time-of-day>", -6.432135910950766),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.738988730390821),
                                    ("Dayananda Saraswati Jayantiyear (latent)",
                                     -6.432135910950766),
                                    ("today<time-of-day> am|pm", -6.432135910950766),
                                    ("Februarythe <day-of-month> (ordinal)", -6.0266708028426015),
                                    ("at <time-of-day><time> <part-of-day>", -6.432135910950766),
                                    ("<day-of-month> (ordinal)intersect", -5.738988730390821),
                                    ("mm/dd<time-of-day> am|pm", -6.432135910950766),
                                    ("hourhour", -4.35269436927093),
                                    ("Mahavir Jayantiyear (latent)", -6.0266708028426015),
                                    ("Navaratriin|during <named-month>|year", -6.432135910950766),
                                    ("Wednesdaythis|last|next <cycle>", -6.432135910950766),
                                    ("Lentyear (latent)", -6.432135910950766),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.560333734049174),
                                    ("Boghiyear (latent)", -6.432135910950766),
                                    ("dayyear", -1.8677877194829295),
                                    ("Karva Chauthin|during <named-month>|year",
                                     -6.432135910950766),
                                    ("Thursdayfrom|since|after <time>", -6.0266708028426015),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.432135910950766),
                                    ("Thursdayat <time-of-day>", -5.738988730390821),
                                    ("Islamic New Yearyear (latent)", -6.0266708028426015),
                                    ("Laylat al-Qadryear (latent)", -5.515845179076611),
                                    ("Shrove Tuesdayyear (latent)", -6.432135910950766),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.738988730390821),
                                    ("<time-of-day> am|pmtomorrow", -5.738988730390821),
                                    ("Yom Kippuryear (latent)", -6.432135910950766),
                                    ("<day-of-month> (ordinal)Tuesday", -6.0266708028426015),
                                    ("<part-of-day> of <time>year (latent)", -6.432135910950766),
                                    ("minutehour", -5.179372942455398),
                                    ("Kaanum Pongalyear (latent)", -6.0266708028426015),
                                    ("Maha Saptamiyear (latent)", -6.432135910950766),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -6.0266708028426015),
                                    ("time-of-day (latent)tomorrow", -5.515845179076611),
                                    ("part of daysat <time-of-day>", -6.0266708028426015),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.417232890408501),
                                    ("for <duration> from <time>December", -6.432135910950766),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.432135910950766),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.179372942455398),
                                    ("intersect by \",\", \"of\", \"from\" for yearhhhmm",
                                     -5.179372942455398),
                                    ("time-of-day (latent)this <part-of-day>", -6.432135910950766),
                                    ("Pentecostyear (latent)", -6.432135910950766),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.179372942455398),
                                    ("<day-of-month> (ordinal)February", -6.432135910950766),
                                    ("Eid al-Fitryear (latent)", -5.045841549830875),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.432135910950766),
                                    ("Mondayin|during the <part-of-day>", -6.432135910950766),
                                    ("Chhathin|during <named-month>|year", -6.432135910950766),
                                    ("Diwaliin|during <named-month>|year", -6.432135910950766),
                                    ("Vaisakhiin|during <named-month>|year", -6.432135910950766),
                                    ("Guru Ravidass Jayantiyear (latent)", -5.179372942455398),
                                    ("Raksha Bandhanyear (latent)", -6.432135910950766),
                                    ("daysecond", -6.0266708028426015),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -6.0266708028426015),
                                    ("Ratha-Yatrayear (latent)", -6.432135910950766),
                                    ("Ashurayear (latent)", -6.432135910950766),
                                    ("Tuesdayin|during <named-month>|year", -6.432135910950766),
                                    ("Chinese New Yearyear (latent)", -6.432135910950766),
                                    ("tomorrowintersect", -6.432135910950766),
                                    ("Lag BaOmeryear (latent)", -6.432135910950766),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.432135910950766),
                                    ("Eid al-Adhayear (latent)", -4.292069747454495),
                                    ("intersectin|during the <part-of-day>", -6.432135910950766),
                                    ("Palm Sundayyear (latent)", -6.432135910950766),
                                    ("Christmasat <time-of-day>", -6.432135910950766),
                                    ("Passoveryear (latent)", -6.432135910950766),
                                    ("Lazarus Saturdayyear (latent)", -6.432135910950766),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.0266708028426015),
                                    ("hhhmmon <day>", -5.515845179076611),
                                    ("Yom HaShoahyear (latent)", -6.0266708028426015),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -6.0266708028426015),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.432135910950766),
                                    ("Septemberyear (latent)", -6.0266708028426015),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.9280585141744915),
                                    ("Halloweenyear (latent)", -6.432135910950766),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.432135910950766),
                                    ("at <time-of-day>intersect", -5.515845179076611),
                                    ("Rosh Hashanahyear (latent)", -5.738988730390821),
                                    ("Dhanterasyear (latent)", -6.432135910950766),
                                    ("Tu BiShvatyear (latent)", -6.432135910950766),
                                    ("<day-of-month> (ordinal)December", -5.738988730390821),
                                    ("Holiyear (latent)", -5.738988730390821),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.432135910950766),
                                    ("Holika Dahanyear (latent)", -5.738988730390821),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.0266708028426015),
                                    ("dayminute", -3.047745647604992),
                                    ("Mawlidyear (latent)", -6.432135910950766),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -6.0266708028426015),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.432135910950766),
                                    ("Jumu'atul-Widayear (latent)", -5.515845179076611),
                                    ("minuteday", -2.6944662926673977),
                                    ("absorption of , after named dayintersect",
                                     -5.738988730390821),
                                    ("intersectyear (latent)", -6.0266708028426015),
                                    ("Orthodox Easter Sundayyear (latent)", -6.432135910950766),
                                    ("time-of-day (latent)in|within|after <duration>",
                                     -6.432135910950766),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -6.432135910950766),
                                    ("intersecthhhmm", -6.0266708028426015),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.432135910950766),
                                    ("Boss's Dayyear (latent)", -6.0266708028426015),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.432135910950766),
                                    ("Global Youth Service Dayyear (latent)", -6.432135910950766),
                                    ("Dhanterasin|during <named-month>|year", -6.432135910950766),
                                    ("Tisha B'Avyear (latent)", -6.432135910950766),
                                    ("Isra and Mi'rajyear (latent)", -5.515845179076611),
                                    ("at <time-of-day>on <day>", -4.822697998516666),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.0266708028426015),
                                    ("time-of-day (latent)<time> <part-of-day>",
                                     -5.738988730390821),
                                    ("Christmasyear (latent)", -6.0266708028426015),
                                    ("Naraka Chaturdashiyear (latent)", -6.0266708028426015),
                                    ("Thai Pongalin|during <named-month>|year", -6.432135910950766),
                                    ("dayweek", -6.432135910950766),
                                    ("Easter Sundayyear (latent)", -5.738988730390821),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -6.0266708028426015),
                                    ("weekyear", -5.333523622282656),
                                    ("King's Dayyear (latent)", -4.9280585141744915),
                                    ("hh:mmin|during the <part-of-day>", -5.515845179076611),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -6.0266708028426015),
                                    ("Hanukkahyear (latent)", -5.738988730390821),
                                    ("February<time> <part-of-day>", -6.432135910950766),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -6.432135910950766),
                                    ("Great Lentyear (latent)", -6.432135910950766),
                                    ("tomorrowat <time-of-day>", -5.738988730390821),
                                    ("hhmm (latent)in|during the <part-of-day>",
                                     -6.432135910950766),
                                    ("Ugadiyear (latent)", -5.045841549830875),
                                    ("Vaisakhiyear (latent)", -5.738988730390821),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -5.738988730390821),
                                    ("last <cycle> of <time>year (latent)", -5.738988730390821),
                                    ("at <time-of-day>tomorrow", -6.0266708028426015),
                                    ("tomorrow<time-of-day> am|pm", -6.432135910950766),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.432135910950766),
                                    ("Diwaliyear (latent)", -6.432135910950766),
                                    ("between <time> and <time>on <day>", -6.0266708028426015),
                                    ("Black Fridayyear (latent)", -6.0266708028426015),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.432135910950766),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.432135910950766),
                                    ("Chhathyear (latent)", -6.0266708028426015),
                                    ("Vasant Panchamiyear (latent)", -6.432135910950766),
                                    ("Rabindra Jayantiyear (latent)", -5.179372942455398),
                                    ("St Patrick's Dayyear (latent)", -6.432135910950766),
                                    ("Thursday<time> (timezone)", -6.432135910950766),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.432135910950766),
                                    ("Pargat Diwasyear (latent)", -5.179372942455398),
                                    ("<datetime> - <datetime> (interval)July", -6.0266708028426015),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.738988730390821),
                                    ("Februaryintersect", -6.432135910950766),
                                    ("Simchat Torahyear (latent)", -6.432135910950766),
                                    ("minuteyear", -6.432135910950766)],
                               n = 478},
                   koData =
                     ClassData{prior = -0.9803936180669147, unseen = -6.759255270663693,
                               likelihoods =
                                 HashMap.fromList
                                   [("Thursdayhhhmm", -4.560869927091511),
                                    ("hourday", -3.667052051069415),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -6.064947323867785),
                                    ("<day-of-month> (ordinal)August", -6.064947323867785),
                                    ("dayhour", -3.147176591783506),
                                    ("<time> timezoneyear (latent)", -5.371800143307841),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.14865659199363),
                                    ("Tuesdayfrom|since|after <time>", -5.371800143307841),
                                    ("daymonth", -3.390798674441257),
                                    ("monthday", -5.14865659199363),
                                    ...
                                    ("about|exactly <time-of-day>year (latent)",
                                     -6.064947323867785),
                                    ("hh:mmon <day>", -4.812184355372417),
                                    ("hhhmmintersect", -5.659482215759621),
                                    ("absorption of , after named dayJuly", -5.14865659199363),
                                    ...
                                    ("hhhmmyear (latent)", -4.812184355372417),
                                    ...
                                    ("Mondayyear (latent)", -5.371800143307841),
                                    ("dayday", -4.678652962747895),
                                    ("mm/ddat <time-of-day>", -5.14865659199363),
                                    ("on <day>September", -5.371800143307841),
                                    ("time-of-day (latent)September", -5.659482215759621),
                                    ("hourhour", -5.659482215759621),
                                    ("time-of-day (latent)on <day>", -4.560869927091511),
                                    ("time-of-day (latent)<cycle> after|before <time>",
                                     -5.659482215759621),
                                    ("dayyear", -3.120508344701345),
                                    ...
                                    ("in|during <named-month>|yearyear (latent)",
                                     -6.064947323867785),
                                    ("at <time-of-day>intersect", -5.14865659199363),
                                    ("hh:mmyear (latent)", -4.678652962747895),
                                    ("Holiyear (latent)", -6.064947323867785),
                                    ("until <time><time-of-day> am|pm", -6.064947323867785),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.659482215759621),
                                    ("dayminute", -3.202746442938317),
                                    ("yyyy-mm-ddhh:mm", -5.659482215759621),
                                    ("intersectfrom|since|after <time>", -5.659482215759621),
                                    ("intersectSeptember", -4.193145146966194),
                                    ("minuteday", -2.907946902717672),
                                    ("absorption of , after named dayintersect",
                                     -6.064947323867785),
                                    ...
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.064947323867785),
                                    ("at <time-of-day>on <day>", -5.14865659199363),
                                    ...
                                    ("tomorrow<time-of-day> am|pm", -5.371800143307841),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.371800143307841),
