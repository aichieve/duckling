...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.5567353250700686,
                               unseen = -6.1070228877422545,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 447},
                   koData =
                     ClassData{prior = -0.8511514297031937, unseen = -5.814130531825066,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4721564826068366, unseen = -7.099201743553092,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.405228458030842),
                                    ("Karva Chauthyear (latent)", -6.405228458030842),
                                    ("<day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.405228458030842),
                                    ("Maha Shivaratriyear (latent)", -6.405228458030842),
                                    ("Ramadanyear (latent)", -5.152465489535474),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -5.018934096910951),
                                    ("Bhai Doojyear (latent)", -6.405228458030842),
                                    ("hourday", -4.390325437488577),
                                    ("dayhour", -3.460789478864401),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.018934096910951),
                                    ("Martin Luther King's Dayyear (latent)", -5.999763349922677),
                                    ("Shemini Atzeretyear (latent)", -6.405228458030842),
                                    ("daymonth", -4.390325437488577),
                                    ("monthday", -5.999763349922677),
                                    ("monthyear", -4.613468988802786),
                                    ("Yom Ha'atzmautyear (latent)", -6.405228458030842),
                                    ("Vijayadashamiyear (latent)", -6.405228458030842),
                                    ("Thai Pongalyear (latent)", -5.7120812774708964),
                                    ("Thiru Onamyear (latent)", -5.7120812774708964),
                                    ("hhhmmabsorption of , after named day", -6.405228458030842),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.405228458030842),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.488937726156687),
                                    ("<day-of-month> (ordinal)Wednesday", -6.405228458030842),
                                    ("Krishna Janmashtamiyear (latent)", -5.999763349922677),
                                    ("Guru Gobind Singh Jayantiyear (latent)", -6.405228458030842),
                                    ("houryear", -5.488937726156687),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.405228458030842),
                                    ("Christmas<time-of-day> am|pm", -6.405228458030842),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.405228458030842),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.7120812774708964),
                                    ("intersectin|during <named-month>|year", -6.405228458030842),
                                    ("<time-of-day> am|pmintersect", -5.152465489535474),
                                    ("Earth Houryear (latent)", -6.405228458030842),
                                    ("Ganesh Chaturthiyear (latent)", -6.405228458030842),
                                    ("Octoberyear (latent)", -4.901151061254567),
                                    ("intersect<time-of-day> am|pm", -6.405228458030842),
                                    ("Mattu Pongalyear (latent)", -6.405228458030842),
                                    ("Shavuotyear (latent)", -6.405228458030842),
                                    ("Parsi New Yearyear (latent)", -5.488937726156687),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.405228458030842),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.405228458030842),
                                    ("todayin|within|after <duration>", -6.405228458030842),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.999763349922677),
                                    ("Marchyear (latent)", -6.405228458030842),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hhhmm",
                                     -5.999763349922677),
                                    ("Sukkotyear (latent)", -5.999763349922677),
                                    ("hhhmmintersect", -5.999763349922677),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.999763349922677),
                                    ("Clean Mondayyear (latent)", -5.999763349922677),
                                    ("monthhour", -5.999763349922677),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.7120812774708964),
                                    ("todayat <time-of-day>", -6.405228458030842),
                                    ("Thursday<time> timezone", -4.007333185232471),
                                    ("time-of-day (latent)tonight", -5.999763349922677),
                                    ("from|since|after <time>December", -6.405228458030842),
                                    ("<time-of-day> am|pmon <day>", -4.390325437488577),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.405228458030842),
                                    ("yyyy-mm-ddhh:mm:ss", -5.999763349922677),
                                    ("dayday", -3.6971782569286313),
                                    ("<time> <part-of-day>at <time-of-day>", -6.405228458030842),
                                    ("tonightat <time-of-day>", -6.405228458030842),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.7120812774708964),
                                    ("Dayananda Saraswati Jayantiyear (latent)",
                                     -6.405228458030842),
                                    ("today<time-of-day> am|pm", -6.405228458030842),
                                    ("Februarythe <day-of-month> (ordinal)", -5.999763349922677),
                                    ("at <time-of-day><time> <part-of-day>", -6.405228458030842),
                                    ("<day-of-month> (ordinal)intersect", -5.999763349922677),
                                    ("hourhour", -4.325786916351006),
                                    ("Mahavir Jayantiyear (latent)", -5.999763349922677),
                                    ("Navaratriin|during <named-month>|year", -6.405228458030842),
                                    ("Wednesdaythis|last|next <cycle>", -6.405228458030842),
                                    ("Lentyear (latent)", -6.405228458030842),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.53342628112925),
                                    ("Boghiyear (latent)", -6.405228458030842),
                                    ("dayyear", -1.878019813512462),
                                    ("Karva Chauthin|during <named-month>|year",
                                     -6.405228458030842),
                                    ("Thursdayfrom|since|after <time>", -5.999763349922677),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.405228458030842),
                                    ("Thursdayat <time-of-day>", -5.7120812774708964),
                                    ("Islamic New Yearyear (latent)", -5.999763349922677),
                                    ("Laylat al-Qadryear (latent)", -5.488937726156687),
                                    ("Shrove Tuesdayyear (latent)", -6.405228458030842),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.7120812774708964),
                                    ("<time-of-day> am|pmtomorrow", -5.7120812774708964),
                                    ("Yom Kippuryear (latent)", -6.405228458030842),
                                    ("<day-of-month> (ordinal)Tuesday", -5.999763349922677),
                                    ("<part-of-day> of <time>year (latent)", -6.405228458030842),
                                    ("minutehour", -5.152465489535474),
                                    ("Kaanum Pongalyear (latent)", -5.999763349922677),
                                    ("Maha Saptamiyear (latent)", -6.405228458030842),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.999763349922677),
                                    ("time-of-day (latent)tomorrow", -5.488937726156687),
                                    ("part of daysat <time-of-day>", -5.999763349922677),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.390325437488577),
                                    ("for <duration> from <time>December", -6.405228458030842),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.405228458030842),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.152465489535474),
                                    ("intersect by \",\", \"of\", \"from\" for yearhhhmm",
                                     -5.152465489535474),
                                    ("time-of-day (latent)this <part-of-day>", -6.405228458030842),
                                    ("Pentecostyear (latent)", -6.405228458030842),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.152465489535474),
                                    ("<day-of-month> (ordinal)February", -6.405228458030842),
                                    ("Eid al-Fitryear (latent)", -5.018934096910951),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.405228458030842),
                                    ("Mondayin|during the <part-of-day>", -6.405228458030842),
                                    ("Chhathin|during <named-month>|year", -6.405228458030842),
                                    ("Diwaliin|during <named-month>|year", -6.405228458030842),
                                    ("Vaisakhiin|during <named-month>|year", -6.405228458030842),
                                    ("Guru Ravidass Jayantiyear (latent)", -5.152465489535474),
                                    ("Raksha Bandhanyear (latent)", -6.405228458030842),
                                    ("daysecond", -5.999763349922677),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.999763349922677),
                                    ("Ratha-Yatrayear (latent)", -6.405228458030842),
                                    ("Ashurayear (latent)", -6.405228458030842),
                                    ("Tuesdayin|during <named-month>|year", -6.405228458030842),
                                    ("Chinese New Yearyear (latent)", -6.405228458030842),
                                    ("tomorrowintersect", -6.405228458030842),
                                    ("Lag BaOmeryear (latent)", -6.405228458030842),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.405228458030842),
                                    ("Eid al-Adhayear (latent)", -4.265162294534571),
                                    ("intersectin|during the <part-of-day>", -6.405228458030842),
                                    ("Palm Sundayyear (latent)", -6.405228458030842),
                                    ("Christmasat <time-of-day>", -6.405228458030842),
                                    ("Passoveryear (latent)", -6.405228458030842),
                                    ("Lazarus Saturdayyear (latent)", -6.405228458030842),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.405228458030842),
                                    ("hhhmmon <day>", -5.488937726156687),
                                    ("Yom HaShoahyear (latent)", -5.999763349922677),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.999763349922677),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.405228458030842),
                                    ("Septemberyear (latent)", -5.999763349922677),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.901151061254567),
                                    ("Halloweenyear (latent)", -6.405228458030842),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.405228458030842),
                                    ("at <time-of-day>intersect", -5.488937726156687),
                                    ("Rosh Hashanahyear (latent)", -5.7120812774708964),
                                    ("Dhanterasyear (latent)", -6.405228458030842),
                                    ("Tu BiShvatyear (latent)", -6.405228458030842),
                                    ("<day-of-month> (ordinal)December", -5.7120812774708964),
                                    ("Holiyear (latent)", -5.7120812774708964),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.405228458030842),
                                    ("Holika Dahanyear (latent)", -5.7120812774708964),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.999763349922677),
                                    ("dayminute", -3.0910424533583156),
                                    ("Mawlidyear (latent)", -6.405228458030842),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -5.999763349922677),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.405228458030842),
                                    ("Jumu'atul-Widayear (latent)", -5.488937726156687),
                                    ("minuteday", -2.667558839747473),
                                    ("absorption of , after named dayintersect",
                                     -5.7120812774708964),
                                    ("intersectyear (latent)", -6.405228458030842),
                                    ("Orthodox Easter Sundayyear (latent)", -6.405228458030842),
                                    ("time-of-day (latent)in|within|after <duration>",
                                     -6.405228458030842),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -6.405228458030842),
                                    ("intersecthhhmm", -5.999763349922677),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.405228458030842),
                                    ("Boss's Dayyear (latent)", -5.999763349922677),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.405228458030842),
                                    ("Global Youth Service Dayyear (latent)", -6.405228458030842),
                                    ("Dhanterasin|during <named-month>|year", -6.405228458030842),
                                    ("Tisha B'Avyear (latent)", -6.405228458030842),
                                    ("Isra and Mi'rajyear (latent)", -5.488937726156687),
                                    ("at <time-of-day>on <day>", -4.795790545596741),
                                    ("at <time-of-day>absorption of , after named day",
                                     -5.999763349922677),
                                    ("time-of-day (latent)<time> <part-of-day>",
                                     -5.7120812774708964),
                                    ("Christmasyear (latent)", -5.999763349922677),
                                    ("Naraka Chaturdashiyear (latent)", -5.999763349922677),
                                    ("Thai Pongalin|during <named-month>|year", -6.405228458030842),
                                    ("dayweek", -6.405228458030842),
                                    ("Easter Sundayyear (latent)", -5.7120812774708964),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -5.999763349922677),
                                    ("weekyear", -5.306616169362732),
                                    ("King's Dayyear (latent)", -4.901151061254567),
                                    ("hh:mmin|during the <part-of-day>", -5.488937726156687),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.999763349922677),
                                    ("Hanukkahyear (latent)", -5.7120812774708964),
                                    ("February<time> <part-of-day>", -6.405228458030842),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -6.405228458030842),
                                    ("Great Lentyear (latent)", -6.405228458030842),
                                    ("tomorrowat <time-of-day>", -5.7120812774708964),
                                    ("hhmm (latent)in|during the <part-of-day>",
                                     -6.405228458030842),
                                    ("Ugadiyear (latent)", -5.018934096910951),
                                    ("Vaisakhiyear (latent)", -5.7120812774708964),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -5.7120812774708964),
                                    ("last <cycle> of <time>year (latent)", -5.7120812774708964),
                                    ("at <time-of-day>tomorrow", -5.999763349922677),
                                    ("tomorrow<time-of-day> am|pm", -6.405228458030842),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.405228458030842),
                                    ("Diwaliyear (latent)", -6.405228458030842),
                                    ("between <time> and <time>on <day>", -5.999763349922677),
                                    ("Black Fridayyear (latent)", -5.999763349922677),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.405228458030842),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.405228458030842),
                                    ("Chhathyear (latent)", -5.999763349922677),
                                    ("Vasant Panchamiyear (latent)", -6.405228458030842),
                                    ("Rabindra Jayantiyear (latent)", -5.152465489535474),
                                    ("St Patrick's Dayyear (latent)", -6.405228458030842),
                                    ("Thursday<time> (timezone)", -6.405228458030842),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.405228458030842),
                                    ("Pargat Diwasyear (latent)", -5.152465489535474),
                                    ("<datetime> - <datetime> (interval)July", -5.999763349922677),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.7120812774708964),
                                    ("Februaryintersect", -6.405228458030842),
                                    ("Simchat Torahyear (latent)", -6.405228458030842),
                                    ("minuteyear", -6.405228458030842)],
                               n = 464},
                   koData =
                     ClassData{prior = -0.9772514316638422, unseen = -6.736966958001855,
                               likelihoods =
                                 HashMap.fromList
                                   [("Thursdayhhhmm", -4.538555436906107),
                                    ...
                                    ("this|last|next <cycle>from|since|after <time>",
                                     -5.637167725574217),
                                    ("tomorrowfrom|since|after <time>", -5.637167725574217),
                                    ("Augustyear (latent)", -5.637167725574217),
                                    ("week-endin|during <named-month>|year", -6.042632833682381),
                                    ("this|last|next <cycle>until <time>", -5.637167725574217),
                                    ("time-of-day (latent)Tuesday", -5.637167725574217),
                                    ("tomorrowuntil <time>", -5.637167725574217),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -6.042632833682381),
       ...
       ("time-of-day (latent)",
        Classifier{okData =
                     ClassData{prior = -0.6561059088795962, unseen = -4.727387818712341,
                               likelihoods =
                                 HashMap.fromList
                               ...
                               n = 110},
                   koData =
                     ClassData{prior = -0.7316134613877414, unseen = -4.653960350157523,
                               likelihoods =
                                 HashMap.fromList
       ...
       ("<time-of-day> am|pm",
        Classifier{okData =
                     ClassData{prior = -0.25452986513488046, unseen = -5.68697535633982,
                               likelihoods =
                                 HashMap.fromList
                                   [("from|since|after <time>", -3.6041382256588457),
                                    ("integer after|past <hour-of-day>", -4.297285406218791),
                                    ("at <time-of-day>", -2.464703942470481),
