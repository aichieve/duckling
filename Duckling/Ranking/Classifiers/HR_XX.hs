...
classifiers
  = HashMap.fromList
      [("<time> timezone",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.9521974403373991, unseen = -4.553876891600541,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 93},
                   koData =
                     ClassData{prior = -0.48758465972653986,
       ...
       ("<time> <part-of-day>",
        Classifier{okData =
                     ClassData{prior = -0.36000273403140703,
                               unseen = -5.147494476813453,
                               likelihoods =
                                 HashMap.fromList
                                   [("<time-of-day> o'clockmorning", -4.448516375942715),
                                    ("until <time-of-day>afternoon", -4.448516375942715),
                                    ("dayhour", -3.1957534074473464),
                                    ("time-of-day (latent)late night", -4.04305126783455),
                                    ("time-of-day (latent)evening|night", -4.04305126783455),
                                    ("<time-of-day> o'clockevening|night", -4.448516375942715),
                                    ("<time-of-day> o'clocktonight", -4.448516375942715),
                                    ("<hour-of-day> halfafternoon", -4.448516375942715),
                                    ("time-of-day (latent)tonight", -4.04305126783455),
                                    ("yesterdayevening|night", -4.448516375942715),
                                    ("hourhour", -1.428091489798352),
                                    ("at <time-of-day>afternoon", -3.349904087274605),
                                    ("minutehour", -2.4336133554004498),
                                    ("<time-of-day> o'clockafternoon", -4.448516375942715),
                                    ("intersectafternoon", -4.448516375942715),
                                    ("time-of-day (latent)morning", -4.448516375942715),
                                    ("todayevening|night", -4.448516375942715),
                                    ("at <time-of-day>late night", -4.04305126783455),
                                    ("hh:mmearly morning", -4.448516375942715),
                                    ...
                                    ("quarter after|past (hour-of-day)afternoon",
                                     -4.448516375942715),
                                    ("<time-of-day> o'clocklate night", -4.04305126783455),
                                    ("tomorrowlunch", -4.448516375942715),
                                    ("todaytonight", -4.448516375942715),
                                    ("time-of-day (latent)afternoon", -3.062222014822824),
                                    ("intersectmorning", -3.1957534074473464),
                                    ("about <time-of-day>afternoon", -3.7553691953827695),
                                    ("<duration> after <time>afternoon", -4.448516375942715),
                                    ("hh:mmafternoon", -3.1957534074473464),
                                    ("between <datetime> and <datetime> (interval)morning",
                                     -4.448516375942715),
                                    ("between <time-of-day> and <time-of-day> (interval)morning",
                                     -4.448516375942715),
                                    ("at <time-of-day>morning", -4.448516375942715),
                                    ("tomorrowevening|night", -4.448516375942715)],
                               n = 60},
                   koData =
                     ClassData{prior = -1.1962507582320256,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("<time-of-day> o'clockmorning", -3.9415818076696905),
                                    ("Februarylate night", -3.9415818076696905),
                                    ("dayhour", -2.6888188391743224),
                                    ("yearhour", -3.536116699561526),
                                    ("nograinhour", -3.536116699561526),
                                    ("Mondayearly morning", -3.248434627109745),
                                    ("monthhour", -3.536116699561526),
                                    ("by <time>afternoon", -3.9415818076696905),
                                    ("after <time-of-day>morning", -3.9415818076696905),
                                    ("hourhour", -2.33214389523559),
                                    ("until <time-of-day>morning", -3.9415818076696905),
                                    ("since <time-of-day>morning", -3.9415818076696905),
                                    ("minutehour", -2.842969519001581),
                                    ("time-of-day (latent)morning", -3.9415818076696905),
                                    ("year (latent)afternoon", -3.536116699561526),
                                    ("Februarymorning", -3.9415818076696905),
                                    ("by <time>morning", -3.9415818076696905),
                                    ("numeral to|till|before <integer> (hour-of-day)morning",
                                     -3.9415818076696905),
                                    ("Mondaylate night", -3.9415818076696905),
                                    ("time-of-day (latent)afternoon", -2.6888188391743224),
                                    ("intersectmorning", -3.536116699561526),
                                    ("Mondaymorning", -3.9415818076696905),
       ...
       ("at <time-of-day>",
        Classifier{okData =
                     ClassData{prior = -0.1743533871447778, unseen = -3.871201010907891,
                               likelihoods =
                                 HashMap.fromList
                                   [("<time-of-day> o'clock", -2.2407096892759584),
                                    ("time-of-day (latent)", -1.1420974006078484),
                                    ("hh:mm", -2.463853240590168), ("hour", -0.9057086225436182),
                                    ("minute", -2.463853240590168)],
                               n = 21},
                   koData =
                     ClassData{prior = -1.8325814637483102, unseen = -2.639057329615259,
                               likelihoods =
                                 HashMap.fromList
       ...
       ("time-of-day (latent)",
        Classifier{okData =
                     ClassData{prior = -0.8198988861990892,
                               ...
                               n = 37},
                   koData =
                     ClassData{prior = -0.580669197133255, unseen = -3.970291913552122,
                               likelihoods =
                                 HashMap.fromList
        ...
        Classifier{okData =
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("Wednesday", -2.70805020110221),
                                    ...
                                    ("evening|night", -2.70805020110221),
                                    ("day", -1.791759469228055), ("afternoon", -2.70805020110221),
                                    ("hour", -1.6094379124341003), ("morning", -2.70805020110221),
                   ...
                   koData =
                     ClassData{prior = -1.1786549963416462, unseen = -3.044522437723423,
                               likelihoods =
                                 HashMap.fromList
                                   [("today", -2.3025850929940455), ("Monday", -2.3025850929940455),
                                    ("day", -1.6094379124341003), ("hour", -2.3025850929940455),
                                    ("late night", -2.3025850929940455),
