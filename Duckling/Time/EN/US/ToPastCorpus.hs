...
module Duckling.Time.EN.US.ToPastCorpus
  ( allExamples
  ) where
...
allExamples = concat
  ...
  , examples (datetimeIntervalHoliday ((2012, 5, 25, 18, 0, 0), (2012, 5, 29, 0, 0, 0)) Hour "Memorial Day weekend")
             [ "memorial day week-end"
             ]
  , examples (datetimeHoliday (2012, 7, 4, 0, 0, 0) Day "Independence Day")
             [ "independence day"
             ]
  , examples (datetimeHoliday (2012, 11, 11, 0, 0, 0) Day "Veterans Day")
             [ "veterans day"
             , "veteran day"
             ]
  , examples (datetimeHoliday (2012, 5, 1, 0, 0, 0) Day "Loyalty Day")
             [ "law day"
             , "Lei Day"
             , "loyalty day"
             ]
  , examples (datetimeHoliday (2012, 2, 20, 0, 0, 0) Day "President's Day")
  ...
  , examples (datetimeHoliday (2012, 4, 10, 0, 0, 0) Day "Siblings Day")
             [ "siblings day"
